				...
				<div class="row">
					<div class="col-md-4">
						<div class="input-group">
							...
							<input type="text" id="txt_mxbh" name="mxbh" class="form-control input-radius" style="border-bottom-right-radius: 4px;border-top-right-radius: 4px;"  value="01" readonly/>
						</div>
                    </div>
                    <div class="col-md-4">
						<div class="input-group">
							<span class="input-group-addon"><span class="required">*</span>模型名称</span>
                            <input type="text" id="txt_mxmc" class="form-control input-radius" name="mxmc" value="模板1"/>
						</div>
					</div>
					<div class="col-md-4">
						<div class="input-group">
							<span class="input-group-addon">设置人</span>
						 <input type="text" id="txt_szr" class="form-control input-radius" name="szr" value="刘华"/>	
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-md-4">
						<div class="input-group">
							<span class="input-group-addon">设置时间</span>
							 <input type="text" id="txt_szsj" class="form-control input-radius" name="szsj" value="	2018-03-21"/>	
						</div>
                    </div>
					<div class="col-md-4">
						<div class="input-group">
					...
					<div class="col-md-12">
					    <div class="input-group">
						    <span class="input-group-addon">备注</span>
                          	<textarea id="txt_bz"  class="form-control" name="bz" style="height: 60px;">备注11</textarea>
					    </div>
					</div>
				</div>
			 </div>
					 ...
					 <table id="mydatatables" class="table table-striped table-bordered" style="border-collapse: collapse">
					    ...
					    <tbody id="tbody">
					    	<tr id="tr_1">
					    		...
					    		<td>
					    			  <input type="text" id="txt_jxmc" style="background-color: white !important;padding:4px;" value="指标1" class=" input-radius  null" name="jxmc" >
					    		</td>
					    		<td>
						    	      <input type="text" id="txt_jxqz" style="background-color: white !important;padding:4px;" value="20"  class=" input-radius  null" name="jxqz" >
					    		</td>
					    		...
					    		<td>
					    			  <input type="text" id="txt_jxsm" style="background-color: white !important;padding:4px;" value="这是我们的指标1"  class=" input-radius  null" name="jxsm" >
					    		</td>
					    	</tr>
					    	<tr id="tr_1">
					    		<td class="btn_td">
					    		...
					    		<td>
					    			  <input type="text" id="txt_jxmc" style="background-color: white !important;padding:4px;" value="过热后" class=" input-radius  null" name="jxmc" >
					    		</td>
					    		<td>
						    	      <input type="text" id="txt_jxqz" style="background-color: white !important;padding:4px;" value="80"  class=" input-radius  null" name="jxqz" >
					    		</td>
					    		<td><input type="radio" style="width:40px;" id="txt_jxqy1" name="jxqy" value="1" checked>是 
									<input type="radio" style="width:40px;" id="txt_jxqy2" name="jxqy" value="0" >否
					    		</td>
					    		<td>
					    			  <input type="text" id="txt_jxsm" style="background-color: white !important;padding:4px;" value="这是会突然又会让"  class=" input-radius  null" name="jxsm" >
					    		</td>
					    	</tr>
					    </tbody>
				   </table>
