...
<!-- 				<button type="button" class="btn btn-default pull-right" id="btn_back"> -->
<!-- 					<i class="fa icon-save"></i>返回 -->
<!-- 				</button> -->
				<c:if test="${'sh'!=sh && 'ck'!=ck}">
				<button type="button" class="btn btn-default pull-right" id="btn_save">
				...
				<div class='scrollable-area'>
					<form id="myform1">
						<table id="mydatatables"
							...
							<thead id="thead">
								<tr>
									<th style="text-align: center;" colspan="6"><h3>项目绩效目标申请表</h3></th>
								</tr>
