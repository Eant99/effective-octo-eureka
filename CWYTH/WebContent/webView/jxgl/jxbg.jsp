...
//打开Word文档
poCtrl.webOpen("/CWYTH/webView/cwjs/doc/jsbg2017.doc",OpenModeType.docNormalEdit,"张佚名");
%>
						...
						<div class="input-group">
							<span class="input-group-addon" >模型:</span>
							 <select class="form-control" id="xznd">
								  ...
								  <option value="2" selected = "selected">模型2</option>
								  <option value="3" >模型3</option>
								  <option value="4" >模型4</option>
							</select>
						</div>
   					 </div>
    </div>
 ...
 <script type="text/javascript" src="../pageoffice.js"  id="po_js_main"></script>
    ...
    $(document).ready(function() {
        $('#xznd').change(function(){
             var nd = $("#xznd").val();
             if(nd=='2'){
            	 location.href="/CWYTH/webView/cwjs/jsbg2017.jsp";
             }else if(nd=='3'){
            	 location.href="/CWYTH/webView/cwjs/jsbg.jsp";
             }else{
            	 location.href="/CWYTH/webView/cwjs/jsbg2016.jsp";
             }
        });
	});
        function Save() {
