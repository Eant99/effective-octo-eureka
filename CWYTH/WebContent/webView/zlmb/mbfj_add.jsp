		 ...
		 <!-- 附件设置 -->
		  <form id="table4" class="myform myformPzby" mc="addfjsz1">
			...
			<div class="box-header clearfix">
            	<div class="sub-title pull-left text-primary"><i class="fa icon-xiangxi"></i>目标分解详细信息</div>
            	<div class="actions">
        			...
        			<tbody id="tbody4">
        				<tr >
					    	...
					    	<td class="td_second_1" style="text-align:center;" valign="middle">
					    		<span class="required" style="color:red">*</span>部门名称
					    	</td>
					    	<td class="td_three_1" style="text-align:center;" valign="middle">
					    		<span class="required" style="color:red">*</span>一级指标
					    	</td>
					    	<td class="td_four_1"  style="text-align:center;" valign="middle">
					    		<span class="required" style="color:red">*</span>二级指标
					    	</td>
					    	<td class="td_five_1"  style="text-align:center;" valign="middle">
					    		<span class="required" style="color:red">*</span>指标内容
					    	</td>
        			 	...
        			 	<tr id="fjsztr_1" a='a'>
							...
							<input type="text" id="txt_bmbh" name="bmbh" class="form-control input-radius window" style="border-bottom-right-radius: 4px;border-top-right-radius: 4px;" placeholder="请输入部门名称" autocomplete="off" data-bv-field="bmbh">
						    <span class="input-group-btn"><button type="button" id="btn_bmbh" class="btn btn-link">选择</button></span>
						</div>
<!--         			 	 		<input type="text" id="txt_bmbh" name="bmbh" class="form-control input-radius window" style="border-bottom-right-radius: 4px;border-top-right-radius: 4px; width:70%;" placeholder="请输入部门名称" autocomplete="off" data-bv-field="bmbh"> -->
<!-- 					    		<span class="input-group-btn" style="width:17%;"><button type="button" id="btn_bmbh" class="btn btn-link" >选择</button></span> -->
					    	</td>
...
<!-- 								<textarea style="width:100%;height:60px;text-indent: 2em;" id="txt_ccsy" name="ccsy" data-bv-field="ccsy" class="form-control input-radius"></textarea> -->
							<input type="text"  a="a"  id="txt_fjbh" class="form-control input-radius" name="fjbh" style="border: 0px;" value=""/>
							</div>
					    	</td>
				   		</tr>
...
$(function(){
	...
	$("#btn_back").click(function(e){
		window.location.href  = "${ctx}/webView/zlmb/mbfj_list.jsp";
	});
	//联想输入
