			...
			<div class="container-fluid box-content">
	         ...
	         <input type="hidden" name="guid" id="guid" value="${guid1}">
				<div class="row">
					<div class="col-md-4">
						<div class="input-group">
								<span class="input-group-addon"><span class="required">*</span>目标名称</span>
							<input type="text" id="txt_bmh" class="form-control input-radius"   name="mbbh"  value=""/>
						</div>
					</div>
					<div class="col-md-4">
						<div class="input-group">
								<span class="input-group-addon"><span class="required">*</span>目标年度</span>
							<input type="text" id="txt_mc" class="form-control input-radius"  readonly="readonly" name="mbnd" value="2019 "/>
						</div>
					</div>
					<div class="col-md-4">
						<div class="input-group">
								<span class="input-group-addon"><span class="required">*</span>制定人员</span>
				...
				<div class="row">
					...
					<div class="col-md-4">
					<div class="input-group ">
							<span class="input-group-addon" style="border: 1px solid #ccc!important;vertical-align: middle; "><span class="required">*</span>指定日期</span>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="input-group">
							<span class="input-group-addon">目标主要内容</span>
				...
				</div><button type="button" class="btn btn-default" style="margin-left:10px;" id="btn_smsc_show">手机拍照</button>
			</div>
				<div class="container-fluid box-content">
				<div class="row">
					<div class="col-md-12">
						...
						<div class="input-group file-caption-main">
						   ...
						   <div class="input-group-btn">
						       ...
						       <div tabindex="500" class="btn btn-primary btn-file"><i class="glyphicon glyphicon-folder-open"></i>&nbsp;  <span class="hidden-xs">选择 …</span><input id="imageFile" name="path" type="file" multiple="" class=""></div>
						   </div>
...
$(function(){
	...
	$("#btn_back").click(function(e){
		var bz = "${param.bz}";
		if(bz == "zlzd"){
			window.location.href  = "${ctx}/webView/zlmb/zlzd_list.jsp";
		}else{
