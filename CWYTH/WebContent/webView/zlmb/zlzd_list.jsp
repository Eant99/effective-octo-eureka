...
<!-- 				            <th>财务处</th> -->
<!-- 				            <th>2018-1-29</th> -->
<!-- 				            <th style="text-align:center"><a id="btn_edit" herf="/webView/zlmb/zlzd_add.jsp">编辑</a>|<a id="btn_del1" herf="javascript:void(0)">删除</a></th> -->
<!-- 				    </tr> -->
				    </thead>
				    <tbody>
				    </tbody>
...
$(function () {
    ...
    table = getDataTableByListHj("mydatatables","${ctx}/webView/zlmb/zlzd.json",[2,'asc'],columns,0,1,setGroup);

   	$("#btn_add").click(function(){
//    		doOperate("${ctx}/xmlx/goEditPage","C");
   		window.location.href  = "${ctx}/webView/zlmb/zlzd_add.jsp?bz=zlzd";
   	});
