	...
	<div class="box">
		<div class="box-panel">		
			...
			<div class="row">
					...
					<input type="text" class="form-control" id="txt_ghdw" name="skr"  value="${pj.skr}" readonly/>
					<span class="input-group-btn"><button type="button" id="btn_ghdw" class="btn btn-link">选择</button></span>
					</div>
				</div></div>
				<div class="row">
					<div class="col-sm-12">
					...
					<input type="text" class="form-control" id="txt_xhdw" name="cpr"  value="${pj.cpr}" readonly/>
					<span class="input-group-btn"><button type="button" id="btn_xhdw" class="btn btn-link">选择</button></span>
					</div>
				</div></div>
				<div class="row">
					<div class="col-sm-6">
					...
					<input type="text" class="form-control" id="" name="shdwdh"  value="${pj.xhdwdh}" />
					</div>
				</div></div><div class="row">
					<div class="col-sm-12">
					<div class="input-group">
					<span class="input-group-addon"><span class="required">*</span>销货单位地址</span> 
					<input type="text" class="form-control" id="" name="shdwdz"  value="${pj.xhdwdz}" />
...
// 			console.log($(this).prop("checked"));
		...
		$("#btn_save").click(function(e){	
				...
				doSave1(validate,"myform","${ctx}/pjgl/rcyw/pjlb/doSavePtfp?guid=${guid}",function(val){
...
//	 				dataType:"json",
	...
	$(document).on("click","#btn_xhdw",function(){
		select_commonWin("${ctx}/window/dwpage?controlId=txt_xhdw","部门信息","920","630");
	});
	$(document).on("click","#btn_ghdw",function(){
		select_commonWin("${ctx}/window/dwpage?controlId=txt_ghdw","部门信息","920","630");
	});
	//领用人
