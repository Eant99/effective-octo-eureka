			...
			<div class="row">
				<div  class="col-sm-6">
					<div class="input-group">
						...
						<input type="text" class="form-control" name="cprq"  value="${cprq}" readonly/>
					</div>
				</div>
				<div class="col-sm-6">
				<div class="input-group">
					<span class="input-group-addon"><span class="required">*</span>发票号码</span> 
					<input type="text" class="form-control" name="pjh" value="${pj.pjh}" readonly/>
				</div>
				</div>
			</div>
			<div class="row">
				...
				<div class="input-group">
					...
					<input type="text" class="form-control" name="je" value="${pj.je}"/>
				</div>
				</div>
			</div>
			<div class="row">
					...
					<input type="text" class="form-control" id="txt_skr" name="skr"  value="${pj.skr}" readonly/>
				...
				<div class="row">
					<div class="col-sm-6">
					<div class="input-group">
					<span class="input-group-addon"><span class="required">*</span>购货单位纳税人识别号</span> 
					<input type="text" class="form-control" name="ghdwsbm"  value="${pj.ghdwsbm}" />
					</div>
				</div>
					<div class="col-sm-6">
					<div class="input-group">
					<span class="input-group-addon"><span class="required">*</span>购货单位电话</span> 
					<input type="text" class="form-control" name="ghdwdh"  value="${pj.ghdwdh}" />
					
					</div>
				</div></div><div class="row">
					<div class="col-sm-12">
					<div class="input-group">
					<span class="input-group-addon"><span class="required">*</span>购货单位地址</span> 
					<input type="text" class="form-control" name="ghdwdz"  value="${pj.ghdwdz}" />
					</div>
				</div></div><div class="row">
					<div class="col-sm-6">
					<div class="input-group">
					<span class="input-group-addon"><span class="required">*</span>购货单位开户行</span> 
					<input type="text" class="form-control" name="skyh"  value="${pj.skyh}" />
					</div>
				</div>
					<div class="col-sm-6">
					<div class="input-group">
					<span class="input-group-addon"><span class="required">*</span>购货单位账号</span> 
					<input type="text" class="form-control" name="skzh"  value="${pj.skzh}" />
					</div>
				</div></div>
				<div class="row">
					<div class="col-sm-12">
					...
					<input type="text" class="form-control" id="txt_cpr" name="cpr"  value="${pj.cpr}" readonly/>
				...
				<div class="row">
					...
					<input type="text" class="form-control" id="txt_kpr" name="kpr"  value="${pj.kpr}" readonly/>
				...
				<div class="col-sm-6">
					...
					<input type="text" class="form-control" name="zdr"  value="${zdr}" readonly/>
					</div>
				</div></div>  
...
$(function(){
   ...
   //返回按钮
	...
	var validate = $("#myform").bootstrapValidator({fields:{
        ...
        ghdwsbm:{validators:{notEmpty:{message:'不能为空'}}},
        ghdwdh:{validators:{notEmpty:{message:'不能为空'}}},
        ghdwdz:{validators:{notEmpty:{message:'不能为空'}}},
        skyh:{validators:{notEmpty:{message:'不能为空'}}},
        skzh:{validators:{notEmpty:{message:'不能为空'}}},
        cpzh:{validators:{notEmpty:{message:'不能为空'}}},
        cpr:{validators:{notEmpty:{message:'不能为空'}}},
		shdwsbm:{validators:{notEmpty:{message:'不能为空'}}},
		shdwdh:{validators:{notEmpty:{message:'不能为空'}}},
		shdwdz:{validators:{notEmpty:{message:'不能为空'}}},
...
// 			console.log($(this).prop("checked"));
		...
		$("#btn_save").click(function(e){	
				...
				doSave1(validate,"myform","${ctx}/pjgl/rcyw/pjlb/doSaveZzsfp?guid=${guid}",function(val){
...
//	 				dataType:"json",
	...
	//保存按钮
	$(document).on("click","#btn_skr",function(){
		select_commonWin("${ctx}/window/dwpage?controlId=txt_skr","部门信息","920","630");
	});
	$(document).on("click","#btn_cpr",function(){
		select_commonWin("${ctx}/window/dwpage?controlId=txt_cpr","部门信息","920","630");
	});
	//领用人
	$("#btn_kpr").click(function(){
		select_commonWin("${ctx}/window/rypage?controlId=txt_kpr","选择开票人","850","630");
    });
