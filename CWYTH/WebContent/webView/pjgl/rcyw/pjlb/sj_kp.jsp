...
<div class="row">
			...
			<div class="row">
				...
				<div class="row">
					...
					<input type="text" class="form-control" name="fjxx"  value="${pj.fjxx}" />
					</div>
				</div></div><div class="row">
					<div class="col-sm-12">
					<div class="input-group">
					<span class="input-group-addon"><span class="required">*</span>年月日</span> 
					<input type="text" class="form-control date"  data-format="yyyy-mm-dd -hh-mm-ss" name="nyr"  value="${pj.nyr}"/></div>
					</div>
				</div></div>
				<div class="row">
					<div class="col-sm-6">
...
// 			console.log($(this).prop("checked"));
		...
		$("#btn_save").click(function(e){	
				...
				doSave1(validate,"myform","${ctx}/pjgl/rcyw/pjlb/doSaveSj?guid=${guid}",function(val){
