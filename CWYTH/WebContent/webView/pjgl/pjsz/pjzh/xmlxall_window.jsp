...
$(function () {
    ...
    var columns = [
    	  {"data": "GUID",orderable:false, 'render': function (data, type, full, meta){
    	         return '<input type="checkbox" name="guid" mc="'+full.PJLXMC+'" bmc="'+full.PJLXBH+'" class="keyId" value="' + data + '" guid = "'+full.GUID+'">';
    	       },"width":10,'searchable': false},
    	       {"data":"_XH",orderable:false,'render':function(data,type,full,meta){
    	          	return data;},"width":41,"searchable":false,"class":"text-center"},
    	       {"data": "PJLXBH",defaultContent:"","class":""},
    	       {"data": "PJLXMC",defaultContent:""},
    ...
    table = $('#mydatatables').DataTable({
        ajax: {
            url: "${ctx}/pjgl/pjzh/getPageListTc"//获取数据的方法
        },
       ...
       "serverSide": true,
        "columns": columns,
          "language":{
         	"search":"",
             "searchPlaceholder":"请输入票据类型编号或票据类型名称"
        },  
  ...
  */   });
    ...
    $(document).on("dblclick","#mydatatables tr:not(#header)",function(){
     	...
     	var pid = $(this).find("[name='guid']").attr("guid");
     	...
     	if(val==''||val==null||val=='undefined'){
     		...
     		getIframeControl("${param.pname}","${param.pid}").val(pid);
