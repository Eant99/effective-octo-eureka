		...
		<form id="myform" class="form-inline" action="" style="padding-top: 10px;padding-bottom: 2px;">
			<div class="search-simple">
				<div class="form-group">
					<label>账户名称</label>
					<input type="text" id="txt_mbbh" class="form-control" name="zhmc" table="k" placeholder="请输入票据用途名称">
				</div>
				<!-- <div class="form-group">
					<label>账套内容</label>
...
$(function () {
    ...
    var columns = [
       ...
       {"data": "ZHMC",defaultContent:"","width":150}, 
       {"data": "PJLXMC",defaultContent:"","class":"","width":150},
	 ...
	 table = getDataTableByListHj("mydatatables","${ctx}/pjgl/pjzh/getPageList",[2,'asc'],columns,0,1,setGroup);
	 
  	//添加按钮
  	$(document).on("click","#btn_add",function(){
   		doOperate("${ctx}/pjgl/pjzh/goEditPage?operateType=C","C");
   	});
  	...
  	$(document).on("click","#btn_export",function(){
   		...
   		doExp("","${ctx}/pjgl/pjzh/expExcel2","票据账户信息","${pageContext.request.contextPath}",id);
	...
	$(document).on("click",".btn_upd",function(){
   		...
   		doOperate("${ctx}/pjgl/pjzh/goEditPage?operateType=U&guid="+guid,"U");
   	});
