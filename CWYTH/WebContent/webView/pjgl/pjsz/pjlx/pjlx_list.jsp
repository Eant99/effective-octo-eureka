		...
		<form id="myform" class="form-inline" action="" style="padding-top: 10px;padding-bottom: 2px;">
			<div class="search-simple">
				<div class="form-group">
					<label>票据类型名称</label>
					<input type="text" id="txt_mbbh" class="form-control" name="pjlxmc" table="k" placeholder="请输入票据用途名称">
				</div>
				<!-- <div class="form-group">
					<label>账套内容</label>
...
$(function () {
    ...
    var columns = [
       ...
       {"data": "PJLXBH",defaultContent:"","width":150}, 
	 ...
	 table = getDataTableByListHj("mydatatables","${ctx}/pjgl/pjlx/getPageList",[2,'asc'],columns,0,1,setGroup);


  	//添加按钮
  	$(document).on("click","#btn_add",function(){
   		doOperate("${ctx}/pjgl/pjlx/goEditPage?operateType=C","C");
   	});
	//导出Excel
  //导出Excel
...
//    	$("#btn_export").click(function() {
   		...
   		doExp("","${ctx}/pjgl/pjlx/expExcel2","项目信息","${pageContext.request.contextPath}",id);
   ...
   /* 	$(document).on("click",".btn_upd",function(){
	...
	$(document).on("click",".btn_upd",function(){
   		...
   		doOperate("${ctx}/pjgl/pjlx/goEditPage?operateType=U&guid="+guid,"U");
   	});
