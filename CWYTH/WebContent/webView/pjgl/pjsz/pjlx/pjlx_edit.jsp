...
<!-- 			   		<button type="button" class="btn btn-default" id="btn_back">返回列表</button> -->
			...
			<div class="container-fluid box-content">
				<div class="row">
					<div class="col-md-4 col-md-offset-4">
						<div class="input-group">
							<span class="input-group-addon"><span class="required">*</span>票据类型代码</span>
                            <c:if test="${operateType == 'C'}">
	                            <input type="text" id="" class="form-control input-radius"  name="pjlxbh" value="" >
							</c:if>
							<c:if test="${operateType == 'U'}">
								<input type="text" id="" class="form-control input-radius"  readonly="readonly" name="pjlxbh" value="${pjlxMap.pjlxbh}" >
							</c:if>
				...
				<div class="row">	
					<div class="col-md-4 col-md-offset-4">
						<div class="input-group">
							<span class="input-group-addon"><span class="required">*</span>票据类型名称</span>
							<c:if test="${operateType == 'C'}">
							<input type="text" id=""  class="form-control input-radius" name="pjlxmc" value=""/>
							</c:if>
							<c:if test="${operateType == 'U'}">
							<input type="text" id=""  class="form-control input-radius" name="pjlxmc" value="${pjlxMap.pjlxmc}"/>
							</c:if>
						</div>
					</div>
				</div>
				<%-- <div class="row">	
					<div class="col-md-6">
						<div class="input-group ">
							...
							<c:if test="${operateType == 'U'}">
	                			 &nbsp; &nbsp;
									<input type="radio" name="sfqy" class="rdo" value="${pjlxMap.sfqy}" <c:if test="${pjlxMap.sfqy=='1' }"> checked</c:if>/>
									<label>是</label>
								 &nbsp; &nbsp; &nbsp;
									<input type="radio" name="sfqy" class="rdo" value="${pjlxMap.sfqy}"  <c:if test="${pjlxMap.sfqy=='0' }"> checked</c:if> />
									<label>否</label>
							</c:if>
							</div>
						</div>
				...
				<div class="row">	
					 ...
					 <div class="col-md-12">
						<div class="input-group">
                            ...
                            <textarea id="txt_zynr" class="form-control" name="bz" ><c:if test="${operateType == 'U'}">${pjlxMap.bz}</c:if></textarea>
						</div>
					</div>
...
$(function(){
   ...
   //返回按钮
 	$("#btn_back").click(function(e){
 			location.href="${ctx}/pjgl/pjlx/goPjlxPage";	
 	});
	var validate = $("#myform").bootstrapValidator({fields:{
		pjlxbh:{validators:{notEmpty: {message: '票据类型代码不能为空'}}},
		pjlxmc:{validators:{notEmpty: {message: '票据类型名称不能为空'}}}
...
// 			console.log($(this).prop("checked"));
		...
		$("#btn_save").click(function(e){	
				...
				doSave1(validate,"myform","${ctx}/pjgl/pjlx/doSave?operateType=${operateType}",function(val){
