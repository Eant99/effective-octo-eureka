	...
	<div class="box">
		<div class="box-panel">		
			<div class="box-header1 clearfix">
            	<div class="sub-title pull-left text-primary"><i class="fa icon-xiangxi"></i>校外人员薪资申报信息
            	</div>
	                          	...
	                          	<tr id="tr_1">
							    		...
							    		<td>
							    			<select id="txt_yhkh_1" name="yhkh" class="bk input-radius">
													...
													<option value="${dlryhklist.khyh}">${yhklist.klx}</option>
													</c:forEach>
											</select>
							    		</td>
										<td>
...
$(function(){
	...
	function xsxx(bz){
		...
		select_commonWin("${ctx}/webView/srgl/xwryxxcj/xwryxxcj_select_list.jsp?controlId="+controlId+"&controlId2="+controlId2+"&controlId3="+controlId3+"&guid="+guid,"校外人员信息","900","620");
	}
	//查询银行卡
