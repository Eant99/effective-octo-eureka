		...
		<center>
			<tr style="height:25px;">
		       <td colspan="3" align="center" style="height: 40px">
                 <span id="txt_bbmc" style="font-size: 16pt">预算结转结余变动表</span>
               </td>
	        </tr>
	    </center>
...
<!-- 					</div> -->
<!-- 				</div> -->
				<table id="mydatatables" class="table table-striped table-bordered" style="width: 100%;margin:0 auto 30px">
		        	<thead>
				        <tr>
				        	<th rowspan="2">项目</th>
				        	<th colspan="2">年初财政拨款结转结余</th>
				        	<th rowspan="2">调整年初财政拨款结转结余</th>
				        	<th rowspan="2">本年归集调入</th>
				        	<th rowspan="2">本年归集上缴或调出</th>
				        	<th colspan="2">单位内部调剂</th>
				        	<th rowspan="2">本年财政拨款收入</th>
				        	<th rowspan="2">本年财政拨款支出</th>
				        	<th colspan="2">年末财政拨款结转结余</th>
				        </tr>
				        <tr>
				        	<th>结转</th>
				        	<th>结余</th>
				    ...
				    <tbody>
				    	<c:forEach items="${list}" var="list">
				    		<tr>
					    		<td>${list.XMMC}</td>
					    		<td style="text-align:right;">${list.NCJZ}</td>
					    		<td style="text-align:right;">${list.NCJY}</td>
					    		<td style="text-align:right;">${list.TZNCCZBK}</td>
					    		<td style="text-align:right;">${list.BNGJTR}</td>
					    		<td style="text-align:right;">${list.BNGJSJ}</td>
					    		<td style="text-align:right;">${list.DWNBJZ}</td>
					    		<td style="text-align:right;">${list.DWNBJY}</td>
					    		<td style="text-align:right;">${list.BNCZBKSR}</td>
					    		<td style="text-align:right;">${list.BNCZBKZC}</td>
					    		<td style="text-align:right;">${list.NMJZ}</td>
					    		<td style="text-align:right;">${list.NMJY}</td>
				    		</tr>
				    	</c:forEach>
				    </tbody>
				</table>
