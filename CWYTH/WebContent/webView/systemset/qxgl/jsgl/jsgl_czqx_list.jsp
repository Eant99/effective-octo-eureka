...
<body>
	<form id="myform" class="form-horizontal" action="" method="post" style="overflow:auto;height:650px;">
		<input type="hidden" name="MKBH" value="">
		<input type="hidden" name="RYBH" value="${jsxx.jsbh}">
		<div class='page-header'>
			<div class="pull-left">
				<span class="page-title text-primary"> <i
					class='fa icon-svg33'></i> 角色&ensp;<span style="color: red;">[${jsxx.jsbh}]${jsxx.jsmc}</span>&ensp;的操作权限
				</span>
			</div>
...
<script type="text/javascript">
	$(function() {
		...
		$("#btn_save").click(
		function(e) {
			var $checkeds = $("table").find(".haveOper")
					.parent().find(":radio").filter(
							":checked");
			var mkbhs = [];
			...
			$("[name='MKBH']").val(mkbhs);
			doSave(validate,"myform","${ctx}/jsxx/doSaveCzqx",function(val) {
