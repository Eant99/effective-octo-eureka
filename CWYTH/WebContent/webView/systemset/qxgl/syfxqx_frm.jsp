...
//配置iframeUlr
var _pageUrl="${ctx}/syfxqx/findSyfxqxszList";
//权限标志
var _type="self";
Ext.onReady(function(){
    ...
    var right = new Ext.Panel({
         ...
         title:"",
         autoScroll:true,
         html: "<iframe frameborder='0' width='100%' height='100%' scrolling='auto' id='iframe_list_${param.mkbh}' name='iframe_list_${param.mkbh}'></iframe>",
         border: true
    });
	/*创建窗体分割器*/
    new Ext.Viewport({
   		   ...
   		   $.ajax({
				...
				success:function(result){
					if(result.trim() != ""&&result.trim() != "F"){
						$("#iframe_list_${param.mkbh}").attr("src","${ctx}/syfxqx/findSyfxqxszList?rybh="+result);
