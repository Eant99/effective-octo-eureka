					...
					<td style="vertical-align: top;">
						...
						<div class="box" style="margin:0px;padding:0px;border-top:0px;">
							<div class="box-panel" style="border-top:0px;">
								...
								<c:if test="${jxqk.size() !=0}">
								    <div class="row" style="font-weight:bold;">
								        <div class="col-md-2">
									        <div class="input-group">
										        <span class="">进修种类</span>
											</div>
										</div>
										<div class="col-md-2">
											<div class="input-group">
												<span class="">进修开始日期</span>
											</div>
										</div>
										<div class="col-md-2">
											<div class="input-group">
												<span class="">进修时间（月）</span>
											</div>
										</div>
										<div class="col-md-5">
											<div class="input-group">
												<span class="">进修内容</span>
											</div>
										</div>
								  </div>
								<c:forEach var="jxqk" items="${jxqk}" varStatus="i" >
									<div class="row">
										<div class="col-md-2">
											<div class="input-group">
												<span class="">${jxqk.jxzl}</span>
											</div>
										</div>
										<div class="col-md-2">
											<div class="input-group">
												<span class="">${jxqk.jxrq}</span>
											</div>
										</div>
										<div class="col-md-2">
											<div class="input-group ">
												<span class="">&emsp;&emsp;&emsp;&emsp;&emsp;${jxqk.jxsj}</span>
											</div>
										</div>
										<div class="col-md-5">
											<div class="input-group">
												<span class="">${jxqk.jxnr}</span>
											</div>
										</div>
									</div>
								</c:forEach>
