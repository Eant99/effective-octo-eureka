					...
					<td style="vertical-align: top;">
						...
						<div class="box" style="margin:0px;padding:0px;border-top:0px;">
							<div class="box-panel" style="border-top:0px;">
								...
								<c:if test="${lwqk.size() !=0}">
								<div class="row" style="font-weight:bold;">
								    <div class="col-md-2">
										<div class="input-group">
											<span class="">发表日期</span>
										</div>
									</div>
									<div class="col-md-3">
										<div class="input-group">
											<span class="">论文题目</span>
										</div>
									</div>
									<div class="col-md-2">
										<div class="input-group">
											<span class="">论文级别</span>
										</div>
									</div>
									<div class="col-md-4">
										<div class="input-group">
											<span class="">所发刊物</span>
										</div>
									</div>
								</div>
								<c:forEach var="lwqk" items="${lwqk}" varStatus="i" >
									<div class="row">
										<div class="col-md-2">
											<div class="input-group">
												<span class="">${lwqk.rq}</span>
											</div>
										</div>
										<div class="col-md-3">
											<div class="input-group">
												<span class="">${lwqk.lwtm}</span>
											</div>
										</div>
										<div class="col-md-2">
											<div class="input-group">
												<span class="">${lwqk.lwjb}</span>
											</div>
										</div>
										<div class="col-md-4">
											<div class="input-group">
												<span class="">${lwqk.sfkw}</span>
											</div>
										</div>
									</div>
								</c:forEach>
