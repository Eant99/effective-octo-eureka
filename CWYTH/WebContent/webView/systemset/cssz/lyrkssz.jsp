...
$(function () {
	...
	$(document).on("click","#btn_add",function() {
		select_commonWin("${ctx}/cyflsz/getEditPage?operateType=C&lx=0","常用分类设置", "400", "450");
	})
	//修改操作
	$(document).on("click",".btn_upd",function() {
		var gid = $(this).parents("tr").find("[name='gid']").val();
		select_commonWin("${ctx}/cyflsz/getEditPage?operateType=U&lx=0&gid="+gid,"常用分类设置", "400", "450");
	});
 	//删除
	...
	table = $('#mydatatables').DataTable({
   	    ajax: {
   	    	url: "${pageContext.request.contextPath}/cyflsz/getPageList?lx=0",//获取数据的方法
   	    },
