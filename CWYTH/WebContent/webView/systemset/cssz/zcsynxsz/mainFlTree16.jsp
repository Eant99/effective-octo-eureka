...
//配置iframeUlr
var _pageUrl="${pageContext.request.contextPath}/webView/systemset/cssz/zcsynxsz/zcsynx_list.jsp?pname=${param.pname}&controlId=${param.controlId}&Next=${param.Next}&windowModel=${param.windowModel}";
