							...
							<div class="box-panel" style="border-top:0px;">
								...
								<c:if test="${zzqk.size() !=0}">
								    <div class="row"  style="font-weight:bold;">
										...
										<div class="col-md-2">
											<div class="input-group">
												<span class="">著作级别</span>
											</div>
										</div>
										<div class="col-md-7">
											<div class="input-group">
												<span class="">著作名称</span>
											</div>
										</div>
								    </div>
								<c:forEach var="zzqk" items="${zzqk}" varStatus="i" >
									<div class="row">
										<div class="col-md-2">
											<div class="input-group">
												<span class="">${zzqk.rq}</span>
											</div>
										</div>
										<div class="col-md-2">
											<div class="input-group">
												<span class="">${zzqk.zzjb}</span>
											</div>
										</div>
										<div class="col-md-7">
											<div class="input-group">
												<span class="">${zzqk.zzmc}</span>
											</div>
										</div>
									</div>
								</c:forEach>
