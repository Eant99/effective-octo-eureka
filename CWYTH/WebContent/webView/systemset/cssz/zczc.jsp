...
<div class="fullscreen">
	 <div class="search" id="searchBox">
		<div class="clearfix">
			<div class="pull-left sub-title text-primary">资产自查设置</div>
...
$(function () {
	...
	table = getDataTableByListHj("mydatatables","${pageContext.request.contextPath}/zcqc/getPageList?flag=zczc",[2,'desc'],columns,0,1,setGroup);
	//添加新过程按钮
	$(document).on("click","#btn_add",function(){
		...
		$.ajax({
			...
			success:function(val){
				 if(val.success=='true'){
					doSave(null,"myform","${pageContext.request.contextPath}/zcqc/doSave?flag=zczc",function(val){
						table.ajax.reload();
					});
				}else{
