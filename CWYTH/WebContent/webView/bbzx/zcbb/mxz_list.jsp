			...
			<table id="mydatatables" class="table table-striped table-bordered">
		        	<thead>
				        <tr>
				            ...
				            <th style="text-align:center;" id="tr_kmbh">对方科目</th>
				            ...
				            <th style="text-align:center;" id="tr_bm">余额</th>
				        </tr>
					</thead>
				    <tbody>
...
$(function () {
	var columns = [
	               ...
	               {"data": "FHYJ",defaultContent:"这是摘要","id":"tr_zy","class":"text-center"},
	               {"data": "FHYJ",defaultContent:"功能科目","id":"tr_kmbh","class":"text-center"},
	               {"data": "FHYJ",defaultContent:"张三","id":"tr_kmmc","class":"text-center"},
	               {"data": "JFJEHJ",defaultContent:"李四","class":"text-right"},
	               {"data": "DFJEHJ",defaultContent:"500.00","class":"text-right"},
	               {"data": "FHYJ",defaultContent:"1000.00","id":"tr_bm","class":"text-right"}
