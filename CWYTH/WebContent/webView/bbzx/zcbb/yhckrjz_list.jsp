	...
	<div class="container-fluid">
		<center>
			<tr style="height:25px;">
		       <td colspan="3" align="center" style="height: 40px">
                 <span id="txt_bbmc" style="font-size: 16pt">银行存款日记账</span>
               </td>
	        </tr>
	    </center>
	    ...
	    <div class="btn-group pull-right" role="group">
	    	 <td align="right" valign="bottom" style="width: 400px; height: 20px;">
                                打印日期：
                 <input name="txt_dyrq" type="text" id="txt_dyrq" style="width: 80px;" class="input_info date "onfocus="javascript:WdatePicker();" value="2017-10-25">
                </td>
	    </div>
	    <div class="form-group">
