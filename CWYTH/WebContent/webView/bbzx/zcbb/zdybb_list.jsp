			...
			<table id="mydatatables" class="table table-striped table-bordered">
		        	<thead>
				        <tr>
				            ...
				            <th style="text-align:center;" id="tr_pzrq">科目编号</th>
				            <th style="text-align:center;" id="tr_pzzh">科目名称</th>
				            <th style="text-align:center;" id="tr_zy">年初余额</th>
				            <th style="text-align:center;" id="tr_kmbh">借方金额</th>
				            <th style="text-align:center;" id="tr_kmmc">贷方金额</th>
				            <th style="text-align:center;" id="tr_bm">期末余额</th>
...
$(function () {
	var columns = [
	               ...
	               {"data": "PZRQ",defaultContent:"001","class":"text-center"},
	               {"data": "PZBH",defaultContent:"会计科目","id":"tr_pzzh","class":"text-center"},
	               {"data": "FHYJ",defaultContent:"3256.00","id":"tr_zy","class":"text-right"},
	               {"data": "FHYJ",defaultContent:"2365.00","id":"tr_kmbh","class":"text-right"},
	               {"data": "FHYJ",defaultContent:"4561.00","id":"tr_kmmc","class":"text-right"},
	               {"data": "FHYJ",defaultContent:"3654.00","id":"tr_bm","class":"text-right"}
