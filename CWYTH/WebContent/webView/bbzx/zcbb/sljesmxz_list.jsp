		...
		<center>
			<tr style="height:25px;">
		       <td colspan="3" align="center" style="height: 40px">
                 <span id="txt_bbmc" style="font-size: 16pt">数量金额式明细账</span>
               </td>
	        </tr>
	    </center>
			...
			<table id="mydatatables" class="table table-striped table-bordered" style="border-collapse:collapse">
		        	<thead>
				        <tr>
				            ...
				            <th rowspan="2" style="text-align:center;">凭证字号</th>
				            <th rowspan="2" style="text-align:center;">摘要</th>
				            <th colspan="3" style="text-align:center;">借方</th>
				            <th colspan="3" style="text-align:center;" >贷方</th>
				            <th rowspan="2" style="text-align:center;">借贷</th>
				            <th colspan="3" style="text-align:center;">余额</th>
				       </tr>
				       <tr>
				            <th style="text-align:center;" >数量</th>
				            <th style="text-align:center;" >单价</th>
				            <th style="text-align:center;" >本币</th>
				            <th style="text-align:center;" >数量</th>
				            <th style="text-align:center;" >单价</th>
				            <th style="text-align:center;" >本币</th>
				            <th style="text-align:center;" >数量</th>
