	...
	<div class="container-fluid">
		<center>
			<tr style="height:25px;">
		       <td colspan="3" align="center" style="height: 40px">
                 <span id="txt_bbmc" style="font-size: 16pt">科目余额表</span>
               </td>
	        </tr>
	    </center>
	    ...
	    <div class="btn-group pull-right" role="group">
	    	 <td align="right" valign="bottom" style="width: 400px; height: 20px;">
                                打印日期：
                 <input name="txt_dyrq" type="text" id="txt_dyrq" style="width: 80px;" class="radiodiv input_info date "onfocus="javascript:WdatePicker();" value="2017-10-25">
                </td>
	    </div>
	    <div class="form-group">
			...
			<table id="mydatatables" class="table table-striped table-bordered">
		        	<thead>
				        <tr>
				            ...
				            <th style="text-align:center;" id="tr_zy">期初余额（元）</th>
				            <th style="text-align:center;" id="tr_kmbh">本期借方发生额（元）</th>
				            <th style="text-align:center;" id="tr_kmmc">本期贷方发生额（元）</th>
				            <th style="text-align:center;" id="tr_jfje">方向</th>
				            <th style="text-align:center;" id="tr_dfje">期末余额（元）</th>		
				        </tr>
					</thead>
				    <tbody>
				    </tbody>
