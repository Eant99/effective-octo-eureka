		...
		<center>
			<tr style="height:25px;">
		       <td colspan="3" align="center" style="height: 40px">
                 <span id="txt_bbmc" style="font-size: 16pt">单位往来余额表</span>
               </td>
	        </tr>
	    </center>
...
<div class="container-fluid">
		<div class='responsive-table'>
			...
			<table id="mydatatables" class="table table-striped table-bordered">
		        	<thead>
				        <tr>
				            <th style="text-align:center;" id="tr_pzrq">单位名称</th>
				            <th style="text-align:center;" id="tr_pzzh">往来编号</th>
				            <th style="text-align:center;" id="tr_zy">往来名称</th>
				            <th style="text-align:center;" id="tr_kmbh">日期</th>
				            <th style="text-align:center;" id="tr_kmmc">凭证号</th>
				            <th style="text-align:center;" id="tr_jfje">摘要</th>
