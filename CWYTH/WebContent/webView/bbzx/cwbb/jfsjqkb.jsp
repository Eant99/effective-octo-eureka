		...
		<div class='responsive-table'>
			...
			<div class='scrollable-area'> 
				...
				<table id="mydatatables" class="table table-striped table-bordered" style="border-collapse:collapse;">
		        	<thead>
				        <tr>
				        	<th rowspan="3">项目单位</th>
				        	<th colspan="4">应收经费</th>
				        	<th rowspan="2" colspan="2">拨缴经费收入<br />（本级）</th>
				        	<th colspan="4">应付经费</th>
				        	<th rowspan="3">已付上级经费</th>
				        	<th rowspan="3">应付未付上级经费</th>
				        </tr>
				        <tr>
				        	<th colspan="2">应收上级经费</th>
				        	<th colspan="2">应收下级经费</th>
				        	<th colspan="2">应付上级经费</th>
				        	<th colspan="2">应付下级经费</th>
				        </tr>
				        <tr>
				        	<th>比例</th>
				        	<th>金额</th>
