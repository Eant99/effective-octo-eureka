...
<!--                 </ul>   -->
<!-- 	    </div> -->
	   <div style="margin-left: 48.5%;margin-top:10px;font-size:14px;">    
               ${sysDate}年
	   </div>
			...
			<table id="mydatatables" class="table table-striped table-bordered" style="border-collapse:collapse;width:62%;margin:0 auto 30px">
		        	<thead>
				        <tr>
				            ...
				            <th style="text-align:center;width:35%">上年累计数</th>				           
				        </tr>
					</thead>
				    <tbody>
				    <c:forEach var="list" items="${list}" varStatus="i">
				 		<tr class="tr_${i.index+1}">
				 			...
				 			<td class="num" role="bys">
				 				<input type="text" name="bys" flag="${list.FLAG}" class="form-control sign-number" style="text-align:right;" ${list.READ} value="${list.BYS}"/>
				 			</td>
