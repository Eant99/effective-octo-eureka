		...
		<form id="myform" class="form-inline" action="" style="padding-top: 8px;padding-bottom: 2px;">
			<div class="search-simple">
				<div class="form-group">
					...
					至<input  name="" class="input_info date form-control" style="width:100px;" value="2017-10-31" data-format="yyyy-MM-dd"/>
					&nbsp;
				</div>
		...
		<center>
			<tr style="height:25px;">
		       <td colspan="3" align="center" style="height: 40px">
                 <span id="txt_bbmc" style="font-size: 16pt">事业单位支出明细表</span>
               </td>
	        </tr>
	    </center>
			...
			<table id="mydatatables" class="table table-striped table-bordered" style="border-collapse:collapse;">
		        	<thead>
				        <tr>
				            ...
				            <th rowspan="2" style="text-align:center;width: 180px;" id="tr_pzrq" >项目</th>
				            <th colspan="3" style="text-align:center;" id="tr_pzzh">财政补助支出</th>
				            <th colspan="3" style="text-align:center;" id="tr_zy">非财政补助支出</th>
				            <th colspan="3" style="text-align:center;" id="tr_zy">事业支出</th>
				            
				           
				        </tr>
				        <tr>
				            <th style="text-align:center;" id="tr_pzrq">小计</th>
				            <th style="text-align:center;" id="tr_pzzh">基本支出</th>
				            <th style="text-align:center;" id="tr_zy">项目支出</th>
				             <th style="text-align:center;" id="tr_pzrq">小计</th>
				            <th style="text-align:center;" id="tr_pzzh">基本支出</th>
				            <th style="text-align:center;" id="tr_zy">项目支出</th>
				           <th style="text-align:center;" id="tr_pzrq">合计</th>
				            <th style="text-align:center;" id="tr_pzzh">基本支出</th>
				            <th style="text-align:center;" id="tr_zy">项目支出</th>
				        </tr>
					</thead>
