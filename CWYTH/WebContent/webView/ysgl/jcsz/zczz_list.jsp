	...
	var columns = [
	    ...
	    {"data": "MC",defaultContent:"",'render': function (data, type, full, meta){
	   	...
	   	{"data": "BMH",defaultContent:"",'render': function (data, type, full, meta){
	         return '<input disabled="disabled" display="none"  type="type" name="ZYBM" style="text-align: center;width:100%;border:none; border-radius: 4px;"  value="2016-10-10" guid = "">';
	       },"width":300},
		...
		{"data": "JC",defaultContent:"",'render': function (data, type, full, meta){
	         return '<input disabled="disabled" display="none"  type="type" name="ZYBM" style="width:100%;border:none;text-align:right;" class="number"  value="<fmt:formatNumber value="90" pattern="0.0000"/>" guid = "'+full.ZYBM+'">';
	       },"width":300},
	   	{"data": "JC",defaultContent:"",'render': function (data, type, full, meta){
  ...
  //保存按钮
  	...
  	//添加按钮
   	$("#btn_add").click(function(){
		...
		trObj.innerHTML = "<td><input type='checkbox' class='keyId' name='keyId' value=''></td>"+
		...
		"<td><input display='none'  id='date"+i+"'  type='type' name='ZYBM' style='text-align: center;width:100%;border:none;padding:0px 0px;font-size: inherit;line-height: inherit;' class='form-control date'/></td>"+
