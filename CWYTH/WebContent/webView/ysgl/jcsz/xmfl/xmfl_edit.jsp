		...
		<div class='page-header'>
			<div class="pull-left">
				<span class="page-title text-primary"> <i
					class='fa icon-xiangxixinxi'></i>编辑项目分类信息
				</span>
			</div>
			...
			<div class="box-panel">
				<div class="box-header clearfix">
					<div class="sub-title pull-left text-primary">
						<i class="fa icon-xiangxi"></i>项目分类信息
					</div>
					<div class="actions">
				...
				<div class="container-fluid box-content">
					<div class="row">
						...
						<div class="col-md-6">
							<div class="input-group">
								<span class="input-group-addon"><span class="required">*</span>关联业务部门</span>
								<input type="text" id="txt_fddbrh" class="form-control input-radius window" name="zckmbh" value="${dwb.zckmbh}">
					...
					<div class="row">
						<div class="col-md-12">
							<div class="input-group">
								...
								<input type="textarea" id="txt_bmh"
									class="form-control input-radius" name="bmh" value="" />
							</div>
						</div>
					</div>
...
<script type="text/javascript">
	$(function() {
		...
		$("#btn_back")
				.click(
						function(e) {
							parent.window.location.href = "${ctx}/window/mainXmflTree?pageUrl=/xmflc/goXmflListPage&treeJson=/glqxb/qxdwTree";
							return false;
						});
		//联想输入
