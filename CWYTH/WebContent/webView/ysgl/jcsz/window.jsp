...
var _pageUrl="${pageContext.request.contextPath}/webView/ysgl/jcsz/dwxx_list.jsp?pname=${param.pname}&controlId=${param.controlId}&windowModel=${param.windowModel}&from="+from;
