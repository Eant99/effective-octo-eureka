				...
				<div class="row">
					<div class="col-md-4">
                    	<div class="input-group">
                            ...
                            <select id="txt_xmdl" class="form-control input-radius select2" name="xmdl" disabled>
					...
					<div class="col-md-4">
                    	<div class="input-group">
                            ...
                            <select id="txt_xmlb" class="form-control input-radius select2" name="xmlb" disabled>
                            	<option value="">未选择</option>
                ...
                <div class="row">
					<div class="col-md-4">
						<div class="input-group">
							...
							<div class="radiodiv">&nbsp; &nbsp;
								<input type="radio" name="sfky" class="rdo" value="1" disabled<c:if test="${xmxx.sfky=='1' }"> checked</c:if> />
								 <label >是</label> &nbsp; &nbsp; &nbsp;
								<input type="radio" name="sfky" class="rdo" value="0" disabled<c:if test="${xmxx.sfky=='0' }"> checked</c:if> />
								 <label >否</label>
							</div>
						</div>
                    </div>
...
<!-- 					    	</td> -->
					    	...
					    	<td class="td_second_second_2">
					    		<div class="input-group">
						    	    <input type="text" readonly="readonly" style="width:100%;border:none;" class="aa" name="kmbh" id="txt_srkbh" value="${srmap.jbzcsrkmbh}">
...
<!-- 					    	</td> -->
					    	...
					    	<td class="td_three_second_3">
					    		<div class="input-group">
						    	    <input type="text" readonly="readonly" style="width:100%;border:none;" class="aa" name="kmbh2" id="txt_srkbh2" value="${srmap.xmzcsrkmbh}">
						    	    <input type="hidden" name="xmbh" id="txt_xmbh" class="a" value="${guid }">
						    	    <span class="input-group-btn">
...
// 	});
	...
	$("#btn_back").click(function(){
		window.location.href = "${ctx}/ysgl/ystz/bmyx/goXmxxPage"; 
	});
	//刷新按钮
