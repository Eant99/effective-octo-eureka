...
<div id="myform" class="form-horizontal" action="" method="post" >
	...
	<div class='page-header'>
       <div class="pull-left">
            <span class="page-title text-primary"><i class='fa icon-xiangxixinxi'></i>编辑项目支出预算</span>
		</div>
				...
				<div class="row">
					<div class="col-md-4">
						<div class="input-group">
                            ...
                            <input type="text" id="txt_sbry1" class="form-control input-radius" name="sbry1" value="${xmzc.sbry1 }" readonly>
                            <input type="hidden" id="txt_sbry" class="form-control input-radius" name="sbry" value="${xmzc.sbry }">
 ...
 -->                            
					...
					<div class="col-md-4">
						<div class="input-group">
							...
							<input type="text" id="txt_sbbm1" class="form-control input-radius window" name="sbbm1" value="${xmzc.sbbm1 }"/>
							<input type="hidden" id="txt_sbbm" class="form-control input-radius window" name="sbbm" value="${xmzc.sbbm }"/>
					...
					<div class="col-md-4">
						<div class="input-group">
							...
							<input type="text" id="txt_sbnd" class="form-control input-radius year" name="sbnd" value="${xmzc.sbnd }" data-format="yyyy"/>
				...
				<div class="row">
				 <div class="col-md-4">
				     <div class="input-group">
							...
							<input type="text" id="txt_ktbh" class="form-control input-radius " name="ktbh" value="${xmzc.ktbh }" />							
					</div>
					</div>
					<div class="col-md-4">
					<div class="input-group">
							<span class="input-group-addon"><span class="required">*</span>课题名称</span>
							<input type="text" id="txt_ktmc" class="form-control input-radius" name="ktmc" value="${xmzc.ktmc }" />							
					</div>
					</div>
					<div class="col-md-4">
					<div class="input-group">
							<span class="input-group-addon"><span class="required">*</span>主持人</span>
							<input type="text" id="txt_zcr1" class="form-control input-radius" name="zcr1" value="${xmzc.zcr1 }" />
							<input type="hidden" id="txt_zcr" class="form-control input-radius" name="zcr" value="${xmzc.zcr }" />
				...
				<div class="col-md-4">
					...
					<div class="input-group">
							...
							<input type="text" id="txt_ktkssj" class="form-control input-radius window date" name="ktjssj" value="${xmzc.ktkssj }" />
							 <span class='input-group-addon'>
                            	<i class="glyphicon glyphicon-calendar"></i>
                       		 </span>
					</div>
					...
					<div class="input-group">
							...
							<input type="text" id="txt_ktjssj" class="form-control input-radius window date" name="ktkssj" value="${xmzc.ktjssj }" />
							 <span class='input-group-addon'>
                            	<i class="glyphicon glyphicon-calendar"></i>
                       		 </span>
					</div>
				...
				<div class="row">
					<div class="col-md-4">
						<div class="input-group">
							...
							<input type="text" id="" class="form-control input-radius number1" name="dynzchz" value="<fmt:formatNumber value="${xmzc.dynzchz }"  pattern=".0000"/>"  readonly/>
						</div>
					</div>
					<div class="col-md-4">
						<div class="input-group">
							<span class="input-group-addon"><%=den %>年支出汇总（万元）</span>
							<input type="text" id="" class="form-control input-radius number1" name="denzchz" value="<fmt:formatNumber value="${xmzc.denzchz }"  pattern=".0000"/>"  readonly/>
						</div>
					</div>
					<div class="col-md-4">
						<div class="input-group">
							<span class="input-group-addon"><%=dsn %>年支出汇总（万元）</span>
							<input type="text" id="" class="form-control input-radius number1" name="dsnzchz" value="<fmt:formatNumber value="${xmzc.dsnzchz }"  pattern=".0000"/>"  readonly/>
						</div>
					</div>
				</div>
				<div class="row">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="input-group">
							...
							<textarea id="txt_kzfw" style="width:100%;height:80px" name="kzfw" class="form-control input-radius" >${xmzc.kzfw }</textarea>
						</div>
					</div>
			  </div>
				<%-- <div class="row">
				    ...
				    <tbody id="tbody" class="tbody">
				       <c:forEach var="srysmx" items="${xmzcysmx}"> 
				    	<tr id="tr_1">
				    		...
				    		<td>
<!-- 				    		<div class="input-group">
 -->				    			<input type="text" id="txt_jjkm${srysmx.guid }" class="form-control input-radius window null" name="jjkm1" value="${srysmx.jjkmbh1 }">
				    			<input type="hidden" id="txt_jjkbh"  name="jjkmbh" value="${srysmx.jjkmbh }">
				    			<input type="hidden" id="txt_guid"  name="guid" value="${srysmx.guid }">
				    			<input type="hidden" id="txt_xmzcbh"  name="xmzcbh" value="${guid}">
...
<!-- 				    		</div>
 -->				    		</td>
				    		<td style="width:100px">
				    			<input type="text" id="txt_dynzc"  class="form-control input-radius number1 null" name="dynzc" value="<fmt:formatNumber value="${srysmx.DYNZC }"  pattern=".0000"/>"  >
				    		</td>
				    		<td>
				    			<input type="text" id="txt_denzc" class="form-control input-radius number1 null" name="denzc" value="<fmt:formatNumber value="${srysmx.DENZC }"  pattern=".0000"/>"  >
				    		</td>
				    		<td>
				    			<input type="text" id="txt_dsnzc" class="form-control input-radius number1 null" name="dsnzc" value="<fmt:formatNumber value="${srysmx.DSNZC }"  pattern=".0000"/>">
				    		</td>
				    		<td>
...
$(function(){
	...
	$("#btn_save").click(function(e){
		doSave1(validate,"table1","${ctx}/bmysbz/editXmzcys",function(val){
