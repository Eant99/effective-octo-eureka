...
<div id="myform" class="form-horizontal" action="" method="post" >
	<input type="hidden" name="guid" id="guid" value="${guid}">
 	<div class='page-header'>
       <div class="pull-left">
            <span class="page-title text-primary"><i class='fa icon-xiangxixinxi'></i>增加收入预算</span>
		</div>
					...
					<div class="col-md-4">
						<div class="input-group">
							<span class="input-group-addon"><%=dyn %>年收入汇总（万元）</span>
 							<input type="text" id="" class=" form-control input-radius number1" name="dynsrhz" value="" readonly />
                     </div>
					</div>
					<div class="col-md-4">
						<div class="input-group">
							<span class="input-group-addon"><%=den %>年收入汇总（万元）</span>
							<input type="text" id="" class="form-control input-radius number1" name="densrhz" value="" readonly/>
						</div>
					</div>
					<div class="col-md-4">
						<div class="input-group">
							<span class="input-group-addon"><%=dsn %>年收入汇总（万元）</span>
							<input type="text" id="" class="form-control input-radius number1" name="dsnsrhz" value="" readonly="readonly"/>
						</div>
					</div>
				</div>
				<div class="row">
				    ...
				    <tbody id="tbody">
				    	<tr id="tr_1">
				    		...
				    		<!-- <div class="input-group" width="100%"> -->
				    			<input type="text" id="txt_srxm" class="form-control input-radius window null" name="srxmbh1" value="">
				    			<input type="hidden" id="txt_srxbh"  name="srxmbh" value="">
 				    			<input type="hidden" id="txt_srysbh" class="srysbh"  name="srysbh" value="${guid }">
				    			<span class="input-group-btn">
<!-- 				    			<button type="button" id="btn_srxm" sj="txt_srxm" bj="txt_srxbh" class="btn btn-link btn-custom">选择</button>
 -->				    			</span>
				    		<!-- </div> -->
				    		</td>
				    		<td>
				    			<input type="text" id="txt_dynsr" class="form-control input-radius number1 null" name="dynsr" value="" >
				    		</td>
				    		<td>
				    			<input type="text" id="txt_densr" class="form-control input-radius number1 null" name="densr" value="" >
				    		</td>
				    		<td>
				    			<input type="text" id="txt_dsnsr" class="form-control input-radius number1 null" name="dsnsr" value="">
				    		</td>				    		
				    	</tr>
				    </tbody>
				</table>
...
$(function(){
	...
	$("#btn_save").click(function(e){
		$("#tr_1").remove();
		doSave1(validate,"table1","${ctx}/bmysbz/addSrys",function(val){
...
function next(){
	...
	$.ajax({
	   			url:"${ctx}/bmysbz/addSrysmx?srysbh=${guid}",
	   			type:"post",
	   			data:"json="+jsonStr,
...
function addsrys(guid,srxm){
	...
	for(var i=0;i<guid.length;i++){
		...
		//$parentTr.attr("id","tr_"+num);
		$parentTr.find("input:not(.srysbh)").val("");
		$parentTr.find(":input").removeClass("border");
		$parentTr.find("[id=txt_srysbh]").val(srysbh);
