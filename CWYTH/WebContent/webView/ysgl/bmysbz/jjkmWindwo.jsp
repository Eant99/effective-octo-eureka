...
//配置iframeUlr
//JjkmWindow_list
var _pageUrl="${pageContext.request.contextPath}/webView/ysgl/bmysbz/JjkmWindow_list.jsp?pname=${param.pname}&controlId=${param.controlId}&controlId1=${param.controlId1}&controlId2=${param.controlId2}";
//权限标志
var _type="self";
