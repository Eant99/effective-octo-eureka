...
var _pageUrl="${pageContext.request.contextPath}/webView/ysgl/bmysbz/ryList.jsp?pname=${param.pname}&controlId=${param.controlId}&controlId1=${param.controlId1}&windowModel=${param.windowModel}&from="+from;
