...
var _pageUrl="${pageContext.request.contextPath}/webView/ysgl/bmysbz/dwxxList.jsp?pname=${param.pname}&a=${param.a}&controlId=${param.controlId}&controlId1=${param.controlId1}&windowModel=${param.windowModel}&from="+from;
