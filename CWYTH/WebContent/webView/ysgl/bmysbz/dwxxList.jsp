...
$(function (){
	...
	var columns = [
	           	{"data": "DWBH",orderable:false, "render": function (data, type, full, meta){
	        		return '<input type="checkbox" class="keyId"  flag="'+data+'" name="dwbh" value="' + "("+full.BMH+")"+full.MC + '">';
	...
	table = $('#mydatatables').DataTable({
        ajax: {
            url: "${pageContext.request.contextPath}/bmysbz/dwxx?dwbh=${param.dwbh}&a=${param.a}&treesearch=${param.treesearch}&from=${param.from}"//获取数据的方法
        },
    ...
    $(document).on("dblclick","#mydatatables tr:not(#header)",function(){
    	...
    	if(a=="jb"){
    		console.log("12313");
    		getIframWindow("${param.pname}").addmx(guid);
    	}
