...
<form id="myform" class="form-horizontal" action="" method="post">
	...
	<div class="page-header">
		<div class="pull-left">
            <span class="page-title text-primary"><i class='fa icon-xiangxixinxi'></i>支出预算查看</span>
		</div>
	...
	<div class="box" style="top:36px">
		<div class="box-panel">
			<div class="box-header clearfix">
            	<div class="sub-title pull-left text-primary"><i class="fa icon-xiangxi"></i>支出预算信息
            	</div>
            	<div class="actions">
	...
	<div class="container-fluid box-content">
                  ...
                  <div class="col-md-4">
					...
					<div class="col-md-4">
						<div class="input-group">
                           ...
                           <input type="text" id="txt_xmmc" readonly class="form-control input-radius" name="xmmc" value="${jsxx.szdw}">
						</div>
					</div>
				...
				<div class="row">
					...
					<div class="col-md-4">
						<div class="input-group">
                           ...
                           <input type="text" id="txt_xmfl" readonly class="form-control input-radius" name="xmfl" value="${jsxx.szdw}">
						</div>
					</div>
				</div>
				<div class="row">
				<div class="col-md-4">
						<div class="input-group">
                           ...
                           <input type="text" id="txt_xmlx" readonly class="form-control input-radius" name="xmlx" value="${jsxx.szdw}">
						</div>
					</div>
			</div>
           </div>
