...
$(function () {
    ...
    var columns = [
      ...
      // {"data": "XMBH",defaultContent:"","class":"text-left"},
       ...
       {"data": "",'render': function (data, type, full, meta){
    	   var ave = Math.floor(Math.random()*10) + 90;
         return ave;
       },"class":"text-right",orderable:false,},
       {"data": "GUID",'render':function(data, type, full, meta){
	   		return '<a href="javascript:void(0);" class="btn btn-link btn_look" guid="' + data + '">编辑</a>';
	...
	$(document).on("click",".btn_look",function(){
		...
		console.log(xmmc)
     	window.location.href ="${ctx}/webView/ysgl/ystz/ysfxpjEdit.jsp?xmmc="+xmmc; 
   	});
});
</script>
</body>
