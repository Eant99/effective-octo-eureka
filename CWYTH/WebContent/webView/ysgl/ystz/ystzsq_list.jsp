...
$(function () {
    ...
    var columns = [
       ...
       {"data": "GUID","class":"text-center",'render':function(data, type, full, meta){
	   		return '<a href="javascript:void(0);" class="btn btn-link btn_upd">修改</a>|<a href="javascript:void(0);" class="btn btn-link btn_delxx">删除</a>';
      },orderable:false,"width":150}
     ];
    table = getDataTableByListHj("mydatatables","${ctx}/ystz/getPageList",[2,'asc'],columns,0,1,setGroup);
	
  	//添加按钮
   	$("#btn_add").click(function(){
   		doOperate("${ctx}/webView/ysgl/ystz/ystzsq_edit.jsp","C");
   	});
	//导出Excel
   	$("#btn_exp").click(function(){
		...
		checkbox.each(function(){
   		...
   		doExp(json,"${ctx}/jsxxs/expExcel?treedwbh=${dwbh}","预算信息","${ctx}",guid.join(","));
   	});
   	//修改按钮
