...
$(function () {
    ...
    table = getDataTableByListHj("mydatatables","${ctx}/onesrysxz/getZcysxgshPageList",[4,'asc'],columns,0,1,setGroup);
	...
	$(document).on("click",".btn_look",function(){
		doOperate("${ctx}/webView/ysgl/twosjd/zcysxgsh_view.jsp", "C");
	});
  
	//修改
	$(document).on("click",".btn_upd",function(){
		doOperate("${ctx}/webView/ysgl/twosjd/zcysxgsh_edit.jsp", "C");
	});
});
$(function() {	
	//列表右侧悬浮按钮
