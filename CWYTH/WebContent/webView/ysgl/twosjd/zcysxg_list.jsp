...
$(function () {
    ...
    var columns = [
       ...
       {"data": "SNYSZE",defaultContent:"200.0000","class":"text-right"},
       {"data": "SNZCZE",defaultContent:"150.0000","class":"text-right"},
       {"data": "BNYSZE",defaultContent:"160.0000","class":"text-right"},
    ...
    table = getDataTableByListHj("mydatatables","${ctx}/onesrysxz/getZcysxgPageList",[2,'asc'],columns,0,1,setGroup);
	...
	$(document).on("click",".btn_upd",function(){
		doOperate("${ctx}/webView/ysgl/twosjd/zcysxg_edit.jsp", "C");
	});
});
$(function() {	
	//列表右侧悬浮按钮
