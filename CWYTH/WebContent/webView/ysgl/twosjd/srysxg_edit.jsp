		...
		<div class="box-panel">
			...
			<div class="row">
					  <div class="col-md-4">
						<div class="input-group">
							<span class="input-group-addon"><span class="required">*</span>上年预算总额（万元）</span>
                              <input type="text" id="txt_snysze" class="form-control input-radius text-right number1" name="snysze" value="100.0000" readonly/>
					...
					<div class="col-md-4">
					  ...
					  <input type="text" id="txt_snsrze" class="form-control input-radius  text-right number1" name="snsrze" value="120.0000" readonly/>
						</div>
					</div>
					<div class="col-md-4">
						<div class="input-group">
							<span class="input-group-addon"><span class="required">*</span>本年预算总额（万元）</span>
                            <input type="text" id="txt_bnysze" class="form-control input-radius text-right number1" name="bnysze" value="130.0000" readonly/>
						</div>
					</div>				
				</div>
				<div class="row">
				...
				<table id="mydatatables" class="table table-striped table-bordered" style="border-collapse: collapse;">
		        	<thead id="thead">
				        <tr>
				            ...
				            <th style="width:300px;text-align: center;"><span class="required" style="color:red ;">*</span>上年收入（万元）</th>
				    ...
				    <tbody id="tbody">
				    	<tr id="tr_1">
                           ...
                           <td class="btn_td">
				    		...
				    		<td>
				    			<input type="text" id="txt_snsr1" class="form-control input-radius null text-right number1" name="snsr1" value="" >
				    		</td>
				    		<td>
...
$(function(){
	...
	$("#btn_back").click(function(){
		window.location.href = "${ctx}/webView/ysgl/twosjd/srysxg_list.jsp";
	});
	//刷新按钮
