				...
				<div class="search-simple">
					...
					<div class="form-group">
						<label>单位名称</label> <input type="text" id="txt_djbh"
							class="form-control" name="dwmc" table="K" placeholder="请输入单位名称">
					</div>
					<div class="form-group">
						<label>科目名称</label> <input type="text" id="txt_kmmc"
							class="form-control" name="knmc" table="K" placeholder="请输入科目名称">
					</div>
...
$(function () {
    ...
    var columns = [
       ...
       {"data": "SNYSZE",defaultContent:"","class":"text-right"},
       {"data": "SNSRZE",defaultContent:"","class":"text-right"},
       {"data": "BNYSZE",defaultContent:"","class":"text-right"},
       {"data": "XGR",defaultContent:""},
       {"data": "XGSJ",defaultContent:""},
       {"data": "SHR",defaultContent:""},
       {"data": "SHRQ",defaultContent:""},
    ...
    table = getDataTableByListHj("mydatatables","${ctx}/onesrysxz/getSrysxgshPageList",[4,'asc'],columns,0,1,setGroup);
	...
	$(document).on("click",".btn_look",function(){
		doOperate("${ctx}/webView/ysgl/twosjd/srysxgsh_view.jsp", "C");
	});
  
	//修改
	$(document).on("click",".btn_upd",function(){
		doOperate("${ctx}/webView/ysgl/twosjd/srysxgsh_edit.jsp", "C");
	});
});
$(function() {	
	//列表右侧悬浮按钮
