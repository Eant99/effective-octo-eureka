...
<%-- 		<input type="hidden" name="czr"	value="${loginId}"> --%>
		<center><h4><strong>专用设备采购</strong></h4></center>
			...
			<form id="myform1">
				<table id="mydatatables" class="table table-striped table-bordered" style="border-collapse: collapse;overflow-x:scroll;width: 1800px;">
		        	<thead id="thead">
		        		<tr>
		        			<td rowspan="2"></td>
		        			<th style="text-align: center;min-width:150px;" colspan="3" rowspan="2">采购项目</th>
...
<!-- 				    		</td> -->
				    		<td>
				    			<input type="text" id="txt_khyh1" a="a" class="form-control input-radius null number" name="DWXYZJSL" style="text-align: right;" value="${list.DWXYZJSL }">
				    		</td>
				    		<td>
				    		...
				    		<td>
				    			<input type="text" id="txt_khyhzh1" a="a" class="form-control input-radius null number" name="JHPZS" style="text-align: right;" value="${list.JHPZS }">
				    		</td>
				    		<td>
				    		...
				    		<td>
				    			<div class="input-group">
									<input type="text" id="txt_jlrq" class="form-control date" name="GHSJYQ" value="${list.GHSJYQ }" >
...
<!-- 				    		</td> -->
				    		<td>
				    			<input type="text" id="txt_khyh1" a="a" class="form-control input-radius null number" name="DWXYZJSL" style="text-align: right;" value="">
				    		</td>
				    		<td>
				    			<input type="text" id="txt_khyhzh1" a="a" class="form-control input-radius null number" name="PZXEZJSL" style="text-align: right;" value="">
				    		</td>
				    		<td>
				    			<input type="text" id="txt_khyhzh1" a="a" class="form-control input-radius null number" name="JHPZS" style="text-align: right;" value="">
				    		</td>
				    		<td>
				    			<input type="text" id="txt_khyhzh1" a="a" class="form-control input-radius null number" name="DJ" style="text-align: right;" value="">
				    		</td>
				    		<td>
				    			<input type="text" id="txt_khyh1" a="a" class="form-control input-radius null number" name="CGYSJE" style="text-align: right;" value="">
				    		</td>
				    		<td>
				    			<div class="input-group">
...
$(function() {
    ...
    $("#btn_save").click(function(){
	   	var url = "${ctx}/ysgl/bmyssb/doSave?operateType=C&dm=11";
		doSave1($("#myform1"),url,function(val){
			var result = JSON.getJson(val);
			if(result.success){
				alert("保存成功！");
// 				window.location = "${ctx}/ysgl/bmyssb/goListPage?operateType=C&dm=11";
			}
		});
	});
  //返回按钮
...
// 		window.location.href = "${ctx}/webView/ysgl/bmyssb/zfcgxmjgcs_list.jsp";
		doOperate("${ctx}/ysgl/bmyssb/tosecond?dm=11","C");
	});
