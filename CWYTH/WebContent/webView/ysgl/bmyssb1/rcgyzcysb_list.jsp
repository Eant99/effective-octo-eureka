...
<!-- 				    			<span><button type="button" id="btn_xmmc" class="btn btn-link btn-custom">选择</button></span> -->
				    		...
				    		<td>
				    			<input type="text" id="txt_khyhzh1" a="a" class="form-control input-radius null" name="zysm" value="${list.zysm}">
				    		</td>
				    		<td>
				    			<input type="text" id="txt_khyhzh1" a="a" class="form-control input-radius null number1" style="text-align: right;" name="nysze" value="${list.nysze}">
				    		</td>
				    		<td>
				    		...
				    		<td>
				    			<input type="text" id="txt_khyh1" a="a" class="form-control input-radius null " style="text-align: right;" name="jsgc" value="${list.jsgc}">
				    		</td>
				    	</tr>
				    ...
				    <tr id="tr_0">
				    		...
				    		<td>
				    			<input type="hidden" id="txt_khyh1" a="a" class="form-control input-radius null" name="guid" value="">
				    			<input type="text" id="txt_fymc" a="a" class="form-control input-radius null" name="fymc" value="" >
<!-- 				    			<span><button type="button" id="btn_xmmc" class="btn btn-link btn-custom">选择</button></span> -->
				    		</td>
				    		<td>
				    			<input type="text" id="txt_khyhzh1" a="a" class="form-control input-radius null" name="zysm" value="">
				    		</td>
				    		<td>
				    			<input type="text" id="txt_khyhzh1" a="a" class="form-control input-radius null number1" style="text-align: right;" name="nysze" value="">
				    		</td>
				    		<td>
				    		...
				    		<td>
				    			<input type="text" id="txt_khyh1" a="a" class="form-control input-radius null " style="text-align: right;" name="jsgc" value="">
				    		</td>
				    	</tr>
				    </tbody>
				</table>
