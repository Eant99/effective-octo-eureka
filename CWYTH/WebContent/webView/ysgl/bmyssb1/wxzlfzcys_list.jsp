				...
				<table id="mydatatables" class="table table-striped table-bordered" style="border-collapse: collapse;overflow-x:scroll;width: 1800px;">
		        	<thead id="thead">
				        <tr>
				            ...
				            <th style="text-align: center;min-width:150px;">项目主要依据及摘要说明</th>
				            <th style="text-align: center;min-width:150px;">项目开始时间</th>
				            <th style="text-align: center;min-width:150px;">项目截止时间</th>
				    ...
				    <c:forEach items="${list}" var="list" varStatus="i">
				    	<tr id="tr_${i.index+1}">
				    		...
				    		<td>
				    			<div class="input-group">
				    				...
				    				<input type="text" id="txt_xmmc" a="a" class="form-control input-radius null" style="width:100%;" readonly="readonly" name="XMMC" value="${list.xmmc}">
				    				<span><button type="button" id="btn_xmmc" name="btn_xz" class="btn btn-link btn-custom">选择</button></span>
				    			</div>
				    		</td>
				    		<td>
				    			<input type="text" id="txt_khyhzh1" a="a" class="form-control input-radius null" name="XMZYYJJJYSM" value="${list.XMZYYJJJYSM}">
				    		</td>
				    		<td>
				    		...
				    		<td>
				    			<input type="text" id="txt_khyhzh1" a="a" class="form-control input-radius null number1"  style="text-align: right"  name="NYSJYAPS" value="${list.NYSJYAPS}">
				    		</td>
				    		<td>
				    			<div class="input-group">
				    	...
				    	<tr id="tr_1">
				    		...
				    		<td>
				    			<div class="input-group">
				    				<input type="hidden" name="guid" value="">
				    				<input type="text" id="txt_xmmc" a="a" class="form-control input-radius null" style="width:100%;" readonly="readonly" name="XMMC" value="">
				    				<span><button type="button" id="btn_xmmc" name="btn_xz" class="btn btn-link btn-custom">选择</button></span>
				    			</div>
				    		</td>
				    		<td>
