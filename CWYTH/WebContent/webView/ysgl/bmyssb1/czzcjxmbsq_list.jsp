						...
						<table id="mydatatables"
							...
							<thead id="thead">
								...
								<div class="search-simple">	
									<div > 
										<label>填报部门</label>					
					 					<input type="text" class="form-control input-radius" name="tbbm" style="width: 140px;"  id="txt_tbbm" readonly="readonly" value="${bmmc}">
									</div> 
							...
							<tbody id="tbody">
								...
								<tr>
									...
									<td colspan="6">
										<div class="input-group">
											<span class="input-group-addon">开始时间：</span> <input type="text" id="txt_jlrq" class="form-control date"
										...
										<div class="input-group">
											...
											<input type="text" id="txt_jlrq" class="form-control date" name="jssj" value="${info.wcsj}" > 
								...
								<tr>
									...
									<td colspan="2">
										<input type="text" id="txt_khyh1" a="a" class="form-control input-radius null" name="xmssnr" value="">
									</td>
									<td>
										<div class="input-group">
											<input type="text" id="txt_jlrq" class="form-control date" name="kssj" value="<fmt:formatDate value="${dwb.JLRQ}" pattern="yyyy-MM-dd"/>"
									...
									<td>
										<div class="input-group">
											<input type="text" id="txt_jlrq" class="form-control date"
												name="wcsj"
								...
								<tr>
									<td colspan="4"><input type="text" id="txt_khyh1" a="a"
										class="form-control input-radius null" name="cqmb" value="${info.cqzb}">
									</td>
									<td><input type="text" id="txt_khyh1" a="a"
										class="form-control input-radius null" name="ndmb" value="${info.ndzb}">
									</td>
								...
								<tr>
									...
									<td><input type="text" id="txt_khyh1" name="slzb1" a="a1"
										class="form-control input-radius null"  value="${info.slzb1}">
									</td>
									<td><input type="text" id="txt_khyh1" name="slzb2" a="a1"
										class="form-control input-radius null"  value="${info.slzb2}">
									</td>
									<td><input type="text" id="txt_khyh1" a="a1" name="slzb3"
										class="form-control input-radius null"  value="${info.slzb3}">
									</td>
								</tr>
								<tr>
									<td><input type="text" id="txt_khyh1" a="a1" name="slzb4"
										class="form-control input-radius null"  value="${info.slzb4}">
									</td>
									<td><input type="text" id="txt_khyh1" a="a1" name="slzb5"
										class="form-control input-radius null"  value="${info.slzb5}">
									</td>
									<td><input type="text" id="txt_khyh1" a="a1" name="slzb6"
										class="form-control input-radius null"  value="${info.slzb6}">
									</td>
								</tr>
								<tr>
									<td rowspan="2" style="text-align: center;">质量指标</td>
									<td><input type="text" id="txt_khyh1" a="a1" name="zlzb1"
										class="form-control input-radius null"  value="${info.zlzb1}">
									</td>
									<td><input type="text" id="txt_khyh1" a="a1" name="zlzb2"
										class="form-control input-radius null"  value="${info.zlzb2}">
									</td>
									<td><input type="text" id="txt_khyh1" a="a1" name="zlzb3"
										class="form-control input-radius null"  value="${info.zlzb3}">
									</td>
								</tr>
								<tr>
									<td><input type="text" id="txt_khyh1" a="a1" name="zlzb4"
										class="form-control input-radius null"  value="${info.zlzb4}">
									</td>
									<td><input type="text" id="txt_khyh1" a="a1" name="zlzb5"
										class="form-control input-radius null"  value="${info.zlzb5}">
									</td>
									<td><input type="text" id="txt_khyh1" a="a1" name="zlzb6"
										class="form-control input-radius null"  value="${info.zlzb6}">
									</td>
								</tr>
								<tr>
									<td rowspan="2" style="text-align: center;">时效指标</td>
									<td><input type="text" id="txt_khyh1" a="a1" name="sxzb1"
										class="form-control input-radius null"  value="${info.sxzb1}">
									</td>
									<td><input type="text" id="txt_khyh1" a="a1" name="sxzb2"
										class="form-control input-radius null" value="${info.sxzb2}">
									</td>
									<td><input type="text" id="txt_khyh1" a="a1" name="sxzb3"
										class="form-control input-radius null"  value="${info.sxzb3}">
									</td>
								</tr>
								<tr>
									<td><input type="text" id="txt_khyh1" a="a1" name="sxzb4"
										class="form-control input-radius null"  value="${info.sxzb4}">
									</td>
									<td><input type="text" id="txt_khyh1" a="a1" name="sxzb5"
										class="form-control input-radius null" value="${info.sxzb5}">
									</td>
									<td><input type="text" id="txt_khyh1" a="a1" name="sxzb6"
										class="form-control input-radius null"  value="${info.sxzb6}">
									</td>
								</tr>
								<tr>
									<td rowspan="2" style="text-align: center;">成本指标</td>
									<td><input type="text" id="txt_khyh1" a="a1" name="cbzb1"
										class="form-control input-radius null" value="${info.cbzb1}">
									</td>
									<td><input type="text" id="txt_khyh1" a="a1" name="cbzb2"
										class="form-control input-radius null"  value="${info.cbzb2}">
									</td>
									<td><input type="text" id="txt_khyh1" a="a1" name="cbzb3"
										class="form-control input-radius null"  value="${info.cbzb3}">
									</td>
								</tr>
								<tr>
									<td class="btn_td">
									...
									<td><input type="text" id="txt_khyh1" a="a1" name="cbzb4"
										class="form-control input-radius null"  value="${info.cbzb4}">
									</td>
									<td><input type="text" id="txt_khyh1" a="a1" name="cbzb5"
										class="form-control input-radius null"  value="${info.cbzb5}">
									</td>
									<td><input type="text" id="txt_khyh1" a="a1" name="cbzb6"
										class="form-control input-radius null"  value="${info.cbzb6}">
									</td>
								</tr>
								<tr>
...
<!-- 									</td> -->
								...
								<tr>
									...
									<td><input type="text" id="txt_khyh1" a="a"
										class="form-control input-radius null" name="jjxyzb1" value="${info.jjxyzb1}">
									</td>
									<td><input type="text" id="txt_khyh1" a="a"
										class="form-control input-radius null" name="jjxyzb2" value="${info.jjxyzb2}">
									</td>
									<td><input type="text" id="txt_khyh1" a="a"
										class="form-control input-radius null" name="jjxyzb3" value="${info.jjxyzb3}">
									</td>
								</tr>
								<tr>
									<td><input type="text" id="txt_khyh1" a="a"
										class="form-control input-radius null" name="jjxyzb4" value="${info.jjxyzb4}">
									</td>
									<td><input type="text" id="txt_khyh1" a="a"
										class="form-control input-radius null" name="jjxyzb5" value="${info.jjxyzb5}">
									</td>
									<td><input type="text" id="txt_khyh1" a="a"
										class="form-control input-radius null" name="jjxyzb6" value="${info.jjxyzb6}">
									</td>
								</tr>
								<tr>
									<td rowspan="2" style="text-align: center;">社会效益指标</td>
									<td><input type="text" id="txt_khyh1" a="a"
										class="form-control input-radius null" name="shxyzb1" value="${info.shxyzb1}">
									</td>
									<td><input type="text" id="txt_khyh1" a="a"
										class="form-control input-radius null" name="shxyzb2" value="${info.shxyzb2}">
									</td>
									<td><input type="text" id="txt_khyh1" a="a"
										class="form-control input-radius null" name="shxyzb3" value="${info.shxyzb3}">
									</td>
								</tr>
								<tr>
									<td><input type="text" id="txt_khyh1" a="a"
										class="form-control input-radius null" name="shxyzb4" value="${info.shxyzb4}">
									</td>
									<td><input type="text" id="txt_khyh1" a="a"
										class="form-control input-radius null" name="shxyzb5" value="${info.shxyzb5}">
									</td>
									<td><input type="text" id="txt_khyh1" a="a"
										class="form-control input-radius null" name="shxyzb6" value="${info.shxyzb6}">
									</td>
								</tr>
								<tr>
									<td rowspan="2" style="text-align: center;">生态效益指标</td>
									<td><input type="text" id="txt_khyh1" a="a"
										class="form-control input-radius null" name="stxyzb1" value="${info.stxyzb1}">
									</td>
									<td><input type="text" id="txt_khyh1" a="a"
										class="form-control input-radius null" name="stxyzb2" value="${info.stxyzb2}">
									</td>
									<td><input type="text" id="txt_khyh1" a="a"
										class="form-control input-radius null" name="stxyzb3" value="${info.stxyzb3}">
									</td>
								</tr>
								<tr>
									<td><input type="text" id="txt_khyh1" a="a"
										class="form-control input-radius null" name="stxyzb4" value="${info.stxyzb4}">
									</td>
									<td><input type="text" id="txt_khyh1" a="a"
										class="form-control input-radius null" name="stxyzb5" value="${info.stxyzb5}">
									</td>
									<td><input type="text" id="txt_khyh1" a="a"
										class="form-control input-radius null" name="stxyzb6" value="${info.stxyzb6}">
									</td>
								</tr>
								<tr>
									<td rowspan="2" style="text-align: center;">可持续影响指标</td>
									<td><input type="text" id="txt_khyh1" a="a"
										class="form-control input-radius null" name="kcxyxzb1" value="${info.kcxyxzb1}">
									</td>
									<td><input type="text" id="txt_khyh1" a="a"
										class="form-control input-radius null" name="kcxyxzb2" value="${info.kcxyxzb2}">
									</td>
									<td><input type="text" id="txt_khyh1" a="a"
										class="form-control input-radius null" name="kcxyxzb3" value="${info.kcxyxzb3}">
									</td>
								</tr>
								<tr>
									<td><input type="text" id="txt_khyh1" a="a"
										class="form-control input-radius null" name="kcxyxzb4" value="${info.kcxyxzb4}">
									</td>
									<td><input type="text" id="txt_khyh1" a="a"
										class="form-control input-radius null" name="kcxyxzb5" value="${info.kcxyxzb5}">
									</td>
									<td><input type="text" id="txt_khyh1" a="a"
										class="form-control input-radius null" name="kcxyxzb6" value="${info.kcxyxzb6}">
									</td>
								</tr>
<!-- 								<tr> -->
<!-- 									<td class="btn_td"> -->
...
<!-- 								</tr> -->
								...
								<tr>
									...
									<td><input type="text" id="txt_khyh1" name="shgz1" a="a"
										class="form-control input-radius null" name="shgg1" value="${info.shgg1}">
									</td>
									<td><input type="text" id="txt_khyh1" name="shgz2" a="a"
										class="form-control input-radius null" name="shgg2" value="${info.shgg2}">
									</td>
									<td><input type="text" id="txt_khyh1" name="shgz3" a="a"
										class="form-control input-radius null" name="shgg3" value="${info.shgg3}">
									</td>
									<td><input type="text" id="txt_khyh1" name="shgz4" a="a"
										class="form-control input-radius null" name="shgg4" value="${info.shgg4}">
									</td>
								</tr>
								<!-------------------------------------------------------------------年度绩效指标-------------------------------------------------------------------------  -->
								<tr>
								...
								<tr>
									...
									<td rowspan="2" style="text-align: center;">数量指标</td>
									<td><input type="text" id="txt_khyh1" a="a"
										class="form-control input-radius null" name="ndslzb1" value="${info.ndslzb1}">
									</td>
									<td><input type="text" id="txt_khyh1" a="a"
										class="form-control input-radius null" name="ndslzb2" value="${info.ndslzb2}">
									</td>
									<td><input type="text" id="txt_khyh1" a="a"
										class="form-control input-radius null" name="ndslzb3" value="${info.ndslzb3}">
									</td>
								</tr>
								<tr>
									<td><input type="text" id="txt_khyh1" a="a"
										class="form-control input-radius null" name="ndslzb4" value="${info.ndslzb4}">
									</td>
									<td><input type="text" id="txt_khyh1" a="a"
										class="form-control input-radius null" name="ndslzb5" value="${info.ndslzb5}">
									</td>
									<td><input type="text" id="txt_khyh1" a="a"
										class="form-control input-radius null" name="ndslzb6" value="${info.ndslzb6}">
									</td>
								</tr>
								<tr>
									<td rowspan="2" style="text-align: center;">质量指标</td>
									<td><input type="text" id="txt_khyh1" a="a"
										class="form-control input-radius null" name="ndzlzb1" value="${info.ndzlzb1}">
									</td>
									<td><input type="text" id="txt_khyh1" a="a"
										class="form-control input-radius null" name="ndzlzb2" value="${info.ndzlzb2}">
									</td>
									<td><input type="text" id="txt_khyh1" a="a"
										class="form-control input-radius null" name="ndzlzb3" value="${info.ndzlzb3}">
									</td>
								</tr>
								<tr>
									<td><input type="text" id="txt_khyh1" a="a"
										class="form-control input-radius null" name="ndzlzb4" value="${info.ndzlzb4}">
									</td>
									<td><input type="text" id="txt_khyh1" a="a"
										class="form-control input-radius null" name="ndzlzb5" value="${info.ndzlzb5}">
									</td>
									<td><input type="text" id="txt_khyh1" a="a"
										class="form-control input-radius null" name="ndzlzb6" value="${info.ndzlzb6}">
									</td>
								</tr>
								<tr>
									<td rowspan="2" style="text-align: center;">时效指标</td>
									<td><input type="text" id="txt_khyh1" a="a"
										class="form-control input-radius null" name="ndsxzb1" value="${info.ndsxzb1}">
									</td>
									<td><input type="text" id="txt_khyh1" a="a"
										class="form-control input-radius null" name="ndsxzb2" value="${info.ndsxzb2}">
									</td>
									<td><input type="text" id="txt_khyh1" a="a"
										class="form-control input-radius null" name="ndsxzb3" value="${info.ndsxzb3}">
									</td>
								</tr>
								<tr>
									<td><input type="text" id="txt_khyh1" a="a"
										class="form-control input-radius null" name="ndsxzb4" value="${info.ndsxzb4}">
									</td>
									<td><input type="text" id="txt_khyh1" a="a"
										class="form-control input-radius null" name="ndsxzb5" value="${info.ndsxzb5}">
									</td>
									<td><input type="text" id="txt_khyh1" a="a"
										class="form-control input-radius null" name="ndsxzb6" value="${info.ndsxzb6}">
									</td>
								</tr>
								<tr>
									<td rowspan="2" style="text-align: center;">成本指标</td>
									<td><input type="text" id="txt_khyh1" a="a"
										class="form-control input-radius null" name="ndcbzb1" value="${info.ndcbzb1}">
									</td>
									<td><input type="text" id="txt_khyh1" a="a"
										class="form-control input-radius null" name="ndcbzb2" value="${info.ndcbzb2}">
									</td>
									<td><input type="text" id="txt_khyh1" a="a"
										class="form-control input-radius null" name="ndcbzb3" value="${info.ndcbzb3}">
									</td>
								</tr>
								<tr>
									<td><input type="text" id="txt_khyh1" a="a"
										class="form-control input-radius null" name="ndcbzb4" value="${info.ndcbzb4}">
									</td>
									<td><input type="text" id="txt_khyh1" a="a"
										class="form-control input-radius null" name="ndcbzb5" value="${info.ndcbzb5}">
									</td>
									<td><input type="text" id="txt_khyh1" a="a"
										class="form-control input-radius null" name="ndcbzb6" value="${info.ndcbzb6}">
									</td>
								</tr>
								<tr>
									<td class="btn_td">
								...
								<tr>
									...
									<td rowspan="2" style="text-align: center;">经济效益指标</td>
									<td><input type="text" id="txt_khyh1" a="a"
										class="form-control input-radius null" name="ndjjxyzb1" value="${info.ndjjxyzb1}">
									</td>
									<td><input type="text" id="txt_khyh1" a="a"
										class="form-control input-radius null" name="ndjjxyzb2" value="${info.ndjjxyzb2}">
									</td>
									<td><input type="text" id="txt_khyh1" a="a"
										class="form-control input-radius null" name="ndjjxyzb3" value="${info.ndjjxyzb3}">
									</td>
								</tr>
								<tr>
									<td><input type="text" id="txt_khyh1" a="a"
										class="form-control input-radius null" name="ndjjxyzb4" value="${info.ndjjxyzb3}">
									</td>
									<td><input type="text" id="txt_khyh1" a="a"
										class="form-control input-radius null" name="ndjjxyzb5" value="${info.ndjjxyzb4}">
									</td>
									<td><input type="text" id="txt_khyh1" a="a"
										class="form-control input-radius null" name="ndjjxyzb6" value="${info.ndjjxyzb5}">
									</td>
								</tr>
								<tr>
									<td rowspan="2" style="text-align: center;">社会效益指标</td>
									<td><input type="text" id="txt_khyh1" a="a"
										class="form-control input-radius null" name="ndshxyzb1" value="${info.ndshxyzb1}">
									</td>
									<td><input type="text" id="txt_khyh1" a="a"
										class="form-control input-radius null" name="ndshxyzb2" value="${info.ndshxyzb2}">
									</td>
									<td><input type="text" id="txt_khyh1" a="a"
										class="form-control input-radius null" name="ndshxyzb3" value="${info.ndshxyzb3}">
									</td>
								</tr>
								<tr>
									<td><input type="text" id="txt_khyh1" a="a"
										class="form-control input-radius null" name="ndshxyzb4" value="${info.ndshxyzb4}">
									</td>
									<td><input type="text" id="txt_khyh1" a="a"
										class="form-control input-radius null" name="ndshxyzb5" value="${info.ndshxyzb5}">
									</td>
									<td><input type="text" id="txt_khyh1" a="a"
										class="form-control input-radius null" name="ndshxyzb6" value="${info.ndshxyzb6}">
									</td>
								</tr>
								<tr>
									<td rowspan="2" style="text-align: center;">生态效益指标</td>
									<td><input type="text" id="txt_khyh1" a="a"
										class="form-control input-radius null" name="ndstxyzb1" value="${info.ndstxyzb1}">
									</td>
									<td><input type="text" id="txt_khyh1" a="a"
										class="form-control input-radius null" name="ndstxyzb2" value="${info.ndstxyzb2}">
									</td>
									<td><input type="text" id="txt_khyh1" a="a"
										class="form-control input-radius null" name="ndstxyzb3" value="${info.ndstxyzb3}">
									</td>
								</tr>
								<tr>
									<td><input type="text" id="txt_khyh1" a="a"
										class="form-control input-radius null" name="ndstxyzb4" value="${info.ndstxyzb4}">
									</td>
									<td><input type="text" id="txt_khyh1" a="a"
										class="form-control input-radius null" name="ndstxyzb5" value="${info.ndstxyzb5}">
									</td>
									<td><input type="text" id="txt_khyh1" a="a"
										class="form-control input-radius null" name="ndstxyzb6" value="${info.ndstxyzb6}">
									</td>
								</tr>
								<tr>
									<td rowspan="2" style="text-align: center;">可持续影响指标</td>
									<td><input type="text" id="txt_khyh1" a="a"
										class="form-control input-radius null" name="ndkcxyxzb1" value="${info.ndkcxyxzb1}">
									</td>
									<td><input type="text" id="txt_khyh1" a="a"
										class="form-control input-radius null" name="ndkcxyxzb2" value="${info.ndkcxyxzb2}">
									</td>
									<td><input type="text" id="txt_khyh1" a="a"
										class="form-control input-radius null" name="ndkcxyxzb3" value="${info.ndkcxyxzb3}">
									</td>
								</tr>
								<tr>
									<td><input type="text" id="txt_khyh1" a="a"
										class="form-control input-radius null" name="ndkcxyxzb4" value="${info.ndkcxyxzb4}">
									</td>
									<td><input type="text" id="txt_khyh1" a="a"
										class="form-control input-radius null" name="ndkcxyxzb5" value="${info.ndkcxyxzb5}">
									</td>
									<td><input type="text" id="txt_khyh1" a="a"
										class="form-control input-radius null" name="ndkcxyxzb6" value="${info.ndkcxyxzb6}">
									</td>
								</tr>
								<tr>
									<td class="btn_td">
								...
								<tr>
									...
									<td><input type="text" id="txt_khyh1" name="shgz5" a="a"
										class="form-control input-radius null"  value="${info.shgz5}">
									</td>
									<td><input type="text" id="txt_khyh1" name="shgz6" a="a"
										class="form-control input-radius null"  value="${info.shgg6}">
									</td>
									<td><input type="text" id="txt_khyh1" name="shgz7" a="a"
										class="form-control input-radius null"  value="${info.shgg7}">
									</td>
									<td><input type="text" id="txt_khyh1" name="shgz8" a="a"
										class="form-control input-radius null"  value="${info.shgg8}">
									</td>
								</tr>
								<tr>
									<td style="text-align: center;">其他需要说明的问题</td>
									<td colspan="5"><input type="text" id="txt_khyh1" name="qtwt" a="a"
										class="form-control input-radius null" name="xmssnr" value="${info.shgg4}">
									</td>
								</tr>
