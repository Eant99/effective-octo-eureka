...
<%-- 		<input type="hidden" name="operateType" id="operateType" value="${operateType}"> --%>
	...
	<div class="container-fluid">
		<div class='responsive-table'>
			<div class='scrollable-area' style="width: 100%;height: 100%;"> 
			<form id="myform1">
				<input type="hidden" name="tbbm1" id="tbbm1" value="${bmmc}">
				<table id="mydatatables" class="table table-striped table-bordered" style="border-collapse: collapse;overflow-x:scroll;width: 100%;">
		        	<thead id="thead">
				        <tr>
				        	<th style="text-align: center;min-width:30px;">操作</th>
				            <th style="text-align: center;width: 200px;min-width:150px;">项目名称</th>
				            <th style="text-align: center;width: 200px;min-width:150px;">摘要说明</th>
				            <th style="text-align: center;width: 200px;min-width:150px;">项目开始时间</th>
				            <th style="text-align: center;width: 200px;min-width:150px;">项目截止时间</th>
				            <th style="text-align: center;width: 200px;min-width:150px;">项目总投资（万元）</th>
				            <th style="text-align: center;width: 200px;min-width:150px;">2017年安排投资数</th>
				            <th style="text-align: center;width: 200px;min-width:150px;">2018年预算建议安排数</th>
				            <th style="text-align: center;width: 200px;min-width:150px;">项目付款时间要求（月份）</th>
				            <th style="text-align: center;width: 200px;min-width:150px;">计算过程（依据）</th>
				        </tr>
					</thead>
				    <tbody id="tbody">
				    ...
				    <c:forEach items="${list}" var="list" varStatus="i">
				    	<tr id="tr_${i.index+1}">
				    		...
				    		<td>
				    			...
				    			<input type="text" id="txt_xmmc" a="a" class="form-control input-radius null" readonly="readonly" name="xmmc" value="${list.xmmc}" style="width: 80%;">
				    			<span><button type="button" id="btn_xmmc" class="btn btn-link btn-custom">选择</button></span>
				    			</div>
				    		</td>
				    		<td>
				    			<input type="text" id="txt_khyhzh1" a="a" class="form-control input-radius null" name="JYSM" value="${list.JYSM}">
				    		</td>
				    		<td>
				    			<input type="text" id="txt_khyhzh1" a="a" class="form-control input-radius null date" name="XMQZSJ" value="${list.XMQZSJ}">
				    		</td>
				    		<td>
				    			<input type="text" id="txt_khyhzh1" a="a" class="form-control input-radius null date" name="XMJSSJ" value="${list.XMJSSJ}">
				    		</td>
				    		<td>
				    			<input type="text" id="txt_khyhzh1" a="a" class="form-control input-radius null number1" style="text-align: right;" name="XMZTZ" value="${list.XMZTZ}">
				    		</td>
				    		<td>
				    			<input type="text" id="txt_khyh1" a="a" class="form-control input-radius null number1" style="text-align: right;" name="NAPZJS" value="${list.NAPZJS}">
				    		</td>
				    		<td>
				    			<input type="text" id="txt_khyhzh1" a="a" class="form-control input-radius null" style="text-align: right;" name="NYSJYAPS" value="${list.NYSJYAPS}">
				    		</td>
				    		<td>
				    			<div class="input-group">
				    		...
				    		<td>
				    			<input type="text" id="txt_khyhzh1" a="a" class="form-control input-radius null" name="jsgc" value="${list.jsgc}">
				    		</td>
				    	</tr>
				    </c:forEach>
				    		<tr id="tr_1">
				    		...
				    		<td>
				    			<input type="hidden" id="txt_khyh1" a="a" class="form-control input-radius null" name="guid" value="">
				    			<div class="input-group">
				    			<input type="text" id="txt_xmmc" a="a" class="form-control input-radius null" readonly="readonly" name="xmmc" value="" style="width: 80%;">
				    			<span><button type="button" id="btn_xmmc" class="btn btn-link btn-custom">选择</button></span>
				    			</div>
				    		</td>
				    		<td>
