...
// 	       		{"data": "FHZT",defaultContent:"审核通过","class":"text-center"},
	       		{"data": "BMMC",defaultContent:"","class":"text-center"},
	       	   	{"data": "RS",defaultContent:"","class":"text-right"},
	       	   	{"data": "SFGZ",defaultContent:"","class":"text-right"},
...
// 	       		},orderable:false,"width":95}
	       	...
	       	//表数据
          	table = getDataTableByListHj("mydatatables","${ctx}/txrybmhz/getPageList?treedwbh=${dwbh}&qc=${qc}&bmh=${bmh}",[4,'asc'],columns);
   	//新增
