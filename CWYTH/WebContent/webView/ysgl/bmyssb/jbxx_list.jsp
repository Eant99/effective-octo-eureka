				    	...
				    	<tr>
				            ...
				            <th>
				            	<div class="input-group">
				            		<input type="text" id="txt_dwmc" windth="90%" class=" input-radius" name="dwmc" readonly="readonly" value="${bmmc }"/>
<!-- 				            		<span class="input-group-btn"><button type="button" id="btn_dwmc" class="btn btn-link btn-custom">选择</button></span> -->
				               	</div>
				            </th>
				            <th style="vertical-align: middle;">部门负责人</th>
				            <th>
					            <div class="input-group">
					            	<input type="text" id="txt_dwfzr" class=" input-radius"  name="dwfzr" readonly value="${info.dwfzrmc }"/>
				            ...
				            <th>
					            <div class="input-group">
					            	<input type="text" id="txt_cwfzr" class=" input-radius" name="cwfzr" readonly value="${info.cwfzrmc }"/>
				         ...
				         <tr>
				            ...
				            <div class="input-group">
				            	<c:if test="${empty info.tbrmc}">
					            	<input type="text" id="txt_tbr" class=" input-radius" name="tbr" readonly value="${rymc}"/>
					            </c:if>
					            <c:if test="${not empty info.tbrmc}">
					            	<input type="text" id="txt_tbr" class=" input-radius" name="tbr" readonly value="${info.tbrmc}"/>
					            </c:if>
				            ...
				            <th>
				            	<input type="text" id="txt_dhhm" class=" input-radius" style="text-align: right;" name="dhhm"  value="${info.dhhm }"/>
				            </th>
				            <th style="vertical-align: middle;">教师人数</th>
				            <th><input type="text" id="txt_jsrs" class=" input-radius int" style="text-align: right;" name="jsrs"  value="${info.jsrs }"/></th>
				        </tr>
				         <tr>
				            <th style="vertical-align: middle;">兼职教师人数</th>
				            <th><input type="text" id="txt_jzjsrs" class=" input-radius int" style="text-align: right;" name="jzjsrs"  value="${info.jzjsrs }"/></th>
				            <th style="vertical-align: middle;">外聘教师人数</th>
				            <th><input type="text" id="txt_wpjsrs" class=" input-radius int" style="text-align: right;"  name="wpjsrs"  value="${info.wpjsrs }"/></th>
				            <th style="vertical-align: middle;">专业数</th>
				            <th><input type="text" id="txt_zys" class=" input-radius int" style="text-align: right;" name="zys"  value="${info.zys }"/></th>
				        </tr>
				         <tr>
				            <th style="vertical-align: middle;">班级数</th>
				            <th><input type="text" id="txt_bjs" class=" input-radius int" style="text-align: right;" name="bjs"  value="${info.bjs }"/></th>
				            <th style="vertical-align: middle;">学生人数</th>
				            <th><input type="text" id="txt_xsrs" class=" input-radius int" style="text-align: right;" name="xsrs"  value="${info.xsrs }"/></th>
				            <th></th>
				            <th></th>
				        </tr>
				    </tbody>
