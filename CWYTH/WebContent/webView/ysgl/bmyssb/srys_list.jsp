		...
		<center><h4><strong>收入预算表</strong></h4></center>
			<div class="search-simple">	
				<div class="form-group"> 
					<label>填报部门：</label>					
 					<input type="text" class="form-control input-radius" style="border:none;" name="tbbm"  id="txt_tbbm" readonly="readonly" value="${bmmc}">
				    	...
				    	<c:if test="${list.xmmc!=null}">
				    		...
				    		<td>
				    		    ...
				    		    <div class="input-group" style="width:90%">
					    			<input type="text" id="txt_xmmc${i.index+2}" a="a" class="form-control input-radius null" readonly name="xmmc" value="${list.XMMC }">
					    			<input type="hidden" id="hdn_xmmc${i.index+2}" name="xmid" value="${list.XMID }">
					    			<button type="button" id="btn_xmmc_${i.index+2}" name="btn_xz" class="btn btn-link btn-custom">选择</button>
				    			</div>
				    		</td>
				    		<td>
				    			<input type="text" id="txt_khyhzh${i.index+2}" a="a" class="form-control input-radius null number1" style="text-align: right;" name="yjwcse" value="${list.YJWCSE }">
				    		</td>
				    		<td>
				    			<input type="text" id="txt_khyhzh${i.index+2}" a="a" class="form-control input-radius null date" name="wcsj" value="${list.WCSJ }">
				    		</td>
				    		<td>
				    			<input type="text" id="txt_khyhzh${i.index+2}" a="a" class="form-control input-radius null" name="bz" value="${list.BZ }">
				    		</td>
				    	</tr>
				    	</c:forEach>
				    	<tr id="tr_1">
				    		...
				    		<td>
				    		    ...
				    		    <div class="input-group" style="width:90%">
					    			<input type="text" id="txt_xmmc1" a="a" class="form-control input-radius null" readonly="readonly" style="width:100%;" name="xmmc" value="">
					    			<input type="hidden" id="hdn_xmmc1" name="xmid" value="">
					    			<button type="button" id="btn_xmmc_1" name="btn_xz" class="btn btn-link btn-custom">选择</button>
				    			</div>
				    		</td>
				    		<td>
...
$(function() {
	...
	//弹框
// 	$(document).on("click","#btn_xmmc",function(){
// 		alert(1);
...
//     	}
	...
	$(document).on("click","[class*=addBtn]",function(){
		...
		$parentTr.find("[id^=btn_xmmc]").attr({"sj":"txt_xmmc_"+num,"mc":"txt_zckmid"+num,"id":"btn_xmmc_"+num});
