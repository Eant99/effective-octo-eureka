    	...
    	<form id="myform" class="form-inline" role="form" action="">
    		<div class="search-simple">
				<div class="form-group">
					<label>部门名称</label>
					<input type="text" id="txt_dwbh" class="form-control input-radius" name="mc" table="K" placeholder="请输入单位号">
				</div>
				<div class="form-group">
					<label>年度</label>
					<input type="text" id="txt_mc" class="form-control input-radius" name="nd" table="K" placeholder="请输入单位名称">
				</div>
