...
<form id="myform" class="form-horizontal" action="" method="post" >
	...
	<div class='page-header'>
       <div class="pull-left">
            <span class="page-title text-primary"><i class='fa icon-xiangxixinxi'></i>审核支出预算信息</span>
		</div>
				...
				<div class="row">
					<div class="col-md-4">
						<div class="input-group">
                            ...
                            <input type="text" id="txt_djbh" class="form-control input-radius" name="djbh" value="20171030" readonly>
						</div>
					</div>
					<div class="col-md-4">
						<div class="input-group">
					...
					<div class="col-md-4">
						<div class="input-group">
							...
							<input type="text" id="txt_bznd" class="form-control input-radius" readonly name="bznd" value="2017" data-format="yyyy"/>
						</div>
					</div>
				</div>
				<div class="row">
					...
					<div class="col-md-4">
						<div class="input-group">
							...
							<input type="text" id="" class="form-control input-radius number" name="snzcze" value=""
							readonly/>
						</div>
					</div>
					<div class="col-md-4">
				...
				<div class="row">
					...
					<div class="col-md-4">
						<div class="input-group">
							...
							<input type="text" id="txt_tbsj" class="form-control input-radius" readonly name="tbsj" value="<%=date%>" data-format="yyyy-MM-dd"/>
						</div>
					</div>
					<div class="col-md-4">
						<div class="input-group">
							<span class="input-group-addon">项目名称</span>
							<input type="text" id="txt_xmmc" class="form-control input-radius window" name="xmmc" value="" readonly/>
						</div>
					</div>
			  </div>
				<div class="row">
				...
				<table id="mydatatables" class="table table-striped table-bordered">
		        	<thead id="thead">
				        <tr>
				            ...
				            <th style="width:300px;"><font color="">上年支出（万元）</font></th>
...
$(function(){
	...
	$("#btn_back").click(function(e){
		location.href="${ctx}/webView/ysgl/zcys/check_list.jsp";
	});
	//通过
