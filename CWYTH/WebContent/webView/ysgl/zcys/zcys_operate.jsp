...
<form id="myform" class="form-horizontal" action="" method="post" >
	...
	<div class='page-header'>
       <div class="pull-left">
            <span class="page-title text-primary"><i class='fa icon-xiangxixinxi'></i>编辑支出预算申报</span>
		</div>
	...
	<div class="box">
		<div class="box-panel">		
			<div class="box-header clearfix">
            	<div class="sub-title pull-left text-primary"><i class="fa icon-xiangxi"></i>支出预算申报信息
            	</div>
            	<div class="actions">
				...
				<div class="row">
					<div class="col-md-4">
						<div class="input-group">
							...
							<input type="text" id="" class="form-control input-radius number1" name="snysze" value="" readonly "/>
						</div>
					</div>
					<div class="col-md-4">
						<div class="input-group">
							<span class="input-group-addon"><span class="required">*</span>上年支出总额（万元）</span>
							<input type="text" id="" class="form-control input-radius number1" name="snzcze" value=""
							readonly/>
						</div>
					</div>
					<div class="col-md-4">
						<div class="input-group">
							...
							<input type="text" id="" class="form-control input-radius number1" name="bnysze" value="" readonly/>
						</div>
					</div>
				</div>
				<div class="row">
					...
					<div class="col-md-4">
						<div class="input-group">
							...
							<input type="text" id="txt_xmmc" class="form-control input-radius window" name="xmmc" value="" />
				...
				<table id="mydatatables" class="table table-striped table-bordered">
		        	<thead id="thead">
				        <tr>
				            ...
				            <th style="width:300px;"><span class="required" style="color:red ;">*</span>上年支出（万元）</th>
				    ...
				    <tbody id="tbody">
				    	<tr id="tr_1">
				    		...
				    		<td>
				    			<input type="text" id="txt_snys1" class="form-control input-radius number1 null" name="snys1" value="" readonly>
				    		</td>
				    		<td>
				    			<input type="text" id="txt_snzc1" class="form-control input-radius number1 null" name="snzc1" value="" readonly>
				    		</td>
				    		<td>
...
$(function(){
	var validate = $('#myform').bootstrapValidator({fields:{
			djbh:{validators:{notEmpty: {message: '单据编号不能为空'}}},
       		...
       		snzcze:{validators:{notEmpty: {message: '上年支出总额不能为空'}}},
	...
	$("#btn_back").click(function(e){
		location.href="${ctx}/webView/ysgl/zcys/zcys_list.jsp";
	});
	//保存按钮
...
$(function(){
	$(document).on("click","[id^=btn_yskm]",function(){
		...
		select_commonWin("${ctx}/zcys/zcys/kmxx?controlId="+sjid,"科目信息","920","630");
    });
	$(document).on("click","[id=btn_xmmc]",function(){
		select_commonWin("${ctx}/zcys/zcys/xmxx?controlId=txt_xmmc","项目信息","920","630");
    });
	//新增按钮
	var num = 2;
...
function fz(id){
	...
	$("[id=txt_snys"+num+"]").val("12.2575");
	$("[id=txt_snys"+num+"]").focus();
	$("[id=txt_snzc"+num+"]").val("52.2556");
	$("[id=txt_snzc"+num+"]").focus();
	computer();
}
//上年计算
function computer(){
	...
	$("[name='snzcze']").val(snsrze.toFixed(4));
}
//计算本年预算
