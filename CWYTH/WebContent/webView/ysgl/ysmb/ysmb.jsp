	...
	<div class="search" id="searchBox" style="padding-top: 0px">
		<form id="myform" class="form-inline" action="" style="padding-top: 8px;padding-bottom: 2px;">
			<div class="search-simple">
				...
				<div class="form-group">
					<label>模板名称</label>
					<input type="text" id="txt_mbnr" class="form-control" name="mbmc"  placeholder="请输入模板名称">
				</div>
...
$(function () {
    ...
    table = getDataTableByListHj("mydatatables","${ctx}/ysmb/getYsmbPageData?",[2,'asc'],columns,0,1,setGroup);
	
  	//添加按钮
   	$("#btn_add").click(function(){
   		doOperate("${ctx}/webView/ysgl/ysmb/ysmbEdit.jsp","C");
   	});
	//导出Excel
   	...
   	$(document).on("click",".btn_upd",function(){
	   	...
	   	doOperate("${ctx}/ysmb/goYsmbEditPage?guid="+guid,"C");
   	});
    //批量删除按钮
