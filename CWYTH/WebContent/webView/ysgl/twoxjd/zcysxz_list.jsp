...
$(function () {
    ...
    var columns = [
       ...
       {"data": "SNYSZE",defaultContent:"20.0000","class":"text-right"},
       {"data": "SNZCZE",defaultContent:"20.0000","class":"text-right"},
       {"data": "BNJY",defaultContent:"20.0000","class":"text-right"},
       {"data": "XZR",defaultContent:"","width":400},  
       {"data": "XZSJ",defaultContent:"2017-11-10","class":"text-center","width":400},
	...
	//导出Excel
   	...
   	$(document).on("click",".btn_upd",function(){
	   	...
	   	doOperate("${ctx}/webView/ysgl/twoxjd/zcysxz_edit.jsp");
   	});
