			...
			<div class='responsive-table'>
				<div class='scrollable-area'>
					<form id="myform" class="form-inline" action="" style="padding-top: 8px;padding-bottom: 2px;">
						<center><h4><strong>专项业务费支出预算汇总表</strong></h4></center>
						<div class="search-simple">	
							<!-- <div class="form-group"> 
								<label>填报部门</label>					
...
// 		$("#txt_dwbh").bindChange("${ctx}/suggest/getXx","D");
	   ...
	   var columns = [
	       ...
	       {"data": "XMQZSJ",defaultContent:"","class":"text-left"},       
	       {"data": "XMJSSJ",defaultContent:"","class":"text-left"},       
	       {"data": "XMZTZ",defaultContent:"","class":"text-right"},
	       {"data": "NAPZJS",defaultContent:"","class":"text-right"},
	       {"data": "NYSJYAPS",defaultContent:"","class":"text-right"},
	       ]
	console.log("+++++++++++运行了");
	table = getDataTableByListHj("mydatatables","${ctx}/yszxfx2/getPageList2",[2,'asc'],columns,0,1,setGroup);
	...
	$("tbody tr").bind("dblclick",function(){
		...
		console.log("----------"+xmmc);
		doOperate("${ctx}/yszxfx/gozxywfzcysMxListPage?xmmc="+xmmc);
	});
	//打印
	$(document).on("click","#btn_print",function(){
   		doOperate("${ctx}/yszxfx/ZxywfzcPrint");
	});
	...
	//导出Excel
   	$("#btn_exp").click(function(){
		...
		checkbox.each(function(){
   		...
   		doExp(json,"${ctx}/yszxfx/expExcel2?guid="+guid.join("','"),"专项业务费支出预算表","${pageContext.request.contextPath}",guid.join(","));
   	});
