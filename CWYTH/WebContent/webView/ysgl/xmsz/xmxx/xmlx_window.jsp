...
$(function () {
    ...
    var columns = [
    	  {"data": "GUID",orderable:false, 'render': function (data, type, full, meta){
    	         return '<input type="checkbox" name="guid" mc="'+full.XMLXMC+'" bmc="('+full.XMLXMC+')'+full.XMLXBH+'" class="keyId" value="' + data + '" guid = "'+full.GUID+'">';
  ...
  */   });
    ...
    $(document).on("dblclick","#mydatatables tr:not(#header)",function(){
     	...
     	var qmc=$(this).find("[name='guid']").attr("bmc");
