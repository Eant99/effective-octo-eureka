...
<div id="myform" class="form-horizontal" action="" method="post">
	...
	<div class="page-header">
		<div class="pull-left">
            <span class="page-title text-primary"><i class='fa icon-xiangxixinxi'></i>添加项目信息</span>
		</div>
	...
	<form id="myform1">
		...
		<div class="box-panel">
			<div class="box-header clearfix">
            	<div class="sub-title pull-left text-primary"><i class="fa icon-xiangxi"></i>添加项目基本信息</div>
            		<div class="actions">
				...
				<div class="row">
					<div class="col-md-4">
						<div class="input-group">
							...
							<input type="text" id="txt_bmbh" name="bmbh" class="form-control input-radius window" style="border-bottom-right-radius: 4px;border-top-right-radius: 4px;" placeholder="请输入部门名称"/>
					...
					<div class="col-md-4">
						<div class="input-group">
							...
							<input type="text" id="txt_xmbh" name="xmbh" value=""  class="form-control input-radius" style="border-bottom-right-radius: 4px;border-top-right-radius: 4px;" />
						</div>
                    </div>
					<div class="col-md-4">
						<div class="input-group">
							<span class="input-group-addon"><span class="required">*</span>项目名称</span>
							<input type="text" id="txt_xmmc" name="xmmc" class="form-control input-radius" style="border-bottom-right-radius: 4px;border-top-right-radius: 4px;" placeholder="请输入项目名称" />
						</div>
                    </div>
				</div>
				<div class="row">
					...
					<div class="col-md-4">
						<div class="input-group">
							...
							<input type="text" id="txt_xmlx" name="xmlx" class="form-control input-radius window" style="border-bottom-right-radius: 4px;border-top-right-radius: 4px;" placeholder="请选择项目类型"/>
				...
				<div class="row">
					<div class="col-md-4">
						<div class="input-group">
							...
							<input type="text" id="txt_fzr" name="fzr" class="form-control input-radius window" style="border-bottom-right-radius: 4px;border-top-right-radius: 4px;" placeholder="请选择负责人" />
					...
					<div class="col-md-4">
						<div class="input-group">
							...
							<input type="text" id="txt_gkbm" name="gkbm" class="form-control input-radius window" style="border-bottom-right-radius: 4px;border-top-right-radius: 4px;" placeholder="请选择归口部门" />
                ...
                <div class="row">
					...
					<div class="col-md-4">
						<div class="input-group ">
							...
							<div class="radiodiv">
						 &nbsp; &nbsp;
								<input type="radio" name="sfwg" class="rdo" value="1" />
								 <label >是</label>
						 &nbsp; &nbsp; &nbsp;
							
								<input type="radio" name="sfwg" class="rdo" value="0" checked />
								 <label >否</label>
					...
					<div class="col-md-4">
						<div class="input-group">
							...
							style="border-bottom-right-radius: 4px;border-top-right-radius: 4px;" placeholder="请输入开始时间" />
						</div>
                    </div>
				</div>
				<div class="row">
                    <div class="col-md-4">
						<div class="input-group">
							...
							style="border-bottom-right-radius: 4px;border-top-right-radius: 4px;" placeholder="请输入结束时间" />
						</div>							
					</div>							
					<div class="col-md-4">
						<div class="input-group">
       ...
       style="border-bottom-right-radius: 4px;text-align:right;border-top-right-radius: 4px;" placeholder="" />
						</div>
					</div>							
					<div class="col-md-4">
						<div class="input-group">
                ...
                <div class="row">
					<div class="col-md-4">
						<div class="input-group">
							...
							<div class="radiodiv">&nbsp; &nbsp;
								<input type="radio" name="xmjfsfyxcb" class="rdo" value="1" />
								 <label >是</label> &nbsp; &nbsp; &nbsp;
								<input type="radio" name="xmjfsfyxcb" class="rdo" value="0" checked />
								 <label >否</label>
							</div>
						</div>
                    </div>
                    <div class="col-md-4">
						<div class="input-group">
							...
							<input type="text" id="txt_cbbl" name="cbbl" class="form-control input-radius" value="" onKeyUp="this.value=this.value.replace(/[^\d\.]/g,'')" onBlur="checknum(this)"
							style="border-bottom-right-radius: 4px;text-align:right;border-top-right-radius: 4px;"  />
						</div>
                    </div>
                    <div class="col-md-4">
						<div class="input-group">
							...
							<div class="radiodiv">&nbsp; &nbsp;
								<input type="radio" name="sfjxjjflfykz" class="rdo" value="1" />
								 <label >是</label> &nbsp; &nbsp; &nbsp;
								<input type="radio" name="sfjxjjflfykz" class="rdo" value="0" checked />
								 <label >否</label>
							</div>
						</div>
                    </div>
...
<!-- 							<div class="radiodiv">&nbsp; &nbsp; -->
<!-- 								<input type="radio" name="sfky" class="rdo" value="1" /> -->
<!-- 								 <label >是</label> &nbsp; &nbsp; &nbsp; -->
<!-- 								<input type="radio" name="sfky" class="rdo" value="0" checked /> -->
<!-- 								 <label >否</label> -->
<!-- 							</div> -->
<!-- 						</div> -->
<!--                     </div> -->
                    <div class="col-md-4">
						<div class="input-group">
							<span class="input-group-addon" style="border: 1px solid #ccc!important;vertical-align: middle;">政府采购金额（元）</span>
                    ...
                    <div class="col-md-4">
						<div class="input-group">
							<span class="input-group-addon" style="border: 1px solid #ccc!important;vertical-align: middle;">非政府采购金额（元）</span>
                    ...
                    <div class="col-md-4">
						<div class="input-group">
							...
							<input type="text" id="txt_ktmc" name="ktmc" class="form-control input-radius window" placeholder="请选择项目名称" />
...
<!-- 							<div class="radiodiv">&nbsp; &nbsp; -->
<!-- 								<input type="radio" name="kjkmyxjz" class="rdo" value="1" /> -->
<!-- 								 <label >允许</label> &nbsp; &nbsp; &nbsp; -->
<!-- 								<input type="radio" name="kjkmyxjz" class="rdo" value="0" checked /> -->
<!-- 								 <label >禁止</label> -->
<!-- 							</div> -->
<!-- 						</div> -->
<!--                     </div> -->
...
<!-- 							<div class="radiodiv">&nbsp; &nbsp; -->
<!-- 								<input type="radio" name="jjkmyxjz" class="rdo" value="1" /> -->
<!-- 								 <label >允许</label> &nbsp; &nbsp; &nbsp; -->
<!-- 								<input type="radio" name="jjkmyxjz" class="rdo" value="0" checked /> -->
<!-- 								 <label >禁止</label> -->
<!-- 							</div> -->
<!-- 						</div> -->
<!--                     </div> -->
...
<!-- 								<select id="txt_yslx" class="form-control input-radius" name="yslx"> -->
...
<!--                     </div> -->
					<div class="col-md-4">
						<div class="input-group ">
							...
							<div class="radiodiv">
							&nbsp;&nbsp;
								<input type="radio" name="sfczzc" class="rdo cz" value="1" />
								<label>是</label>
						&nbsp;&nbsp;&nbsp;
						
								<input type="radio" name="sfczzc" class="rdo cz" value="0" checked />
								<label>否</label>
                    ...
                    <div class="col-md-4">
						<div class="input-group ">
							...
							<div class="radiodiv">
							&nbsp;&nbsp;
								<input type="radio" name="sfgk" class="rdo" value="1" />
								<label>是</label>
						&nbsp;&nbsp;&nbsp;
								<input type="radio" name="sfgk" class="rdo" value="0" checked />
								<label>否</label>
                    ...
                    <div class="col-md-4">
						<div class="input-group">
							...
							<input type="text" id="txt_gkxxm" name="gkxxm" class="form-control input-radius" style="border-bottom-right-radius: 4px;border-top-right-radius: 4px;" placeholder="请输入国库信息码" />
						</div>
                    </div>
				</div>
			</div>
...
// 		}
 ...
 $("#txt_gkbm").bindChange("${ctx}/suggest/getXx","CD");
	...
	var validate = $("#myform1").bootstrapValidator({fields:{
        ...
        xmmc:{validators:{notEmpty: {message: '项目名称不能为空'},stringLength:{message:'项目编号过长',max:'32'}}},
			...
			if(srkmbh==""&&srkmbh2 !=""){
				...
				if(srkmbhs != '5005'){
					...
					if(srkmbh2s != '5005'&&srkmbhs != '5005'){
						alert("支出请选择当前项目类别——“离退休”下的科目编号！");
						return;
					}}
			}
		}
	 doSave(validate,"myform1",target+"/doSave",function(val){
			if(val.success) {
				next();
				alert(val.msg);
			}
...
// 	});
	...
	$(document).on("click","#btn-srkm",function(){
		select_commonWin("${ctx}/window/goSrkmPage?controlId=txt_srkm","收入科目","920","630");
	});
	//支出科目弹窗
...
// 	}
	...
	$.ajax({
		...
		success:function(val){
				var yslx = val.YSLX;
				var sfczzc = val.SFCZZC;
// 				alert("yslx="+yslx+"sfczzc="+sfczzc);
				$(".cz[value='"+sfczzc+"']").attr("checked",'true');
 				$("#txt_yslx option").removeAttr("selected");
// 				var option = $("#txt_yslx").find("option");
// 				 document.getElementById("txt_yslx").value = yslx;
