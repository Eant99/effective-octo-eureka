...
//配置iframeUlr
var _pageUrl="${pageContext.request.contextPath}/xmlx/goJjkmWindowPage?pname=${param.pname}&controlId=${param.controlId}&controlId1=${param.controlId1}&dx=${param.dx}";
//权限标志
var _type="self";
