...
$(function(){
    ...
    $(document).on("dblclick","#mydatatables tr:not(#header)",function(){
    	...
    	if(vals==''||vals==null||vals==undefined){
    		...
    		getIframeControl("${param.pname}","${param.controlId1}").val(vals);
	...
	var columns = [
		{"data": "guid",orderable:false, "render": function (data, type, full, meta){
	       	return '<input type="checkbox" name="guid" kmbh="'+full.KMBH+'" class="keyId" value="' +full.KMMC + '" guid = "'+full.GUID+'" kmjc = "'+full.KMJC+'">';
