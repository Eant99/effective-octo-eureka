...
<form id="myform" class="form-horizontal" action="" method="post">
	...
	<div class="page-header">
		<div class="pull-left">
            <span class="page-title text-primary"><i class='fa icon-xiangxixinxi'></i>添加收入项目信息</span>
		</div>
			...
			<div class="container-fluid box-content">
				...
				<div class="col-dm-18">
					<div class="input-group">
                        ...
                        <textarea id="txt_bz"  class="form-control" name="bz" style=" height: 142px; width: 100%;"></textarea>
					</div>
				</div>
			</div>
         </div>
...
function checkXmbhExist(){
	var tag = false;
	var srxmbh = $("#txt_srxmbh").val();
	$.ajax({
		type:"post",
		//url:ADDRESS+"/xmxx/checkXmbh",
		url:target+"/checkSrxmbhExist",
		data:"srxmbh="+srxmbh,
		async:false,
