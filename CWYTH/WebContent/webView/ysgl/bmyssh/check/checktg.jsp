...
$(function(){
	...
	$("#btn_qd").click(function(){
		...
		$.ajax({
			...
			data:"&procinstid="+procinstid+"&pass=true&guid="+guid+"&shyj="+shyj+"&SRYSHZ="+SRYSHZ+"&ZCYSHZ="+ZCYSHZ,
			success:function(val){
				var data = JSON.getJson(val);
				if(data.success='true'){
					alert("操作成功！");
					getIframWindow("iframe_160401").location.href="${ctx}/ysgl/bmyssh/goBmysshPage";
					close(winId);
