		...
		<div class='responsive-table'>
			...
			<form id="myform1">
				<table id="mydatatables" class="table table-striped table-bordered" style="border-collapse: collapse">
				    ...
				    <tbody id="tbody">
				    	 <tr>
				            <th style="color: blue;font-size:15px;">一、基本情况</th>
				            <th></th>
				            <th>&nbsp&nbsp&nbsp&nbsp长休人员</th>
				            <th><input type="text" id="txt_bmh" class="form-control input-radius" name="bmh"  value=""/></th>
				            <th>&nbsp&nbsp10、编制内领导职数</th>
				            <th><input type="text" id="txt_bmh" class="form-control input-radius" name="bmh"  value=""/></th>
				        </tr>
				         <tr>
				            <th>&nbsp&nbsp单位规格</th>
				            <th><input type="text" id="txt_bmh" class="form-control input-radius" name="bmh"  value=""/></th>
				            <th>&nbsp&nbsp&nbsp&nbsp提前离岗、离职留薪人员</th>
				            <th><input type="text" id="txt_bmh" class="form-control input-radius" name="bmh"  value=""/></th>
				            <th>&nbsp&nbsp11、教师学生数</th>
				            <th><input type="text" id="txt_bmh" class="form-control input-radius" name="bmh"  value=""/></th>
				        </tr>
				         <tr>
				            <th>&nbsp&nbsp单位性质</th>
				            <th><input type="text" id="txt_bmh" class="form-control input-radius" name="bmh"  value=""/></th>
				            <th>&nbsp&nbsp3、离休人员</th>
				            <th><input type="text" id="txt_bmh" class="form-control input-radius" name="bmh"  value=""/></th>
				            <th>&nbsp&nbsp&nbsp&nbsp教师人数</th>
				            <th><input type="text" id="txt_bmh" class="form-control input-radius" name="bmh"  value=""/></th>
				        </tr>
				         <tr>
				            <th>&nbsp&nbsp预算编码</th>
				            <th><input type="text" id="txt_bmh" class="form-control input-radius" name="bmh"  value=""/></th>
				            <th>&nbsp&nbsp4、退休人员</th>
				            <th><input type="text" id="txt_bmh" class="form-control input-radius" name="bmh"  value=""/></th>
				            <th>&nbsp&nbsp&nbsp&nbsp高中学生人数</th>
				            <th><input type="text" id="txt_bmh" class="form-control input-radius" name="bmh"  value=""/></th>
				        </tr>
				         <tr>
				            <th>&nbsp&nbsp预算级次（一级/二级）</th>
				            <th><input type="text" id="txt_bmh" class="form-control input-radius" name="bmh"  value=""/></th>
				            <th>&nbsp&nbsp5、公益性岗位人员</th>
				            <th><input type="text" id="txt_bmh" class="form-control input-radius" name="bmh"  value=""/></th>
				            <th>&nbsp&nbsp&nbsp&nbsp初中学生人数</th>
				            <th><input type="text" id="txt_bmh" class="form-control input-radius" name="bmh"  value=""/></th>
				        </tr>
				         <tr>
				            <th>&nbsp&nbsp经费供给方式（全额/差额/自收自支）</th>
				            <th><input type="text" id="txt_bmh" class="form-control input-radius" name="bmh"  value=""/></th>
				            <th>&nbsp&nbsp6、遗属人数</th>
				            <th><input type="text" id="txt_bmh" class="form-control input-radius" name="bmh"  value=""/></th>
				            <th>&nbsp&nbsp&nbsp&nbsp小学学生人数</th>
				            <th><input type="text" id="txt_bmh" class="form-control input-radius" name="bmh"  value=""/></th>
				        </tr>
				         <tr>
				            <th>&nbsp&nbsp综合定额标准（元）</th>
				            <th><input type="text" id="txt_bmh" class="form-control input-radius" name="bmh"  value=""/></th>
				            <th>&nbsp&nbsp7、其他人员</th>
				            <th><input type="text" id="txt_bmh" class="form-control input-radius" name="bmh"  value=""/></th>
				            <th>&nbsp&nbsp&nbsp&nbsp幼儿园学生人数</th>
				            <th><input type="text" id="txt_bmh" class="form-control input-radius" name="bmh"  value=""/></th>
				        </tr>
				         <tr>
				            <th>&nbsp&nbsp是否代发工资</th>
				            <th><input type="text" id="txt_bmh" class="form-control input-radius" name="bmh"  value=""/></th>
				            <th>&nbsp&nbsp8、在职人员职务级别</th>
				            <th><input type="text" id="txt_bmh" class="form-control input-radius" name="bmh"  value=""/></th>
				            <th>&nbsp&nbsp&nbsp&nbsp高等职业学校学生人数</th>
				            <th><input type="text" id="txt_bmh" class="form-control input-radius" name="bmh"  value=""/></th>
				        </tr>
				         <tr>
				            <th></th>
				            <th></th>
				            <th>&nbsp&nbsp&nbsp&nbsp正厅级</th>
				            <th><input type="text" id="txt_bmh" class="form-control input-radius" name="bmh"  value=""/></th>
				            <th>&nbsp&nbsp&nbsp&nbsp中等职业学校学生人数</th>
				            <th><input type="text" id="txt_bmh" class="form-control input-radius" name="bmh"  value=""/></th>
				        </tr>
				         <tr>
				            <th></th>
				            <th></th>
				            <th>&nbsp&nbsp&nbsp&nbsp副厅级</th>
				            <th><input type="text" id="txt_bmh" class="form-control input-radius" name="bmh"  value=""/></th>
				            <th>&nbsp&nbsp&nbsp&nbsp特殊学校学生人数</th>
				            <th><input type="text" id="txt_bmh" class="form-control input-radius" name="bmh"  value=""/></th>
				        </tr>
				        <tr>
				            <th style="color: blue;font-size:15px;">二、人员基本情况</th>
				            <th></th>
				            <th>&nbsp&nbsp&nbsp&nbsp正处级</th>
				            <th><input type="text" id="txt_bmh" class="form-control input-radius" name="bmh"  value=""/></th>
				            <th></th>
				            <th></th>
				        </tr>
				         <tr>
				            <th>&nbsp&nbsp1、编制人员</th>
				            <th><input type="text" id="txt_bmh" class="form-control input-radius" name="bmh"  value=""/></th>
				            <th>&nbsp&nbsp&nbsp&nbsp副处级</th>
				            <th><input type="text" id="txt_bmh" class="form-control input-radius" name="bmh"  value=""/></th>
				            <th></th>
				            <th></th>
				        </tr>
				         <tr>
				            <th>&nbsp&nbsp&nbsp&nbsp行政</th>
				            <th><input type="text" id="txt_bmh" class="form-control input-radius" name="bmh"  value=""/></th>
				            <th>&nbsp&nbsp&nbsp&nbsp正科级</th>
				            <th><input type="text" id="txt_bmh" class="form-control input-radius" name="bmh"  value=""/></th>
				            <th style="color: blue;font-size:15px;">三、公用设施、设备情况</th>
				            <th></th>
				        </tr>
				         <tr>
				            <th>&nbsp&nbsp&nbsp&nbsp工勤</th>
				            <th><input type="text" id="txt_bmh" class="form-control input-radius" name="bmh"  value=""/></th>
				            <th>&nbsp&nbsp&nbsp&nbsp副科级</th>
				            <th><input type="text" id="txt_bmh" class="form-control input-radius" name="bmh"  value=""/></th>
				            <th>&nbsp&nbsp1、公办建筑面积（平方米）</th>
				            <th><input type="text" id="txt_bmh" class="form-control input-radius" name="bmh"  value=""/></th>
				        </tr>
				         <tr>
				            <th>&nbsp&nbsp&nbsp&nbsp事业</th>
				            <th><input type="text" id="txt_bmh" class="form-control input-radius" name="bmh"  value=""/></th>
				            <th>&nbsp&nbsp&nbsp&nbsp一般干部</th>
				            <th><input type="text" id="txt_bmh" class="form-control input-radius" name="bmh"  value=""/></th>
				            <th>&nbsp&nbsp2、单位车辆</th>
				            <th><input type="text" id="txt_bmh" class="form-control input-radius" name="bmh"  value=""/></th>
				        </tr>
				         <tr>
				            <th>&nbsp&nbsp2、实有人数</th>
				            <th><input type="text" id="txt_bmh" class="form-control input-radius" name="bmh"  value=""/></th>
				            <th>&nbsp&nbsp9、在职人员职称级别</th>
				            <th><input type="text" id="txt_bmh" class="form-control input-radius" name="bmh"  value=""/></th>
				            <th>&nbsp&nbsp&nbsp&nbsp一般公务用车</th>
				            <th><input type="text" id="txt_bmh" class="form-control input-radius" name="bmh"  value=""/></th>
				        </tr>
				         <tr>
				            <th>&nbsp&nbsp&nbsp&nbsp在岗人数</th>
				            <th><input type="text" id="txt_bmh" class="form-control input-radius" name="bmh"  value=""/></th>
				            <th>&nbsp&nbsp&nbsp&nbsp正高级</th>
				            <th><input type="text" id="txt_bmh" class="form-control input-radius" name="bmh"  value=""/></th>
				            <th>&nbsp&nbsp&nbsp&nbsp执法执勤用车</th>
				            <th><input type="text" id="txt_bmh" class="form-control input-radius" name="bmh"  value=""/></th>
				        </tr>
				         <tr>
				            <th>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp行政</th>
				            <th><input type="text" id="txt_bmh" class="form-control input-radius" name="bmh"  value=""/></th>
				            <th>&nbsp&nbsp&nbsp&nbsp副高级</th>
				            <th><input type="text" id="txt_bmh" class="form-control input-radius" name="bmh"  value=""/></th>
				            <th>&nbsp&nbsp&nbsp&nbsp其他专业用车</th>
				            <th><input type="text" id="txt_bmh" class="form-control input-radius" name="bmh"  value=""/></th>
				        </tr>
				         <tr>
				            <th>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp工勤</th>
				            <th><input type="text" id="txt_bmh" class="form-control input-radius" name="bmh"  value=""/></th>
				            <th>&nbsp&nbsp&nbsp&nbsp中级</th>
				            <th><input type="text" id="txt_bmh" class="form-control input-radius" name="bmh"  value=""/></th>
				            <th></th>
				            <th></th>
				        </tr>
				         <tr>
				            <th>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp事业</th>
				            <th><input type="text" id="txt_bmh" class="form-control input-radius" name="bmh"  value=""/></th>
				            <th>&nbsp&nbsp&nbsp&nbsp初级</th>
				            <th><input type="text" id="txt_bmh" class="form-control input-radius" name="bmh"  value=""/></th>
				            <th></th>
				            <th></th>
				        </tr>
