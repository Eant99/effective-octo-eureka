...
$(function () {
    ...
    var columns = [
       ...
       {"data": "SHZT",defaultContent:"已提交","class":"text-center"},
    ...
    $("[id$=_sh]").click(function(){
    	select_commonWin("${ctx}/webView/ysgl/srys/check.jsp","审核意见页面","500","300");
  	});
   //查看按钮
   	$(".btn_look").click(function(){
   		location.href="${ctx}/webView/ysgl/srys/check_view.jsp";
   	});
   	$(".btn_upd").click(function(){
   		location.href="${ctx}/webView/ysgl/srys/srys_check.jsp";
   	});
	//导出Excel
