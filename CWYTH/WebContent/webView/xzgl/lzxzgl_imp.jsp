...
<body>
     <form id="myform" class="form-horizontal"  action="${ctx}/xzgl/upload_lz?pname=${param.pname}" 
...
//     		}
    		...
    		$("#btn_exp").click(function(){
    			...
    			doExp("","${ctx}/xzgl/LzryexpExcelnew?texts="+texts,"退休人员薪资导入模板","${pageContext.request.contextPath}","");
    			/* var fname = "退休人员薪资导入模板.xls";
    			var path = "uploadFiles/退休人员薪资导入模板.xls";
    		...
    		if (commonWin == 'T') {
    			var file = "${file}";
    			select_commonWin("${pageContext.request.contextPath}/xzgl/getImpLzxzQr?file="+ file ,"数据确认", "750", "550");
    			return false;
    		}
