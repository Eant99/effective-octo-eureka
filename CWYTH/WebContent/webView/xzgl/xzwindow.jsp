...
//配置iframeUlr   /CWYTH/WebContent/webView/xzgl/xzrylist.jsp
var _pageUrl="${pageContext.request.contextPath}/webView/xzgl/xzrylist.jsp?pname=${param.pname}&controlId=${param.controlId}&model=${param.model}&szbmm=${param.szbmm}&ryid=${param.ryid}&flag=${param.flag}&gzyf=${param.gzyf}";
//权限标志
var _type;
var flag = "${param.flag}";
if(flag=="All"){
