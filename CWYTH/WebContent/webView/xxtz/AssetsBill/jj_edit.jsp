...
<body>
		...
		<div class="row">
			...
			<div class="col-md-4">
				<div class="input-group">
					<span class="input-group-addon" id="span_hgrq">货到日期</span>
		...
		<div class="row">
			<div class="col-md-4">
				<div class="input-group">
					...
					<input type="text" id="txt_tph" class="form-control input-radius text-right int" name="tph" value="${yshd.TPH}" readonly="readonly">
				</div>
			</div>
			<div class="col-md-4">
				<div class="input-group">
			...
			<c:if test="${yshd.ffldm=='6010200' or yshd.ffldm=='6010300'}">
				<div class="col-md-4">
					<div class="input-group">
						<span class="input-group-addon">桌椅类别</span>
						<select id="drp_jj_bgzylb" class="form-control input-radius" name="jj_bgzylb">
							<option value="1" <c:if test="${yshd.JJ_BGZYLB==1}">selected</c:if>>司局级</option>
                        	<option value="2" <c:if test="${yshd.JJ_BGZYLB==2}">selected</c:if>>处级及以下</option>
						</select>
					</div>
				</div>
			</c:if>
			<c:if test="${yshd.ffldm=='6010400'}">
				<div class="col-md-4">
					<div class="input-group">
						<span class="input-group-addon">沙发类别</span>
						<select id="drp_jj_sflb" class="form-control input-radius" name="jj_sflb">
							<option value="1" <c:if test="${yshd.JJ_SFLB==1}">selected</c:if>>单人</option>
                        	<option value="2" <c:if test="${yshd.JJ_SFLB==2}">selected</c:if>>三人以上</option>
						</select>
					</div>
				</div>
			</c:if>
...
$(function(){
	...
	$("[id*=txt_sykh]").mouseleave(function(){
		var sykh = $(this).val();
		if(sykh<1){
			alert("套(件)数不能小于1！！！");
			$(this).val("1");
