...
<div class="box">
	...
	<div class="alert alert-info"><strong>提示：</strong>先找到需要的学科，然后<strong>双击</strong>这条信息</div>
...
<script>
$(function (){
	var bzdm = "${param.dm}";//点击左侧树上的节点，传过来的flbm（分类号去掉右侧的0）
    table = $('#example').DataTable({
        ajax: {
        	url: "${pageContext.request.contextPath}/window/xkxx?bzdm="+bzdm//获取数据的方法
        },
