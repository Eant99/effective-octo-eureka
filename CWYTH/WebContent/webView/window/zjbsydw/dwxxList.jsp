...
$(function (){
	var winId = getTopFrame().layer.getFrameIndex(parent.window.name);
   	...
   	$('#mydatatables').DataTable({
        "ajax": {
            url:"${pageContext.request.contextPath}/window/getDwxxZjbWindow?dwbh=${param.dwbh}&treesearch=${param.treesearch}&from=${param.from}"//获取数据的方法
        },
    ...
    if("${param.windowModel}" == "1"){
    	...
    	$("div.button").prop("innerHTML","单位信息列表");
    }
