...
//配置iframeUlr
var _pageUrl="${pageContext.request.contextPath}/webView/window/sbwx/wxsq/wxsq_list.jsp?pname=${param.pname}&controlId=${param.controlId}&windowModel=${param.windowModel}";
//权限标志
var _type="self";
Ext.onReady(function(){
	...
	var right=new Ext.Panel({
         ...
         title:"",
         autoScroll:false,
         html: "<iframe frameborder='0' width='100%' height='100%' scrolling='auto' src='"+_pageUrl+"' id='iframe_list_wxsqxx' name='iframe_list_wxsqxx'></iframe>",
         border: true
     });
	/*创建窗体分割器*/
    new Ext.Viewport({
