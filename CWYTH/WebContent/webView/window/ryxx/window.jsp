...
var _pageUrl="";
if(ymbz == 'xmsq'){
	_pageUrl="${pageContext.request.contextPath}/xmsq/goJsxxPage?pname=${param.pname}&controlId=${param.controlId}&controlId1=${param.controlId1}&controlId2=${param.controlId2}&controlId3=${param.controlId3}&szbmm=${param.szbmm}&ryid=${param.ryid}&flag=${param.flag}";
}else{
	_pageUrl="${pageContext.request.contextPath}/webView/window/ryxx/ryxxList.jsp?mkbh=${mkbh}&pname=${param.pname}&controlId=${param.controlId}&controlId1=${param.controlId1}&controlId2=${param.controlId2}&controlId3=${param.controlId3}&szbmm=${param.szbmm}&ryid=${param.ryid}&flag=${param.flag}";
}
//权限标志
var _type;
var flag = "${param.flag}";
