...
//配置iframeUlr
var _pageUrl="${pageContext.request.contextPath}/webView/window/ryxx/ryxxList2.jsp?pname=${param.pname}&controlId=${param.controlId}&szbmm=${param.szbmm}&ryid=${param.ryid}&flag=${param.flag}";
//权限标志
var _type;
var flag = "${param.flag}";
if(flag=="All"){
