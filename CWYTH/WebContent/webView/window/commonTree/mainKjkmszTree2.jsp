...
//配置iframeUlr
var _pageUrl="${pageContext.request.contextPath}/kjkmsz/goKmszPage1?pname=${param.pname}&controlId=${param.controlId}&szbmm=${param.szbmm}&ryid=${param.ryid}&flag=${param.flag}";
//权限标志
var _type="self";
