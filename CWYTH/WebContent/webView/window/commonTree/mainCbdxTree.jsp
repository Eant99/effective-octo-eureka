...
//配置iframeUlr
var _pageUrl="${pageContext.request.contextPath}/cbdx/goPageList?tid=";
//权限标志
var _type="self";
Ext.onReady(function(){
	var root = new Ext.tree.AsyncTreeNode({
        ...
        loader: new Ext.tree.TreeLoader({
        	 url: "${pageContext.request.contextPath}/tree/cbdxTree",
//         	 url: "http://localhost/apis/hello/treeDmbNew",
             listeners: {
