...
//配置iframeUlr
var _pageUrl="${pageContext.request.contextPath}/kjkmsz/goKmszPage?mkbh=${param.mkbh}";
//权限标志
var _type="self";
 ...
 */
    ...
    $("#txt_treesearch").bindChange("${pageContext.request.contextPath}/suggest/getXx","KJKM");
