...
//配置iframeUlr
var _pageUrl="${ctx}${param.pageUrl}?mkbh=${param.mkbh}";
//权限标志
var _type="self";
...
//     var str = "<div class='ext-tree-search input-group'><input class='form-control' type='text' id='txt_fykm' placeholder='输入分类编号或分类名称' ><span class='input-group-btn'><button type='button' title='点击搜索信息' id='btn_search' class='btn'><i class='faw fa-search' aria-hidden='true'></i></button></span></div>";
//     $("#left_tree .x-panel-body").prepend(str);
    
    $("#btn_search").click(function(){
 	   var dwbhmc = $("#txt_fykm").val();
    ...
    $("#txt_fykm").bindChange("${ctx}/suggest/getXx","FYKMSZ");
});
</script>
</body>
</html>