...
$(function (){
	...
	var columns = [
	           	{"data": "DM",orderable:false, "render": function (data, type, full, meta){
	        		return '<input type="checkbox" class="keyId" name="dwbh" value="' + "("+full.DM+")"+full.MC + '">';
	...
	table = $('#mydatatables').DataTable({
        ajax: {
            url: "${pageContext.request.contextPath}/window/goZyfxPageList?dwbh=${param.dwbh}&treesearch=${param.treesearch}&from=${param.from}"//获取数据的方法
        },
    ...
    $(document).on("dblclick","#mydatatables tr:not(#header)",function(){
    	...
    	console.log("____"+val+"___"+winId+"__${param.pname}____${param.controlId}+____"+window.name);
