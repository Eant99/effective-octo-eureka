...
//配置iframeUlr
_pageUrl="${ctx}${pageUrl}?mkbh=${mkbh}&bz=${bz}";
//权限标志
var sql;
if("${sql}"=='undefined'){
	sql='sql'
...
Ext.onReady(function(){
	var root = new Ext.tree.AsyncTreeNode({
     ...
     var right=new Ext.Panel({
         ...
         title:"", 
         autoScroll:false, 
         html: "<iframe frameborder=\"0\" width=\"100%\" height=\"100%\" scrolling=\"auto\" src=\""+_pageUrl+"&sql="+sql+"\" id=\"iframe_list_${mkbh}\" name=\"iframe_list_${mkbh}\"></iframe>",
         border: true
     });
	/*创建窗体分割器*/
    new Ext.Viewport({
