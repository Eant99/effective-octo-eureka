...
//配置iframeUlr
var _pageUrl="${pageContext.request.contextPath}/kmsz/goGnkmszPage";
//权限标志
var _type="self";
Ext.onReady(function(){
     ...
     * 左侧树的联想查询
     */
    	var str = "<div class='ext-tree-search input-group'><input class='form-control' type='text' id='txt_treesearch' placeholder='请输入功能科目编号或名称！' ><span class='input-group-btn'><button type='button' title='点击搜索信息' class='btn'><i class='faw fa-search' aria-hidden='true'></i></button></span></div>";
