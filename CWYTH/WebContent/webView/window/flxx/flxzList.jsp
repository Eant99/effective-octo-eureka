...
$(function (){
	...
	//点击左侧树上的节点，传过来的flbm（分类号去掉右侧的0）
	var URL="${pageContext.request.contextPath}/window/flxz?treesearch=${param.treesearch}&flh=${param.flh}&ffldm=${param.ffldm}&lyr=${param.lyr}";//获取数据的方法，常用分类代码
	if('${param.dl}'!=''){
		URL="${pageContext.request.contextPath}/window/flxx?treesearch=${param.treesearch}&flbm=${param.flbm}&lyr=${param.lyr}&dl=${param.dl}";//获取数据的方法,大类
	}
