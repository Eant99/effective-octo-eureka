...
var _pageUrl="${pageContext.request.contextPath}/webView/window/dwxx/dwxxList.jsp?pname=${param.pname}&controlId=${param.controlId}&windowModel=${param.windowModel}&type=${param.type}&from="+from;
