...
var _pageUrl="${pageContext.request.contextPath}/webView/kjhs/kmsz/bmdwxxList.jsp?pname=${param.pname}&controlId=${param.controlId}&controlName=${param.controlName}";
