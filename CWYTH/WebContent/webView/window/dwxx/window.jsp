...
var _pageUrl="${pageContext.request.contextPath}/webView/window/dwxx/dwxxList.jsp?pname=${param.pname}&controlId=${param.controlId}&controlId1=${param.controlId1}&controlId2=${param.controlId2}&mkbh=${param.mkbh}&windowModel=${param.windowModel}&from="+from;
