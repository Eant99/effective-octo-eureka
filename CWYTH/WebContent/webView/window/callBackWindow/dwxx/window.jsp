...
//配置iframeUlr
var _pageUrl="${pageContext.request.contextPath}/webView/window/callBackWindow/dwxx/dwxxList.jsp?pname=${param.pname}&controlId=${param.controlId}&ejdw=${param.ejdw}&flag=${param.flag}";
//权限标志
var _type="self";
Ext.onReady(function(){
	var root = new Ext.tree.AsyncTreeNode({
        ...
        loader: new Ext.tree.TreeLoader({
        	//单位权限
        	url: "${pageContext.request.contextPath}/tree/ejdwTree?ejdw=${param.ejdw}&flag=${param.flag}",
            listeners: {
