...
$(function () {
   ...
   var columns = [
       ...
       {"data": "XMFZR",defaultContent:"","class":"text-left"},
       {"data": "BXLX",defaultContent:"","class":"text-left"},
       {"data": "BXSJ",defaultContent:"","class":"text-center"},
       {"data": "BXR",defaultContent:"","class":"text-left"},
       {"data": "BXZJE",defaultContent:"","class":"text-right"}
     ];
    table = getDataTableByListHj("mydatatables","${ctx}/wdxm/getMxPage?guid=${guid}",[2,'asc'],columns,0,1,setGroup);
