...
<form id="myform" class="form-horizontal" action="" method="post" >
	...
	<input type="hidden" name="czrq" value="${xmfl.czrq}">
	<input type="hidden" name="guid" value="${xmfl.GUID}">
		...
		<div class="box-panel">		
			...
			<div class="container-fluid box-content">
				<div class="row">
					<div class="col-md-4">
						<div class="input-group">
							...
							<input type="text" id="txt_flbh" class="form-control input-radius" name="flbh"  value="${xmfl.FLBH}"/>
					...
					<div class="col-md-4">
						<div class="input-group">
						   <span class="input-group-addon"><span class="required">*</span>分类名称</span>
							<input type="text" id="txt_flmc" class="form-control input-radius" name="flmc" value="${xmfl.FLMC}"/>
						</div>
					</div>
					<div class="col-md-4">
						<div class="input-group">
							<span class="input-group-addon"><c:if test="${dwb.sjfl!='000000'}"></c:if>上级分类</span>
							
								<input type="text" name='sjfl' id="txt_sjfl"  class="form-control input-radius window" value="${xmfl.SJFL}">
				...
				<div id="editor" style="height: 100px;">
					 ...
					 <textarea style="width:100%;height:100px;" id="txt_bz" class="form-control" name="bz" >${xmfl.BZ}</textarea>
				</div>
			    </div>
				  </div>
...
$(function(){
	...
	var operate_src = ADDRESS+"/xmflsz/insert";
	var validate = $('#myform').bootstrapValidator({fields:{
        	    flbh:{validators:{notEmpty:{message:'不能为空'}}},
...
// 	});	
	...
	$("#btn_save").click(function(){
		...
		if("U"==operate){
			operate_src = ADDRESS+"/xmflsz/update";
		}
