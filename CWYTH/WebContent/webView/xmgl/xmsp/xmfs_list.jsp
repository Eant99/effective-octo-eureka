		...
		<form id="myform" class="form-inline" action="" style="padding-top: 8px;padding-bottom: 2px;">
			<div class="search-simple">
				...
				<div class="btn-group pull-right" role="group">
	               <button type="button" class="btn btn-default" id="btn_exportExcel" data-file-name="项目复审" data-param="splx=${param.splx }">导出Excel</button>
				</div>
			</div>
		</form>
	</div>
...
$(document).on("click","#btn_exportExcel",function(){
	doExportExcel(getBasePath()+"/doExportExcel?splx=${param.splx}",function(result){
		FileDownload(getContextPath()+"/file/fileDownload","项目复审.xls",result.url);
	});
})
</script>
</body>
