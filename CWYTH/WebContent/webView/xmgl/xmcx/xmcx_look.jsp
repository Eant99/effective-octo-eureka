				...
				<div class="row">
					<div class="col-md-4">
						<div class="input-group">
							...
							<input type="text" id="txt_bmbh" value="${xmxx.BMBH }" name="bmbh" class="form-control input-radius" style="border-bottom-right-radius: 4px;border-top-right-radius: 4px;" placeholder="请输入部门名称" disabled/>
					...
					<div class="col-md-4">
						<div class="input-group">
							...
							<input type="text" id="txt_xmbh" name="xmbh" readonly  value="${xmxx.XMBH }" class="form-control input-radius" style="border-bottom-right-radius: 4px;border-top-right-radius: 4px;" placeholder="请输入项目编号" disabled/>
						</div>
                    </div>
					<div class="col-md-4">
						<div class="input-group">
							<span class="input-group-addon"><span class="required">*</span>项目名称</span>
							<input type="text" id="txt_xmmc" name="xmmc" value="${xmxx.XMMC }" class="form-control input-radius" style="border-bottom-right-radius: 4px;border-top-right-radius: 4px;" placeholder="请输入项目名称" readonly/>
						</div>
                    </div>
				</div>
				<div class="row">
					<div class="col-md-4">
                    	<div class="input-group">
                            ...
                            <input type="text" id="txt_xmmc" name="xmmc" value="${xmxx.XMDLMC }" class="form-control input-radius" style="border-bottom-right-radius: 4px;border-top-right-radius: 4px;" placeholder="请输入项目名称" readonly/>
                        </div>
					</div>
					<div class="col-md-4">
                    	<div class="input-group">
							<span class="input-group-addon"><span class="required">*</span>项目类别</span>
                            <input type="text" id="txt_xmmc" name="xmmc" value="${xmxx.XMLBMC }" class="form-control input-radius" style="border-bottom-right-radius: 4px;border-top-right-radius: 4px;" placeholder="请输入项目名称" readonly/>
                        </div>
					</div>
					<div class="col-md-4">
						<div class="input-group">
							<span class="input-group-addon"><span class="required">*</span>项目类型</span>
							<input type="text" id="txt_xmlx" value="${xmxx.XMLX }" name="xmlx" class="form-control input-radius" style="border-bottom-right-radius: 4px;border-top-right-radius: 4px;" placeholder="请选择项目类型" disabled/>
				...
				<div class="row">
					<div class="col-md-4">
						<div class="input-group">
							...
							<input type="text" id="txt_fzr" value="${xmxx.FZRMC }" name="fzr" class="form-control input-radius" style="border-bottom-right-radius: 4px;border-top-right-radius: 4px;" placeholder="请选择负责人" disabled/>
<%-- 							<input type="text" id="txt_fzr" value="${xmxx.FZR }" name="fzr" class="form-control input-radius" style="border-bottom-right-radius: 4px;border-top-right-radius: 4px;" placeholder="请选择负责人" /> --%>
					...
					<div class="col-md-4">
						<div class="input-group">
							...
							<input type="text" id="txt_gkbm" name="gkbm" value="${xmxx.GKBMMC }" class="form-control input-radius" style="border-bottom-right-radius: 4px;border-top-right-radius: 4px;" placeholder="请选择归口部门" disabled/>
                ...
                <div class="row">
                    <div class="col-md-4">
						<div class="input-group ">
							...
							<span class="radio-group">
								<input type="radio" name="sfqy" class="rdo" value="1" disabled<c:if test="${xmxx.SFQY=='1' }"> checked</c:if>/>
								<span style="float: right">是</span>
							</span>
							<span class="radio-group">
								<input type="radio" name="sfqy" class="rdo" value="0" disabled <c:if test="${xmxx.SFQY=='0' }"> checked</c:if> />
					...
					<div class="col-md-4">
						<div class="input-group ">
							...
							<div class="radiodiv">
							<span class="radio-group">
								<input type="radio" name="sfwg" class="rdo" value="1" disabled<c:if test="${xmxx.SFWG=='1' }"> checked</c:if> />
								<span style="float: right">是</span>
							</span>
							<span class="radio-group">
								<input type="radio" name="sfwg" class="rdo" value="0" disabled<c:if test="${xmxx.SFWG=='0' }"> checked</c:if> />
								<span style="float: right">否</span>
							</span>
							</div>
						</div>
				...
				<div class="row">
                    <div class="col-md-4">
						<div class="input-group">
							...
							style="border-bottom-right-radius: 4px;border-top-right-radius: 4px;" value="${xmxx.WGRQ }"  placeholder="请输入结束时间" disabled/>
						</div>							
					</div>							
					<div class="col-md-4">
						<div class="input-group">
							...
							style="border-bottom-right-radius: 4px;text-align:right;border-top-right-radius: 4px;" value="${xmxx.YSJE }"  placeholder="请输入预算金额" readonly/>
						</div>
					</div>							
					<div class="col-md-4">
						<div class="input-group">
							...
							style="border-bottom-right-radius: 4px;text-align:right;border-top-right-radius: 4px;" value="${xmxx.SYJE }"  placeholder="请输入剩余金额" readonly/>
						</div>
                    </div>
				</div>
                 ...
                 <div class="row">
					<div class="col-md-4">
						<div class="input-group">
							...
							<div class="radiodiv">&nbsp; &nbsp;
								<input type="radio" name="xmjfsfyxcb" class="rdo" value="1" disabled<c:if test="${xmxx.xmjfsfyxcb=='1' }"> checked</c:if>/>
								 <label >是</label> &nbsp; &nbsp; &nbsp;
								<input type="radio" name="xmjfsfyxcb" class="rdo" value="0" disabled<c:if test="${xmxx.xmjfsfyxcb=='0' }"> checked</c:if> />
								 <label >否</label>
							</div>
						</div>
                    </div>
                    <div class="col-md-4">
						<div class="input-group">
							...
							<input type="text" id="txt_cbbl" name="cbbl" class="form-control input-radius" readonly value="${xmxx.cbbl }" onKeyUp="this.value=this.value.replace(/[^\d\.]/g,'')"
                    ...
                    <div class="col-md-4">
						<div class="input-group">
							...
							<div class="radiodiv">&nbsp; &nbsp;
								<input type="radio" name="sfjxjjflfykz" class="rdo" value="1" disabled<c:if test="${xmxx.sfjxjjflfykz=='1' }"> checked</c:if>/>
								 <label >是</label> &nbsp; &nbsp; &nbsp;
								<input type="radio" name="sfjxjjflfykz" class="rdo" value="0" disabled<c:if test="${xmxx.sfjxjjflfykz=='0' }"> checked</c:if> />
								 <label >否</label>
							</div>
						</div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-4">
						<div class="input-group">
							...
							style="border-bottom-right-radius: 4px;text-align:right;border-top-right-radius: 4px;" readonly value="${xmxx.zfcgje }" />
                    ...
                    <div class="col-md-4">
						<div class="input-group">
							...
							style="border-bottom-right-radius: 4px;text-align:right;border-top-right-radius: 4px;"  readonly value="${xmxx.fzfcgje }"/>
...
<!-- 							<div class="radiodiv">&nbsp; &nbsp; -->
<%-- 								<input type="radio" name="kjkmyxjz" class="rdo" value="1" disabled<c:if test="${xmxx.kjkmyxjz=='1' }"> checked</c:if> /> --%>
<!-- 								 <label >允许</label> &nbsp; &nbsp; &nbsp; -->
<%-- 								<input type="radio" name="kjkmyxjz" class="rdo" value="0" disabled<c:if test="${xmxx.kjkmyxjz=='0' }"> checked</c:if> /> --%>
<!-- 								 <label >禁止</label> -->
<!-- 							</div> -->
<!-- 						</div> -->
<!--                     </div> -->
...
<!-- 							<div class="radiodiv">&nbsp; &nbsp; -->
<%-- 								<input type="radio" name="jjkmyxjz" class="rdo" value="1" disabled<c:if test="${xmxx.jjkmyxjz=='1' }"> checked</c:if> /> --%>
<!-- 								 <label >允许</label> &nbsp; &nbsp; &nbsp; -->
<%-- 								<input type="radio" name="jjkmyxjz" class="rdo" value="0" disabled<c:if test="${xmxx.jjkmyxjz=='0' }"> checked</c:if> /> --%>
<!-- 								 <label >禁止</label> -->
<!-- 							</div> -->
<!-- 						</div> -->
<!--                     </div> -->
...
<!--                     </div> -->
					<div class="col-md-4">
						<div class="input-group ">
							...
							<div class="radiodiv">
							<span class="radio-group">
								<input type="radio" name="sfczzc" class="rdo" value="1" disabled<c:if test="${xmxx.SFCZZC=='1' }"> checked</c:if>/>
								<span style="float: right">是</span>
							</span>
							<span class="radio-group">
								<input type="radio" name="sfczzc" class="rdo" value="0" disabled<c:if test="${xmxx.SFCZZC=='0' }"> checked</c:if> />
								<span style="float: right">否</span>
							</span>
							</div>
						</div>
                    ...
                    <div class="col-md-4">
						<div class="input-group ">
							...
							<div class="radiodiv">
							<span class="radio-group">
								<input type="radio" name="sfgk" class="rdo" value="1" disabled<c:if test="${xmxx.SFGK=='1' }"> checked</c:if>/>
								<span style="float: right">是</span>
							</span>
							<span class="radio-group">
								<input type="radio" name="sfgk" class="rdo" value="0" disabled<c:if test="${xmxx.SFGK=='0' }"> checked</c:if> />
								<span style="float: right">否</span>
							</span>
							</div>
						</div>
                    ...
                    <div class="col-md-4">
						<div class="input-group">
							...
							<input type="text" id="txt_gkxxm" name="gkxxm" value="${xmxx.GKXXM }" class="form-control input-radius" style="border-bottom-right-radius: 4px;border-top-right-radius: 4px;" placeholder="请输入国库信息码" readonly/>
						</div>
                    </div>
				</div>
			</div>
...
<!-- 					    	</td> -->
					    	...
					    	<td class="td_second_second_2">
					    		<div class="input-group">
						    	    <input type="text" readonly="readonly" style="width:100%;border:none;" class="aa" name="kmbh" id="txt_srkbh" >
						    	    <input type="hidden" name="xmbh" id="txt_xmbh" class="a" value="${guid }">
						    	    <span class="input-group-btn">
	  				    				<button type="button" id="btn_srkm" class="btn btn-link btn-custom">选择</button>
	 				    			</span> 
					    	...
					    	<td class="td_second_three_3">
					    		<input type="text" readonly="readonly" style="width:100%;border:none;" name="kmmc" id="txt_srkm" />
					    	</td>
				   		</tr>
				   		<tr></tr>
				   		<tr id="pbtr_2" class="pdtr_2 pd_tr2">
...
<!-- 					    		<div class="addBtn1 add1"></div> -->
<!-- 					    	</td> -->
							<td class="td_three_first_2" style="text-align:center;" valign="middle">
					    		项目支出
					    	</td>
					    	<td class="td_three_second_3">
					    		<div class="input-group">
						    	    <input type="text" readonly="readonly" style="width:100%;border:none;" class="aa" name="kmbh2" id="txt_srkbh2" >
						    	    <input type="hidden" name="xmbh" id="txt_xmbh" class="a" value="${guid }">
						    	    <span class="input-group-btn">
	  				    				<button type="button" id="btn_srkm2" class="btn btn-link btn-custom">选择</button>
	 				    			</span> 
					    	...
					    	<td class="td_three_three_3">
					    		<input type="text" readonly="readonly" style="width:100%;border:none;" name="kmmc2" id="txt_srkm2" />
					    	</td>
				   		</tr>
        				...
        				<tr >
        			 	...
        			 	<tr id="zctr_1" class="zctr_11">
					    	...
					    	<td class="td_second_1">
					    	    ...
					    	    <input type="text" style="width:100%;border:none;" class="bb" name="kmbh" id="txt_zckbh" value="${zcma.ZCKMBH }" readonly>
...
<!--  				    			</span> -->
					    	...
					    	<td class="td_three_1">
					    		<input type="text" style="width:100%;border:none;" name="kmmc" id="txt_zckm" value="${zcma.KMMC }" readonly/>
					    	</td>
				   		</tr>
				   		</c:forEach>
				   			</c:when>
        			 	...
        			 	<tr id="zctr_1" class="zctr_11 zc_1">
					    	...
					    	<td class="td_second_1">
					    	    ...
					    	    <input type="text" style="width:100%;border:none;" class="bb" name="kmbh" id="txt_zckbh" value="" readonly>
...
<!--  				    			</div> -->
					    	...
					    	<td class="td_three_1">
					    		<input type="text" style="width:100%;border:none;" name="kmmc" id="txt_zckm" value="" readonly/>
					    	</td>
				   		</tr>
...
<%-- 					    	    <input type="text" style="width:100%;border:none;" class="cc" name="kmbh" id="txt_jjflkbh" value="${ jjflmap.JJFL}" readonly> --%>
...
<!-- 					    	<td class="td_three_1"> -->
<%-- 					    		<input type="text" style="width:100%;border:none;" name="kmmc" id="txt_jjflkm" value="${jjflmap.KMMC }" readonly/> --%>
<!-- 					    	</td> -->
<!-- 				   		</tr> -->
<%-- 				   		</c:forEach> --%>
<%-- 				   			</c:when> --%>
