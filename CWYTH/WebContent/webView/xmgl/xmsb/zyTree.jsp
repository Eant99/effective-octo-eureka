...
//配置iframeUlr
var _pageUrl="${pageContext.request.contextPath}/webView/xmgl/xmsb/zyxxList.jsp?pname=${param.pname}&controlId=${param.controlId}&windowModel=${param.windowModel}";
//权限标志
var _type="self";
Ext.onReady(function(){
    ...
    var str = "<div class='ext-tree-search input-group'><input class='form-control' type='text' id='txt_treesearch' placeholder='输入单位编号或名称' /><span class='input-group-btn'><button type='button' title='点击搜索信息' id='btn_search' class='btn'><i class='faw fa-search' aria-hidden='true'></i></button></span></div>"; 
