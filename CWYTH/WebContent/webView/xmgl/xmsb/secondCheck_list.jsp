		...
		<form id="myform" class="form-inline" action="" style="padding-top: 8px;padding-bottom: 2px;">
			<div class="search-simple">
				...
				<div class="btn-group pull-right" role="group">
	               <button type="button" class="btn btn-default" id="btn_excel">导出Excel</button>
				</div>
			</div>
		</form>
	</div>
...
$(function () {
    ...
    var columns = [
       ...
       {"data": "GUID",'render':function(data, type, full, meta){
	   		return '<a href="javascript:void(0);" class="btn btn-link btn_look">查看</a>|<a href="javascript:void(0);" class="btn btn-link btn_sh">审核</a>';
    ...
    table = getDataTableByListHj("mydatatables","${ctx}/xmsb/xmsb/getPageList",[2,'asc'],columns,0,1,setGroup);
   	...
   	$(".btn_look").click(function(){
   		location.href="${ctx}/webView/xmgl/xmsb/xmsb_view2.jsp";
   	});
	//导出Excel
...
//    	   		return;
//    		}else{
   			location.href="${ctx}/xmfs/operate?operate=S";
//    		}
	});
});
</script>
