			...
			<div class="search-simple">
				...
				<div id="btn_search_more">
					...
					<div class="search-more">
						...
						<div class="form-group">
							<label>工&emsp;&emsp;期</label>
							<div class="input-group">
								<input type="text" id="txt_bxr" class="form-control" name="bxr" table="A" placeholder="请输入工期">
							</div>
						</div>
						<div class="form-group">
							<label>采购目录</label>
							<div class="input-group">
								<input type="text" id="txt_bxr" class="form-control" name="bxr" table="A" placeholder="请输入采购目录">
							</div>
						</div>
						<div class="form-group">
							<label>服务专业</label>
...
$(function () {
    ...
    table = getDataTableByListHj("mydatatables","${ctx}/xmsb/xmsb/getPageList",[2,'asc'],columns,0,1,setGroup);
   	$(".btn_look").click(function(){
   		location.href="${ctx}/webView/xmgl/cxtj/zjfpqktj/zjfpqk_view.jsp";
   	});
	//导出Excel
   	$("#btn_exp").click(function(){
   		window.location.href = "${ctx}/webView/xmgl/cxtj/zjfpqktj/zjfpqktj_list.jsp";
   	});
	//查询
