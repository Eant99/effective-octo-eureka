...
//配置iframeUlr
var _pageUrl="${pageContext.request.contextPath}/webView/xmgl/cxtj/zjfpqktj/zjfpqktj_list.jsp";
//权限标志
var _type="self";
Ext.onReady(function(){
	var root = new Ext.tree.AsyncTreeNode({
        ...
        loader: new Ext.tree.TreeLoader({
        	 url: "${pageContext.request.contextPath}/tree/school",
             listeners: {
    ...
    var str = "<div class='ext-tree-search input-group'><input class='form-control' type='text' id='txt_treesearch' placeholder='输入学校编号或名称' /><span class='input-group-btn'><button type='button' title='点击搜索信息' id='btn_search' class='btn'><i class='faw fa-search' aria-hidden='true'></i></button></span></div>"; 
