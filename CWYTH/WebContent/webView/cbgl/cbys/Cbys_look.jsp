				...
				<div class ="row">
					<div class="col-md-4">
						<div class="input-group">
							<span class="input-group-addon">要素编号</span>
					...
					<div class="col-md-4">
						<div class="input-group">
							<span class="input-group-addon">要素名称</span>
...
$(function(){
	...
	//验证方法
	var validate = $('#myform').bootstrapValidator({fields:{
          kmbh:{validators: {notEmpty: {message: '要素编号不能为空'},stringLength:{message:'编号过长',max:'20'}}},
          kmmc:{validators: {notEmpty: {message: '要素名称不能为空'}}},
          }
	      });
