        ...
        <div class="pull-left">
            <span class="page-title text-primary">
            	...
            	<c:choose>
            		...
            		<c:otherwise>成本对象信息</c:otherwise>
            	</c:choose>
			</span>
		</div>
	...
	<div class="box" style="top:36px">
		<div class="box-panel">		
			<div class="box-header clearfix">
            	<div class="sub-title pull-left text-primary"><i class="fa icon-xiangxi"></i>成本对象信息</div>
            	<div class="actions">
				...
				<div class ="row">
					<div class="col-md-4">
						<div class="input-group">
							<span class="input-group-addon"><span class="required">*</span>成本对象编号</span>
					...
					<div class="col-md-4">
						<div class="input-group">
							<span class="input-group-addon"><span class="required">*</span>成本对象名称</span>
							<input type="text" id="kmsz_kmmc" class="form-control input-radius" name="kmmc" value="${kmsz.kmmc}"/>
						</div>
					</div>
					<div class="col-md-4">
						<div class="input-group">
							<span class="input-group-addon">成本对象级次</span>
...
$(function(){
	...
	$("#btn_back").click(function(){
		window.location.href = "${ctx}/cbdx/goPageList";
	});
	/* //联想输入
	...
	$("#btn_save").click(function(){
		doSave(validate,"myform","",function(val){
			if(val.success){
				alert(val.msg);
				//window.location.href = "${ctx}/kmsz/goJjkmPage";
				parent.location.href = "${ctx}/cbdx/goPageList";
			}
		});
	});
