...
//配置iframeUlr
var _pageUrl="${pageContext.request.contextPath}/syszc/goSysPage?mkbh=${param.mkbh}&sql=${param.sql}";
//权限标志
var _type="self";
Ext.onReady(function(){
	var root = new Ext.tree.AsyncTreeNode({
     ...
     var right=new Ext.Panel({
         ...
         title:"", 
         autoScroll:false, 
         html: "<iframe frameborder=\"0\" width=\"100%\" height=\"100%\" scrolling=\"auto\" src=\""+_pageUrl+"&sql=${param.sql}\" id=\"iframe_list_${param.mkbh}\" name=\"iframe_list_${param.mkbh}\"></iframe>",
         border: true
     });
	/*创建窗体分割器*/
    new Ext.Viewport({
