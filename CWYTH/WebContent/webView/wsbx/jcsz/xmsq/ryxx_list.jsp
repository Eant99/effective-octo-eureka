...
<div class="fullscreen">
	<div class="search" id="searchBox" style="padding-top: 0px">
		<form id="myform" class="form-inline" action="" style="padding-top: 8px;padding-bottom: 2px;">
			<div class="row search-simple">
				<div class="col-xs-4 col-offset-4 form-group">
					<label>工号</label>
					<input type="text" id="txt_xh" class="form-control" name="rybh" placeholder="请输入工号">
				</div>
				<div class="col-xs-4 col-offset-4 form-group">
					<label>姓名</label>
					<input type="text" id="txt_xm" class="form-control" name="xm" placeholder="请输入姓名">
				</div>
...
$(function () {
    ...
    var columns = [
       ...
       {"data": "RYBH",defaultContent:"","class":"gh"},
       {"data": "XM",defaultContent:"","class":"xm"},
       {"data": "SSDW",defaultContent:"","class":"szbm"}
     ];
    table = getDataTableByListHj("mydatatables","${ctx}/xmsq/getRyPageList?xmbh=${param.xmbh}&treesearch=${param.treesearch}&dwbh=${param.dwbh}&flag=${param.flag}&bmbh=${bmbh}",[2,'asc'],columns,0,1,setGroup);
	//确定按钮
