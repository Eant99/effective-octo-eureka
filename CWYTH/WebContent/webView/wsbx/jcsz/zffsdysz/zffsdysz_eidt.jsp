...
<form id="myform" class="form-horizontal" action="" method="post">
	...
	<input type="hidden" name="guid" id="guid" value="${zffsdz.GUID}">
				...
				<div class="row">
					<div class="col-md-4">
						<div class="input-group">
                            ...
                            <select id="drp_zffs" class="form-control select2" name="zffs" >	
							   	...
							   	<option value="${zffs.DM }" <c:if test="${zffsdz.ZFFS==zffs.DM }">selected</c:if>>${zffs.MC }</option>
								</c:forEach>	
						   	</select>           		 	
						</div>
					</div>
					<div class="col-md-4">
						<div class="input-group">
				            ...
				            <input type="text" id="txt_kmbh" class="form-control input-radius window" name="kmbh" value="${zffsdz.KMBH }" readonly>
				    ...
				    <div class="col-md-4">
						<div class="input-group">
                            ...
                            <input type="text" id="txt_kmmc" class="form-control input-radius" name="kmmc" value="${zffsdz.KMMC }" readonly />
						</div>
					</div>				
				</div>
				...
				<div class="row">
					<div class="col-md-4">
						<div class="input-group">
                        	...
                        	<div class="radiodiv">&nbsp;&nbsp;&nbsp;
                        		<input type="radio" name="jdfx" value="1" <c:if test="${zffsdz.JDFX=='1' }"> checked</c:if>> 贷方&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<input type="radio" name="jdfx" value="0" <c:if test="${zffsdz.JDFX=='0' }"> checked</c:if>> 借方
                        	</div>
						</div>
					</div>
				</div>
                ...
                <div class="row">
                	<div class="col-sm-12">
						<div class="input-group">
                        	...
                        	<textarea id="txt_bz" class="form-control" name="bz" >${zffsdz.BZ }</textarea>
						</div>
					</div>
                </div>
			</div>
...
$(function(){
	...
	$("#btn_save").click(function(e){
		...
		doSave(validate,"myform","${ctx}/zffsdysz/doupdate",function(val){
			if(val.success){
				alert(val.msg);
