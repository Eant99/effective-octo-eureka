...
//配置iframeUlr
var _pageUrl="${ctx}/webView/wsbx/jcsz/fykmdysz/sjfl_list.jsp?mkbh=${param.mkbh}&pname=${param.pname}&controlId=${param.controlId}&text_id=${param.text_id}";
//权限标志
var _type="self";
