					...
					<div class="row">
						<div class="col-md-4">
							<div class="input-group">
								...
								<select id="drp_fyfl" class="form-control select2" name="fyfl"
									table="K">
...
<%-- 										<c:if test="${fykmdysz.fyfl ==3}">selected</c:if>>预支付</option> --%>
						...
						<div class="col-md-4">
							<div class="input-group">
								...
								<div class="radiodiv">&nbsp;&nbsp;&nbsp;
									<input type="radio" name="jdfx" value="0" checked
										<c:if test="${operateType == 'C' }">checked</c:if>>
									贷方&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="radio" name="jdfx" value="1"
					...
					<div class="row">
						<div class="col-md-4">
							<div class="input-group">
								<span class="input-group-addon">科目编号</span> <input type="text"
									id="txt_kmbh" class="form-control input-radius window"
									name="kmbh" value="${fykmdysz.kmbh}" readonly> <span
									class="input-group-btn"><button type="button"
										id="btn_kmbh" class="btn btn-link btn-custom">选择</button></span>
							</div>
						</div>
						<div class="col-md-4">
							<div class="input-group">
						...
						<div class="col-md-4">
							<div class="input-group">
								...
								<input type="text" id="txt_sjfyfl" readonly
									class="form-control input-radius window" name="sjfyfl"
									value="${fykmdysz.sjfyfl}"> <input type="hidden"
									name='sjfl' id="txt_sjfl" readonly value="${fykmdysz.sjfl}">
								<span class="input-group-btn"><button type="button"
										id="btn_sjfl" class="btn btn-link btn-custom">选择</button></span>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="input-group">
								...
								<textarea id="txt_bz" class="form-control" name="bz">${fykmdysz.bz}</textarea>
							</div>
						</div>
					</div>
				</div>
