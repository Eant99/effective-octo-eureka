		...
		<div class="box-panel">		
			...
			<div class="container-fluid box-content">
				<div class="row">
					...
					<div class="col-md-4">
						<div class="input-group">
							<span class="input-group-addon">(项目编号)项目名称</span>
							<input type="text" id="txt_xmbh" class="form-control input-radius window" name="xmbh" value="(001)项目1"/>
							<span class="input-group-btn"><button type="button" id="btn_xmbh" class="btn btn-link btn-custom">选择</button></span>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-md-4">
						<div class="input-group">
							...
							<input type="text" id="txt_pjzzs" class="form-control input-radius sz" name="pjzzs" value="1"
					...
					<div class="col-md-4">
						<div class="input-group">
							...
							<input type="text" id="txt_hkje" class="form-control input-radius number sz" name="hkje" value="0.00"
							onkeyup="value=value.replace(/[^0-9.(\d{2})?$]/g,'');"/>
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-md-4">
						<div class="input-group">
							...
							<input type="text" id="txt_skr" class="form-control input-radius" name="skr" value="张丽丽"/>
						</div>
					</div>				
					...
					<div class="col-md-4">
						<div class="input-group">
							...
							<input type="text" id="txt_yhzh" class="form-control input-radius" name="yhzh" value="622210324285425"/>
						</div>
					</div>
					<div class="col-md-4">
						<div class="input-group">
							<span class="input-group-addon">收款类型</span>
							<input type="radio" id="txt_sklx" name="sklx" checked>个人
							<input type="radio" id="txt_sklx" name="sklx">单位
						</div>
					</div>	
				</div>
				<div class="row">
					...
					<div class="col-md-4">
						<div class="input-group">
							...
							<input type="text" id="txt_skdwmc" class="form-control input-radius" name="skdwmc" value="山东国子软件"/>
						</div>
					</div>
					<div class="col-md-4">
						<div class="input-group">
				...
				<div class="row">
					<div class="col-md-4">
						<div class="input-group">
							<span class="input-group-addon">附&emsp;&emsp;言</span>
							<textarea style="width:1560px;" class="form-control input-radius" name="fy">暂无</textarea>
						</div>
					</div>
				</div>				
			</div>
				...
				<table id="mydatatables" class="table table-striped table-bordered">
				    ...
				    <tbody id="tbody">
				    	<tr id="tr_1">
				    		...
				    		<td>
				    		<div class="input-group">
				    			<input type="text" id="txt_fymc1" class="form-control input-radius window" name="fymc1" value="(00022)出差补贴">
				    			<span class="input-group-btn">
				    			<button type="button" id="btn_fymc1" sj="txt_fymc1" class="btn btn-link btn-custom">选择</button>
				    			</span>
				    		</div>
				    		</td>
				    		<td>
				    			<input type="text" id="txt_je1" class="form-control input-radius sz number" name="je1" value="200"
				    			onkeyup="value=value.replace(/[^0-9.(\d{2})?$]/g,'');">
				    		</td>
				    		<td>
				    			<input type="text" id="txt_pjzs1" class="form-control input-radius sz" name="pjzs1" value="5"
				    			onkeyup="value=value.replace(/[^0-9.(\d{2})?$]/g,'');">
				    		</td>
				    		<td>
				    			<input type="text" id="txt_bz" class="form-control input-radius" name="bz" value="无">
				    		</td>
				    	</tr>
				    </tbody>
				</table>
...
$(function(){
	...
	$("#btn_bmmc").click(function(){
		select_commonWin("${ctx}/window/dwpage?controlId=txt_sjdw","部门信息","920","630");
    });
	$("#btn_xmbh").click(function(){
		select_commonWin("${ctx}/wsbx/rcbx/window?type=xm&controlId=txt_xmbh","部门信息","920","630");
    });
});
//明细js操作
$(function(){
	...
	$(document).on("click","[class=addBtn]",function(){
		...
		$parentTr.find("[id^=btn_fymc]").attr({"id":"btn_fymc"+num,"sj":"txt_fymc"+num});
		$parentTr.find("[id^=btn_fymc]").attr({"id":"btn_fymc"+num,"sj":"txt_fymc"+num});
