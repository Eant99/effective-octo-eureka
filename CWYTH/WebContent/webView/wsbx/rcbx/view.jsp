...
<!-- 				            <th style="width:300px;"><span class="required" style="color:red"></span>政府采购剩余金额（元）</th> -->
<!-- 				            <th style="width:300px;"><span class="required" style="color:red"></span>非政府采购剩余金额（元）</th> -->
				           ...
				           <!--  <th style="width:200px;"><span class="required" style="color:red"></span>政府采购金额（元）</th>
				            <th style="width:200px;"><span class="required" style="color:red"></span>非政府采购金额（元）</th> -->
...
<!-- 								<td> -->
<%-- 								<input type="text" id="dxt_zfcgsyje${i.index+1}" class=" null window input-radius number" readonly="readonly" name="zfcgsyje" value="<fmt:formatNumber type="number" value="${list.zfcgsyje}" pattern="0.00" maxFractionDigits="2"/>"> --%>
<!-- 								</td> -->
<!-- 								<td> -->
<%-- 								<input type="text" id="dxt_fzfcgsyje${i.index+1}" class=" null window input-radius number" readonly="readonly" name="fzfcgsyje" value="<fmt:formatNumber type="number" value="${list.zfcgsyje}" pattern="0.00" maxFractionDigits="2"/>" --%>
<!-- 									onkeyup="value=value.replace(/[^0-9.(\d{2})?$]/g,'');"> -->
<!-- 								</td> -->
<!-- 								<td> -->
...
<!-- 								</td> -->
								...
								<td>
								<input type="text" id="txt_pjzs${i.index+1}" a="a" readonly class=" input-radius sz null int" name="fjzs" value="${list.fjzs}"
										  onkeyup="value=value.replace(/[^0-9.(\d{2})?$]/g,'');">
								</td>
								<td>
								<input type="hidden"  name="zbid" value="${zbid}">
								<input type="text" id="txt_bz${i.index+1}" a="a" readonly class=" null window input-radius" name="bz" value="${list.bz}">
								</td>
							</tr>
				    		</c:if>
				    	</c:forEach>
...
$("#btn_tg").click(function(){
	...
	select_commonWin("${ctx}/wsbx/rcbx/check?type=first&guid="+guid+"&procinstid="+procinstid,"通过页面","500","200");
	//location.href = "${ctx}/wsbx/rcbx/check?type=first&guid="+guid+"&procinstid="+procinstid;
});
$("#btn_th").click(function(){
	var guid = "${guid}";
	var procinstid = "${procinstid}";
	select_commonWin("${ctx}/wsbx/rcbx/check?type=second&guid="+guid+"&procinstid="+procinstid,"退回页面","500","200");
