       ...
       <div class="pull-left">
		...
		<div class="pull-right" style="margin-top:3px;">
				<div class="sub-title pull-left text-green">
					...
					<div class="sub-title pull-left  text-green">费用修改&nbsp;</div>
			...
			<div class="box-header clearfix">
            	...
            	<div class="pull-right">
            		<button type="button" class="btn btn-link" id="btn_ywsm" title="点击可查看业务说明">
			  		...
			  		<button type="button" class="btn btn-default" id="btn_th"><i class="fa icon-save"></i>退回</button>
				...
				<table id="mydatatables" class="table table-striped table-bordered">
				    ...
				    <tbody id="tb_cxjk">
				    	<c:forEach items="${cjkList}" var="cjkList" varStatus="cjk">
							...
							<input type="text" id="txt_jkdh${cjk.index+1}" name="djbh" class=" input-radius bk" readonly value="${cjkList.djbh}">
							</td>
							<td>
							<input type="text" id="txt_jkrxm${cjk.index+1}" class=" input-radius bk" readonly value="${cjkList.jkrxm}">
							<input type="hidden" id="txt_jkr${cjk.index+1}" name="jkr" class=" input-radius" readonly value="${cjkList.jkr}">
							</td>
							<td>
							<input type="text" id="txt_szdw${cjk.index+1}" class=" input-radius" readonly value="${cjkList.dwmc}">
							<input type="hidden" id="txt_szbm${cjk.index+1}" name="szbm" class=" input-radius bk" readonly value="${cjkList.szbm}">
							</td>
							<td>
							<input type="text" id="txt_jkje${cjk.index+1}" name="jkje" class=" input-radius number bk" readonly value="<fmt:formatNumber value="${cjkList.jkje}"  pattern=".00"/>">
							</td>
							<td>
							<input type="text" id="txt_cjkje${cjk.index+1}" name="cjkje" class=" input-radius number bk"  value="${cjkList.cjkje}">
							</td>
						...
						<tr class="tr_0">
						 <input type="hidden" name="start" value=""/>
							...
							<td>
							<input type="hidden" name="jkdh" value="${zbid}" />
							<input type="text" id="txt_jkdh0" name="djbh" class=" input-radius bk" readonly value="">
							</td>
							<td>
							<input type="text" id="txt_jkrxm0" class=" input-radius bk" readonly value="">
							<input type="hidden" id="txt_jkr0" name="jkr" class=" input-radius bk" readonly value="">
							</td>
							<td>
							<input type="text" id="txt_szdw0" class=" input-radius bk" readonly value="">
							<input type="hidden" id="txt_szbm0" name="szbm" class=" input-radius" readonly value="">
							</td>
							<td>
							<input type="text" id="txt_jkje0" name="jkje" class=" input-radius number bk" readonly value="<fmt:formatNumber value=""  pattern=".00"/>">
							</td>
							<td>
							<input type="text" id="txt_cjkje0" name="cjkje" class=" input-radius number bk"  value="">
							</td>
							 <input type="hidden" name="end" value=""/>
						</tr>
				    </tbody>
...
<!-- 				    			</span> -->
								<input type="" id="txt_ryxm${ds.index+1}" name="ryxm" class="bk input-radius" style="height:27px;" value="${dsList.ryxm}">
...
<%-- 										<option value="${item.khyh}" zh="${item.khyhzh}" zhbguid="${item.guid }" <c:if test="${item.khyhzh == dsList.dfzh }">selected</c:if>>${dsList.klx}</option> --%>
							...
							<td>
							<input type="text" id="txt_dsje${ds.index+1}" name="je" class="bk input-radius number  je" value="${dsList.je}" 
...
<%-- 								<input type="" id="txt_ryxm0" name="ryxm" class="bk input-radius " style="height:27px;" value="${loginInfo}"> --%>
								<input type="" id="txt_ryxm0" name="ryxm" class="bk input-radius " style="height:27px;" value="">
				    			<span class="input-group-btn">
				    			<input type="hidden" name="zfdh" value="${zbid}" />
...
<!-- 							<input type="text" id="txt_klx0" name="klx" class="bk input-radius"  value=""> -->
							...
							<td>
							<input type="text" id="txt_dsje0" name="je" class="bk input-radius number  je"  value="" onkeyup="value=value.replace(/[^0-9.(\d{2})?$]/g,'');">
								<input type="hidden" name="end" />
							</td>
						</tr>
				...
				<table id="mydatatables" class="table table-striped table-bordered">
				    ...
				    <tbody id="tb_xnzz">
				    	<c:forEach items="${dgList}" var="dgList" varStatus="dg">
							...
							<div class="input-group">
								<input type="hidden" name="zfdh" value="${zbid}" />
								<input type="text" id="txt_dwmc${dg.index+1}" class="bk input-radius" name="dfdw1"  value="${dgList.dwmc}">
							...
							<td>
							<input type="text" id="txt_dfdz${dg.index+1}" style="background-color: white !important;" name="dfdz" class="bk input-radius" readonly value="${dgList.dfdq}">
							</td>
							<td>
							...
							<td>
							<input type="text" id="txt_je${dg.index+1}" name="je" class="bk input-radius"  style="text-align:right" value="${dgList.je}">
							</td>
							<input type="hidden" name="end" value=""/>
						</tr>
				    	</c:forEach>
						...
						<input type="hidden" name="start" value=""/>
							...
							<div class="input-group">
								<input type="hidden" name="zfdh" value="${zbid}" />
								<input type="text" id="txt_dwmc0" class="bk input-radius" name="dfdw1"  value="">
							...
							<td>
							<input type="text" id="txt_dfzh0" style="background-color: white !important;" name="dfzh" readonly class="bk input-radius"  value="">
							</td>
							<td>
							<input type="text" id="txt_je0" name="je" class="bk input-radius number"  value="">
							</td>
							<input type="hidden" name="end" value="" />
						</tr>
...
<!--             		<span>未选择</span> -->
            	...
            	&nbsp;&nbsp;
            	<span class="tyspan gwk_xj"><strong>小计（元）:</strong><input type="" class="tsinput" readonly value="0.00" /></span>
            	</div>
            	<div class="actions">
				    ...
				    <tbody id="tb_gwk" >
				    	<c:forEach items="${gwkList}" var="gwkList" varStatus="gwk">
							...
							<div class="input-group">
				    			...
				    			<input type="text" id="ttxt_ryxm${gwk.index+1}" name="ryxm" class="bk input-radius" value="${gwkList.ryxm}">
				    			<span class="input-group-btn">
							...
							<td >
							<input type="text" id="txt_skrq${gwk.index+1}" name="skrq" class="bk input-radius date" value="${gwkList.skrq}">
							</td >
							
							<td >
							<input type="text" id="txt_kh${gwk.index+1}" name="kh" class="bk input-radius"  value="${gwkList.kh}">
							</td>
							<td >
							<input type="text" id="txt_skje${gwk.index+1}" name="skje" class="bk input-radius number"  value="${gwkList.skje}"
								onkeyup="value=value.replace(/[^0-9.(\d{2})?$]/g,'');">
							</td>
							<td >
							<input type="text" id="txt_sjskje${gwk.index+1}" name="sjskje" class="bk input-radius number"  value="${gwkList.sjskje}"
								onkeyup="value=value.replace(/[^0-9.(\d{2})?$]/g,'');">
							</td>
							 <input type="hidden" name="end" value=""/>
						</tr>
						...
						<tr class="tr_0 gd">
						 <input type="hidden" name="start" value=""/>
							...
							<td >
							<div class="input-group">
				    			<input type="text" id="ttxt_ryxm0" name="ryxm" class="bk input-radius" value="">
				    			<span class="input-group-btn">
							...
							<td >
							<input type="hidden" name="skdh" value="${zbid}" />
							<input type="text" id="txt_skrq0" name="skrq" class="bk input-radius date" value="">
							</td>
							
							<td >
							<input type="text" id="txt_kh0" name="kh" class="bk input-radius"  value="">
							</td>
							<td >
							<input type="text" id="txt_skje0" name="skje" class="bk input-radius number"  value=""
								onkeyup="value=value.replace(/[^0-9.(\d{2})?$]/g,'');">
							</td>
							<td >
							<input type="text" id="txt_sjskje0" name="sjskje" class="bk input-radius number"  value=""
								onkeyup="value=value.replace(/[^0-9.(\d{2})?$]/g,'');">
							</td>
							<input type="hidden" name="end" />
						</tr>
...
<!--             		<span>未选择</span> -->
		...
		<div class="row">
			<div class="pull-center" style="text-align:center;">
	    		...
	    		<button type="button" class="btn btn-default" id="btn_second" style="background:#00acec;color: white;">保存并通过</button>
	 		</div>
		</div>
	</div>
		</div>
...
// 	parentTr.find("[id^=txt_ryxm]").attr({"id":"txt_ryxm"+sszk,"value":"${loginInfo}"});
	...
	$("[id=txt_dsje0]").val(Number(syje).toFixed(2));
...
// 	select_commonWin("${ctx}/wsbx/rcbx/window?controlId=xnzz&id="+ids,"往来单位","920","630");
// });
$(document).on("click","[id^=btn_dfdw]",function(){
...
$(document).on("click","[class*=addBtn_XN]",function(){
	...
	$.each(schqdgmoney,function(){//对公
		if($(this).val()!=""||!isNaN($(this).val)){
			schqdgcount = Number(schqdgcount)+Number($(this).val());
			console.log("schqdgcount=="+schqdgcount);
		}
	});
	$.each(schqgwkmoney,function(){//公务卡
		if($(this).val()!=""||!isNaN($(this).val)){
...
$(".gwkbox").click(function(){
	...
	if(clw=="noselect"){
		...
		var schqgwkcount = 0;
		$.each(schqmoney,function(){//对私
			if($("[id^=txt_dsje]").val()!=""||!isNaN($("[id^=txt_dsje]").val)){
				schqcount = Number(schqcount)+Number($("[id^=txt_dsje]").val());
			}
		});
		$.each(schqdgmoney,function(){//对公
			if($("[id^=txt_je]").val()!=""||!isNaN($("[id^=txt_je]").val)){
				schqdgcount = Number(schqdgcount)+Number($("[id^=txt_je]").val());
			}
		});
		$.each(schqgwkmoney,function(){//公务卡
			if($("[id^=txt_skje]").val()!=""||!isNaN($("[id^=txt_skje]").val)){
				schqgwkcount = Number(schqgwkcount)+Number($("[id^=txt_skje]").val());
			}
		});
		if($("[mc='addLye']").is(":checked")){
			$.each(schqlyemoney,function(){//零余额
...
// 	parentTr.find(":input").val("");
	parentTr.find("[id^=txt_skrq]").val("");
	parentTr.find("[id^=txt_kh]").val("");
...
<script type="text/javascript">
	function doAddAll(type){
		...
		if(checkBox.length==0&&type=="after"){
			location.href="${ctx}/wsbx/rcbx/ywblByBzy?xmguid=${xmguid}&zbid=${param.zbid}&xmmc=${param.xmmc}&djbh=${param.djbh}&money=${param.money}";
		}
		var cc = $("[name^=ryxz]");
		$.each(cc,function(){
	  		...
	  		$.ajax({
	  			...
	  			complete:function(){
	  				$.ajax({
	  		  			...
	  		  			complete:function(){
	  		  				var xmdl = "${xmdl}";
	  		  				var money = $("#txt_ywzje").val();
	  		  				var flag = false;
	  		  				if(xmdl=="1"&&money<=5000){
	  		  					flag = true;
	  		  				}
	  		  				select_commonWin("${ctx}/wsbx/rcbx/check?type=first&guid=${param.zbid}&procinstid=${param.procinstid}&flag="+flag,"通过页面","500","300");
	  		  			}
	  		  		});
	  			}
	  		});
...
$(document).on("click","[id='btn_tg']",function(){
	var xmdl = "${xmdl}";
	var money = $("#txt_ywzje").val();
	var flag = false;
	if(xmdl=="1"&&money<=5000){
...
$(document).on("click","[id='btn_th']",function(){
	select_commonWin("${ctx}/wsbx/rcbx/check?flag=BZY&type=second&guid=${param.guid}&procinstid=${param.procinstid}","退回页面","500","300");
});
</script>
</html>