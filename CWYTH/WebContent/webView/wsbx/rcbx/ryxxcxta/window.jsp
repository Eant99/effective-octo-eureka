...
//配置iframeUlr  
console.log("aaaaaaaa"+"${zbid}");
var _pageUrl="${pageContext.request.contextPath}/webView/wsbx/rcbx/ryxxcxta/ryxxlist.jsp?pname=${param.pname}&controlId=${param.controlId}&szbmm=${param.szbmm}&ryid=${param.ryid}&flag=${param.flag}&zbid=${zbid}&flags=1";
//权限标志
var _type;
var flag = "${param.flag}";
if(flag=="All"){
...
Ext.onReady(function(){
	var root = new Ext.tree.AsyncTreeNode({
        ...
        loader: new Ext.tree.TreeLoader({
        	//单位权限
        	 url: "${pageContext.request.contextPath}/tree/dwTrees",
             listeners: {
