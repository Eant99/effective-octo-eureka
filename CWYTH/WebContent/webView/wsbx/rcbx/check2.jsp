	...
	<div class="box">
		<div class="box-panel">		
			...
			<div class="row">
				...
				<div class="row" id="row_sqrselect">
					<div class="col-md-4">
						<div class="input-group">
...
$(function(){
	if("${flag}"=="BZY"){
// 		$('#row_sqrselect').addClass('hidden');
		$('#row_sqrselect').find("input[value='1']")[0].checked=true;
	}
	...
	$("#btn_qd").click(function(){
		...
		$.ajax({
			...
			data:"&procinstid="+procinstid+"&pass=false&type=rcbx&guid="+guid+"&shyj="+shyj+"&apply="+apply+"&bxsy="+bxsy+"&fyid="+fyid+"&fcwys="+fcwys+"&xmguid="+xmguid+"&ymbz=${ymbz}",
