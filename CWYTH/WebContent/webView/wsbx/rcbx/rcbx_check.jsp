...
<!-- 				            <th style="width:300px;">政府采购剩余金额（元）</th> -->
<!-- 				            <th style="width:300px;">非政府采购剩余金额（元）</th> -->
				            <th style="width:300px;">费用名称</th>
				            <th style="width:200px;">报销金额（元）</th>
<!-- 				            <th style="width:200px;">政府采购金额（元）</th> -->
<!-- 				            <th style="width:200px;">非政府采购金额（元）</th> -->
...
<!-- 								<td> -->
<%-- 								<input type="text" id="txt_zfcgje${i.index+1}" a="a" class=" input-radius sz number null txt_zfcgje" name="zfcgje" readonly="readonly" value="${list.zfcgje}" --%>
<!-- 									onkeyup="value=value.replace(/[^0-9.(\d{2})?$]/g,'');"> -->
<!-- 								</td> -->
<!-- 								<td> -->
<%-- 								<input type="text" id="txt_fzfcgje${i.index+1}" a="a" class=" input-radius sz number null txt_fzfcgje" name="fzfcgje" readonly="readonly" value="${list.fzfcgje}" --%>
<!-- 									onkeyup="value=value.replace(/[^0-9.(\d{2})?$]/g,'');"> -->
<!-- 								</td> -->
								<td>
...
$("#btn_tg").click(function(){
	...
	select_commonWin("${ctx}/wsbx/rcbx/check?type=first&guid="+guid+"&procinstid="+procinstid+"&flag="+flag,"通过页面","500","300");
	//location.href = "${ctx}/wsbx/rcbx/check?type=first&guid="+guid+"&procinstid="+procinstid;
});
$("#btn_th").click(function(){
	var guid = "${guid}";
	var procinstid = "${procinstid}";
	select_commonWin("${ctx}/wsbx/rcbx/check?type=second&guid="+guid+"&procinstid="+procinstid+"&ymbz=${ymbz}","退回页面","500","300");
