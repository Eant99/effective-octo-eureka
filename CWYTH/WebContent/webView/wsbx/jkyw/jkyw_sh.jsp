...
<form id="myform" class="form-horizontal" action="" method="post" >
	...
	<div class='page-header'>
       	<div class="pull-left">
            <span class="page-title text-primary"><i class='fa icon-xiangxixinxi'></i>审核借款业务信息</span>
		</div>
		...
		<div class="box-panel">		
			...
			<div class="container-fluid box-content">
				...
				<div id="editor" style="height: 100px;">
					<textarea style="width:100%;height:100px;" name="fy" id="fy" data-bv-field="fy"></textarea>
				</div>
			    </div>
				</div>
			</div>
...
$(function(){
	...
	$("#btn_back").click(function(){
		window.location.href = "${ctx}/jkyw/goJkywShPage";
	});
	//通过
