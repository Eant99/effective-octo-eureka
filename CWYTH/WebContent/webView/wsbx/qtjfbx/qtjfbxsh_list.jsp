...
$(function () {
    ...
    table = getDataTableByListHj("mydatatables","${ctx}/json/wsbx/qtjfbx/qtjfbxsh.json",[2,'asc'],columns,0,1,setGroup); 
	//导出Excel
    ...
    //审核按钮
   	$("#btn_SH").click(function(){
   		...
   		if(checkbox.length>0){
   	   	...
   	   	doOperate("${ctx}/webView/wsbx/qtjfbx/qtjfbxsh_edit.jsp", "C");
   		}else{
   			alert("请选择至少一条信息提交!");
   		}
   	});
	...
	$(document).on("click",".btn_delxx",function(){
		/*
		var guid = $(this).parents("tr").find("[name='guid']").val();
		doDel("guid="+guid,"${ctx}/jsxxs/doDelete",function(val){
			table.ajax.reload();
		},function(val){
