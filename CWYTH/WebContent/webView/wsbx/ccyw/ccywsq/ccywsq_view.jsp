...
$(function(){
	...
	$(document).on("click","#btn_pass",function(){
   		select_commonWin(target+"/ccywsh/goVerifyPage?guid="+guid+"&procinstid="+procinstid+"&status=pass","审核通过","500","300");
   	});
	//退回
	$(document).on("click","#btn_refuse",function(){
		select_commonWin(target+"/ccywsh/goVerifyPage?guid="+guid+"&procinstid="+procinstid+"&status=false","审核退回","500","300");
