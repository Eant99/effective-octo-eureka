...
<form id="myform" class="form-horizontal" action="" method="post">
	...
	<div class="page-header">
        ...
        <div class="pull-right">
            ...
            <button type="button" class="btn btn-default plugin" id="btn_pass">通过</button>
			<button type="button" class="btn btn-default plugin" id="btn_refuse" >退回</button>
...
//		 		select_commonWin(target+"/jfszList?cId_1=txt_ktmc&cId_2=txt_jflx&cId_3=txt_syje&cId_4=txt_jfbh","项目信息","900","620");
			select_commonWin(target+"/jfszList?cId_1="+txt_ktmc+"&cId_2="+txt_jflx+"&cId_3="+txt_syje+"&cId_4="+txt_jfbh+"&guid="+guid.join("','"),"项目信息","900","620");
...
$(function(){
   ...
   $("#btn_save").click(function(){
		...
		if(checkbox.length>0){
	   		...
	   		var url = target+"/ccywsqEditBybzr?jtgjm="+jtgj;
...
$(document).on("click","#btn_pass",function(){
		select_commonWin(targett+"/ccywsh/goVerifyPage?guid="+guid+"&procinstid="+procinstid+"&status=pass","审核通过","500","250");
	});
//退回
$(document).on("click","#btn_refuse",function(){
		select_commonWin(targett+"/ccywsh/goVerifyPage?guid="+guid+"&procinstid="+procinstid+"&status=false","审核退回","500","250");
});
</script>
</body>
</html>