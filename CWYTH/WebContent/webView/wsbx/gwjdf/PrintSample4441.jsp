	 ...
	 <div style="text-align: center;"><span>${time}</span></div>
		<TABLE border=1 cellSpacing=0 cellPadding=1 width="90%" style="border-collapse:collapse;margin-left: 5%" bordercolor="#333333">
		  ...
		  <tr style="height: 150px;">
		    <TD style="height:150px;width:20%;text-align: center;"><span><img src="${fjView }" style="width: 90px;height: 50px;"></span><br>${yxMap.SHYJ }<br><fmt:formatDate value="${yxMap.jdsj }"/></TD>
		    <TD colspan="2"  style="height:150px;width:20%;text-align: center;"><span><img src="${fjView2 }" style="width: 90px;height: 50px;"></span><br>${bmMap.SHYJ }<br><fmt:formatDate value="${bmMap.jdsj }"/></TD>
		    <TD style="height:150px;width:20%;text-align: center;"><span><img src="${fjView3 }" style="width: 90px;height: 50px;"></span><br>${kjMap.SHYJ }<br><fmt:formatDate value="${kjMap.jdsj }"/></TD>
