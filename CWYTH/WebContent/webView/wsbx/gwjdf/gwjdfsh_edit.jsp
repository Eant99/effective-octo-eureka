...
<form id="myform" class="form-horizontal" action="" method="post">
	...
	<div class="page-header">
		<div class="pull-left">
            <span class="page-title text-primary"><i class='fa icon-xiangxixinxi'></i>公务接待审核</span>
		</div>
			...
			<div class="row">
                 ...
                 <!--  <div class="col-md-4">
						<div class="input-group">
							...
							<div class="radiodiv">
                            <input type="radio" name="sfjzbx" id="sfjzbx_yes"  value="01"> 是&ensp;&ensp;
...
<!-- 										</td> -->
										...
										<td style="padding: 4px !important" >
											<input type="text" name="hdsj" readonly class="form-control input-radius date" value="${mxList.hdsj}"/>
										</td>
										<td style="padding: 4px !important">
...
var guid =$("#txt_guid").val();
	...
	$("#btn_pass").click(function(){
		select_commonWin("${ctx}/gwjdfsh/pageSkip?pageName=check&guid=${param.guid}&procinstid=${param.procinstid}&status=pass","审核意见","520","300");
    });
	$("#btn_refuse").click(function(){
		select_commonWin("${ctx}/gwjdfsh/pageSkip?pageName=check&guid=${param.guid}&procinstid=${param.procinstid}&status=false","审核意见","520","300");
    });
	
	//返回按钮
	$("#btn_back").click(function(){
		window.location.href = "${ctx}/webView/wsbx/gwjdf/gwjdfsh_list.jsp?shztm="+"${shztm}";
	});
	//刷新按钮
