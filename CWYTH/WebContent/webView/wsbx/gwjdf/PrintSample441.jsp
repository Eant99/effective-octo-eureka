...
<a href="goRcbxListPage?mkbh=110201">返回</a>
<%-- <a href="${ctx}/kylbx/gowdbxListPage">返回</a> --%>

<div id="div2">
	
	<h2 id="div1" style="text-align: center;">${organizationname}报&nbsp;销&nbsp;封&nbsp;面</h2>
		...
		<TABLE border=1 cellSpacing=0 cellPadding=1 width="90%" style="border-collapse:collapse;margin-left: 5%" bordercolor="#333333">
		  <tr>
			...
			<TD style="text-align: center;">${printinfolist.FJZZS}<b>张</b></TD>
		  </tr>
		  <tr >
		  ...
		  <c:forEach var="jjMap" items="${jjMap}">
		  <tr>
		  	<td colspan="1"  id="" style="text-align: center;">${jjMap.FYMC}</td>
		  	<td colspan="1"  id="" class="je" style="text-align: center;">${jjMap.BXJE}</td>
		  </tr>
		  </c:forEach>
		  <tr>
...
// 		});
	function PreviewMytable(){
		...
		LODOP.ADD_PRINT_HTM(10,"RightMargin:3cm","85%",1000,strStyle+document.getElementById("div2").innerHTML);
