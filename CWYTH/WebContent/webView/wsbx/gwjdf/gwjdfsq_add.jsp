		...
		<div class="box-panel">
				...
				<div class="col-md-4">
						<div class="input-group">
							<span class="input-group-addon"><span class="required">*</span>单据编号</span>
                             <input type="text" id="txt_djbh"  class="form-control input-radius " name="djbh" value="系统自动生成" readonly/>                      
						</div>
					</div>
					 <div class="col-md-4">
						<div class="input-group">
							<span class="input-group-addon"><span class="required">*</span>申请人</span>
                             <input type="text" id="txt_sqr" readonly class="form-control input-radius" name="sqr" value="${gwjdfsq.sqr}"/>
			...
			<div class="row">
					...
					<div class="col-md-4">
					  ...
					  <input type="text" id="txt_jdbm" class="form-control input-radius window" readonly name="jdbm"  value="${gwjdfsq.jdbm}"/>
                 ...
                 <div class="col-md-4">
                  ...
                  <!-- <div  class="col-md-4">
						<div class="input-group">
							...
							<div class="radiodiv">&nbsp;&nbsp;&nbsp;
                              <input type="radio" name="sfyzf" id="sfyzf_yes" value="01"> 是&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				    ...
				    <tbody id="tbody">
				    	<tr>
							...
							<td style="padding: 4px !important">
						    	...
						    	<input type="hidden" name="valll" value="1"/>
								<input type="text" name="hdxm"  class="form-control input-radius"/>
							</td>
							<td style="padding: 4px !important" >
								<input type="text" name="hdsj" style="text-align:center;" class="form-control input-radius date"/>
							</td>
							<td style="padding: 4px !important">
							 	<input type="text" name="hddd"  class="form-control input-radius"/>
							</td>
							<td style="padding: 4px !important">
								<input type="text" name="ptry"  class="form-control input-radius"/>
...
// $("[name='jdbm']").bindChange("${ctx}/suggest/getXx","D");
// $("[name='sqr']").bindChange("${ctx}/suggest/getXx","R");
...
$(function(){
	...
	$(document).on("click","[class*=addBtn]",function(){
		...
		$parentTr.find("[name='valll']").attr({"value":num});
		num++;
	});
...
// 		checkAutoInput();
		...
		$.each($("#myform tbody tr"),function(){
			...
			valll = $(this).find("[name='valll']").val();
			//如果全部为空则不做判断
			if(hdxm == ""||hdsj == ""){
				tag = true;
			}
...
// $(document).on("focus","[name='sqr']",function(){
// 	var val = $(this).val();
// 	if(val!=""&&val!=null){
// 		$.ajax({
// 			url:"${ctx}/gwjdfsq/getDwxx",
// 			data:""
// 		});
// 	}
// });
