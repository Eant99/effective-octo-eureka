				...
				<div class="row">
					<div class="col-md-4">
						<div class="input-group">
							...
							<textarea style="width:100%;height: 100px;" name="shyj" class="form-control input-radius">同意</textarea>
						</div>
					</div>
				</div>
				<div class="row">
...
$(function(){
	...
	$("#btn_qd").click(function(){
		...
		$.ajax({
			...
			data:"&procinstid="+procinstid+"&pass=true&type=gwjdfbx&guid="+guid+"&shyj="+shyj,
