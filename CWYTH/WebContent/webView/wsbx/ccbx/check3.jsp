				...
				<div class="row">
					<div class="col-md-4">
						<div class="input-group">
							...
							<textarea style="width:100%;heigth:100%;" class="form-control input-radius" id="shyj">同意</textarea>
						</div>
					</div>
				</div>
...
$(function(){
	...
	$("#btn_qd").click(function(){
		...
		$.ajax({
			...
			data:"&procinstid="+"${procinstid}"+"&pass=true&type=clfbx&guid="+"${guid}"+"&shyj="+$("#shyj").val()+"&other="+other,
...
// 		close(winId);
// 		parent.getIframWindow("${param.pname}").location.href = "${ctx}/webView/wsbx/ccbx/check_list.jsp";
	});
