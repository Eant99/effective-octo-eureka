				...
				<table id="mydatatables" class="table table-striped table-bordered">
				    ...
				    <tbody id="tb_cxjk">
				    	<c:forEach items="${cjkList}" var="cjkList" varStatus="cjk">
							...
							<input type="text" id="txt_jkdh${cjk.index+1}" name="djbh" style="background-color: white !important;" class="bk input-radius" readonly value="${cjkList.djbh}">
							</td>
							<td>
							<input type="text" id="txt_jkrxm${cjk.index+1}" style="background-color: white !important;" class="bk input-radius" readonly value="${cjkList.jkrxm}">
							<input type="hidden" id="txt_jkr${cjk.index+1}" name="jkr" class="form-control input-radius" readonly value="${cjkList.jkr}">
							</td>
							<td>
							<input type="text" id="txt_szdw${cjk.index+1}" style="background-color: white !important;" class="bk input-radius" readonly value="${cjkList.dwmc}">
							<input type="hidden" id="txt_szbm${cjk.index+1}" name="szbm" class="form-control input-radius" readonly value="${cjkList.szbm}">
							</td>
							<td>
							<input type="text" id="txt_jkje${cjk.index+1}" name="jkje" style="background-color: white !important;" class="bk input-radius number je" readonly value="${cjkList.jkje}">
							</td>
							<td>
							<input type="text" id="txt_cjkje${cjk.index+1}" name="cjkje" class="bk input-radius number"  value="${cjkList.cjkje}">
						...
						<input type="hidden" name="start" value=""/>
							...
							<input type="hidden" name="jkdh" value="${zbid}" />
							<input type="text" id="txt_jkdh0" name="djbh" style="background-color: white !important;" class="bk input-radius" readonly value="">
							</td>
							<td>
							<input type="text" id="txt_jkrxm0" style="background-color: white !important;" class="bk input-radius" readonly value="">
							<input type="hidden" id="txt_jkr0" name="jkr" class="form-control input-radius" readonly value="">
							</td>
							<td>
							<input type="text" id="txt_szdw0" style="background-color: white !important;" class="bk input-radius" readonly value="">
							<input type="hidden" id="txt_szbm0" name="szbm" class="form-control input-radius" readonly value="">
							</td>
							<td>
							<input type="text" id="txt_jkje0" style="background-color: white !important;" name="jkje" class="bk input-radius number" readonly value="">
							</td>
							<td>
							<input type="text" id="txt_cjkje0" name="cjkje" class="bk input-radius number  je"  value="">
				...
				<table id="mydatatables" class="table table-striped table-bordered">
				    ...
				    <tbody id="tb_xnzz">
				    	<c:forEach items="${dgList}" var="dgList" varStatus="dg">
							...
							<td>
							<input type="text" id="txt_je${dg.index+1}" name="je" class="bk input-radius number  je"  value="${dgList.je}">
							<input type="hidden" name="end" value="" />
							</td>
						...
						<tr class="tr_0">
							...
							<td>
							<input type="text" id="txt_je0" name="je" class="bk input-radius number  je"  value="">
							<input type="hidden" name="end" value="" />
							</td>
				...
				<table id="mydatatables" class="table table-striped table-bordered">
				    ...
				    <tbody id="tb_gwk">
				    	<c:forEach items="${gwkList}" var="gwkList" varStatus="gwk">
							...
							<td>
							<input type="text" id="txt_skrq${gwk.index+1}" style="background-color: white !important;" name="skrq" class="bk input-radius date"  readonly value="${gwkList.skrq}">
							</td>
							
							<td>
							<input type="text" id="txt_kh${gwk.index+1}" name="kh" class="bk input-radius null"  value="${gwkList.kh}">
							</td>
							<td>
							<input type="text" id="txt_skje${gwk.index+1}" name="skje" class="bk input-radius number  je"  value="${gwkList.skje}"
								onkeyup="value=value.replace(/[^0-9.(\d{2})?$]/g,'');">
							</td>
							<td>
							<input type="text" id="txt_sjskje${gwk.index+1}" name="sjskje" class="bk input-radius number  je"  value="${gwkList.sjskje}"
								onkeyup="value=value.replace(/[^0-9.(\d{2})?$]/g,'');">
							<input type="hidden" name="end" />
							</td>
						</tr>
						...
						<input type="hidden" name="start" value=""/>
							...
							<td>
							<input type="text" id="txt_kh0" name="kh" class="bk input-radius null"  value="">
							<input type="hidden" name="end" />
							</td>
							<td>
							<input type="text" id="txt_skje0" name="skje" class="bk input-radius number je"  value=""
								onkeyup="value=value.replace(/[^0-9.(\d{2})?$]/g,'');">
							</td>
							<td>
							<input type="text" id="txt_sjskje0" name="skje" class="bk input-radius number je"  value=""
								onkeyup="value=value.replace(/[^0-9.(\d{2})?$]/g,'');">
							</td>
						</tr>
				    </tbody>
...
$(document).on("click","[class=addBtn_JK]",function(){
	...
	var jkr = $(this).parents("tr").find("[id^='txt_jkr']").attr("id");
...
$(".cxjkbox").click(function(){
	...
	if(clw=="noselect"){
		...
		$("#txt_cjkje2").val(Number(syje).toFixed(2));
 		cxmoney();
	}else{
...
//  		xmdl='1';
 		...
 		select_commonWin("${ctx}/wsbx/ccbx/check?type=first&ccywguid=${ccywguid}&guid="+"${zbid}"+"&procinstid="+"${procinstid}"+"&flag="+flag,"通过页面","500","300");
 		//location.href="${ctx}/wsbx/ccbx/goCheckListPage";
 	});	
 	//退回
 	$("#btn_th").click(function(e){
 		select_commonWin("${ctx}/wsbx/ccbx/check?type=second&ccywguid=${ccywguid}&guid="+"${zbid}"+"&procinstid="+"${procinstid}","退回页面","500","300");
 		//location.href="${ctx}/wsbx/ccbx/goCheckListPage";
 	});	
	//保存并通过
