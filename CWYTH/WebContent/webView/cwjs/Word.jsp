...
//打开Word文档
poCtrl.webOpen("/CWYTH/webView/cwjs/doc/test.doc",OpenModeType.docNormalEdit,"张佚名");
%>
						...
						<div class="input-group">
							<span class="input-group-addon" >年度:</span>
							 <select class="form-control" id="xznd">
								  ...
								  <option value="2" selected = "selected">2017年</option>
								  <option value="3" >2018年</option>
							</select>
						</div>
   					 </div>
    </div>
    <div style="position:absolute;top:30px;width:100%; height:900px;">
 ...
 <script type="text/javascript" src="../pageoffice.js"  id="po_js_main"></script>
    ...
    $(document).ready(function() {
        $('#xznd').change(function(){
             var nd = $("#xznd").val();
             if(nd=='2'){
            	 location.href="/CWYTH/webView/cwjs/Word.jsp";
             }else if(nd=='3'){
            	 location.href="/CWYTH/webView/cwjs/cwbglist.jsp";
             }else{
