...
$(function(){
	var winId = getTopFrame().layer.getFrameIndex(parent.window.name);
	 table = $('#mydatatables').DataTable({
	        ajax: {
	            url: "${pageContext.request.contextPath}/cyzysz/getkjkmPageList?treedwbh=${dwbh}&kmnd=${kmnd}&dm=${dm}&jb=${jb}"//获取数据的方法
	        },
	        ...
	        "columns": [
	        	{"data": "guid",orderable:false, "render": function (data, type, full, meta){
	       	       	return '<input type="checkbox" name="guid"  class="keyId" kmbh="'+full.KMBH+'" bhmc="' + "("+full.KMBH+")"+full.KMMC + '"  value="' + full.GUID + '">';
