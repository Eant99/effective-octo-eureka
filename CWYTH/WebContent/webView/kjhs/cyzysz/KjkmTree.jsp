...
//配置iframeUlr
var _pageUrl="${pageContext.request.contextPath}/cyzysz/goKjkmPage?pname=${param.pname}&controlId=${param.controlId}&controlId1=${param.controlId1}&szbmm=${param.szbmm}&ryid=${param.ryid}&flag=${param.flag}&type=${param.type}";
//权限标志
var _type="self";
