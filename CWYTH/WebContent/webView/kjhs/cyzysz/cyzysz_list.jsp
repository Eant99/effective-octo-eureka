		...
		<form id="myform" class="form-inline" action="" style="padding-top: 10px;padding-bottom: 2px;">
			<div class="search-simple">
				<div class="form-group">
					<label>科目编号</label>
					<input type="text" id="txt_kmbh" class="form-control" name="kmbh" table="K" placeholder="请输入摘要编号">
				</div>
				<div class="form-group">
					<label>摘要内容</label>
					<input type="text" id="txt_zynr" class="form-control" name="zynr"  table="K" placeholder="请输入摘要内容">
				</div>
...
$(function () {
    ...
    var columns = [
       ...
       {"data": "KMBH",defaultContent:"","class":"text-center","width":150},
       {"data": "ZYNR",defaultContent:"",}, 
       {"data": "SFQY",defaultContent:"","width":150,"class":"text-center"},
	 ...
	 table = getDataTableByListHj("mydatatables","${ctx}/cyzysz/getPageList",[2,'asc'],columns,0,1,setGroup);
  	//添加按钮
  $(document).on("click","#btn_add",function(){
//    	$("#btn_add").click(function(){
   		doOperate("${ctx}/cyzysz/goEditPage","C");
   	});
  	//编辑按钮
	$(document).on("click",".btn_upd",function(){
   		var guid = $(this).parents("tr").find("[name='guid']").val();
   		doOperate("${ctx}/cyzysz/goEditPage?guid="+guid,"U");
   	});
