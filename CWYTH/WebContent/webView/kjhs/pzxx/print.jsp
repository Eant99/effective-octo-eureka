...
/* 		margin-left:18%!important; */
    ...
    .NOPRINT { FONT-SIZE: 12px; FONT-FAMILY: "宋体" }
	/* 表外框加粗 */
	.tabp{ 
		BORDER-COLOR: #000000;
...
<form id="myform" class="form-horizontal" action="" method="post" >
	<object id="LODOP" classid="clsid:2105C259-1E0C-4534-8141-A753534CB4CA" width="0" height="0"> 
           <embed id="LODOP_EM" type="application/x-print-lodop" pluginspage="/assetsDisposal/print/install_lodop-6.exe" width="0" height="0"></embed>
    </object>	
