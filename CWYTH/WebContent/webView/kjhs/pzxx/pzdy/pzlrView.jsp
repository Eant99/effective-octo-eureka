...
<body>
	...
	<div class='page-header'>
        ...
        <div class="pull-right">
			 ...
			 <button type="button" class="btn btn-default" id="btn_print">打印凭证</button>
			 <button type="button" class="btn btn-default" id="btn_print_more">批量打印</button>
...
<!-- 								<label >日期</label> -->
				       		...
				       		<div style="width: 10%;display:inline-block;position:absolute;right:0px;">
								<label>单据</label>
								<input type="text" class="int" style="height: 22px!important;width: 30px;border-radius:4px;border:1px solid #ccc;" id="txt_fjzs" name="fjzs" value="${zbMap.fjzs }"/>&nbsp;张
							</div>
				       	</div>
				       	</form>
				       	<form id="mxForm">
...
<script src="${ctx }/webView/kjhs/pzxx/pzdy/pzlrView.js"></script>
...
$("#btn_qxfh").click(function(){
	...
	$.ajax({
		type : "post",
		url : "${ctx}/kjhs/pzxx/pzdy/Saverqqx",
		data : "guid=" + guid,
		dataType : "json",
...
$("#btn_print_more").click(function(){
	...
	select_commonWin("${ctx}/kjhs/pzxx/pzdy/printwindow?guid=" + guid+"&pzz="+pzz+"&kjqj="+kjqj+"&pznd="+pznd,"批量打印", "600", "550");
});
</script>
</body>
</html>