				    ...
				    <tbody id="tbody">
				    	<tr id="tr_1">
				    		...
				    		<td>
				    			...
				    			<input type="text" id="txt_khyh1" a="a" class=" input-radius <c:if test="${param.kmbh!='230518'}"> null</c:if>" name="khyh1" value="">
				    		</td>
				    		<td>
				    			<input type="text" id="txt_khyhzh1" a="a" class=" input-radius <c:if test="${param.kmbh!='230518'}"> null</c:if>" name="khyhzh1" value="">
				    		</td>
				    		<td>
	   ...
	   checkAutoInput();
		...
		if(valid){
			$.ajax({
				...
				success:function(val){	
					window.location.href = "${ctx}/kjhs/pzxx/pzlr/wldw";
					next();
				},
				error:function(val){
