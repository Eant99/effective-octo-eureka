...
<body>
<form id="myform"  class="form-horizontal" action="${ctx}/kjhs/pzxx/pzlr/uploadMx?pname=${param.pname}&zbid=${param.zbid}&mxid=${param.mxid}" method="post" enctype="multipart/form-data">
...
$(function() {
	...
	$("#btn_exp").click(function(){
		var fname = "银行明细信息.xls";
		var path = "uploadFiles/银行明细信息.xls";
