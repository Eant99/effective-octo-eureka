...
var _pageUrl="${pageContext.request.contextPath}/kjhs/pzxx/pzlr/pageSkip?pageName=dwxx&pname=${param.pname}&controlId=${param.controlId}&windowModel=${param.windowModel}&from="+from;
