...
<body>
	...
	<div class='page-header'>
        ...
        <div class="pull-right">
			 ...
			 <button type="button" class="btn btn-default" id="btn_copyByPz"><i class="fa icon-saves"></i>复制凭证</button>
			 ...
			 <button type="button" class="btn btn-default" id="btn_ckfj"><i class="fa icon-saves"></i>查看单据</button>
        </div>
    </div>
	<div class="box">
						    ...
						    <tbody id="pzlr_mx">
					    		<tr data-line="0" style="display:none;">
					    			<td class="action">
					   		 		...
					   		 		<td class="xh">0</td>
						            <td data-col="1">
						            	<textarea rows="1" cols="" maxlength="100" name="zy" class="zyTextArea"></textarea>
						            </td>
						            <td data-col="2">
		...
		<div class="box-panel pzfz_info" style="display:none;" data-pzfz="0">
			...
			<div class="container-fluid box-content">
				<div class="row">
					...
					<div class="col-md-4">
						<div class="input-group">
							 <span class="input-group-addon">个&ensp;&ensp;人</span>
...
<%-- 							 		<option value="${items2.dm }">${items2.zclx }</option> --%>
<%-- 							 	</c:forEach> --%>
<!-- 							 </select> -->
						</div>
					</div>
