...
//配置iframeUlr
var _pageUrl="${pageContext.request.contextPath}/kjhs/pzxx/pzlr/goJjkmPage?controlId=${param.controlId}&isAll=${param.isAll}&pname=${param.pname}&fyid=${param.fyid}&xmguid=${param.xmguid}";
//权限标志
var _type="self";
var _isAll='${param.isAll}';
