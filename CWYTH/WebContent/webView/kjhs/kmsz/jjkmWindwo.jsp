...
//配置iframeUlr
//JjkmWindow_list
var _pageUrl="${pageContext.request.contextPath}/webView/kjhs/kmsz/JjkmWindow_list.jsp?pname=${param.pname}&controlId=${param.controlId}&controlId1=${param.controlId1}";
//权限标志
var _type="self";
