...
$(function(){
	...
	var columns = [
		{"data": "XMLXBH",orderable:false, "render": function (data, type, full, meta){
	       	return '<input type="checkbox" class="keyId" name="XMLXBH" bz="'+full.BZS+'"value="' + "("+full.JJFL+")"+full.KMMC + '">';
	    },"width":10,'searchable': false},
		{"data":"_XH",orderable:false,'render': function (data, type, full, meta){
	   		return data;
		},"width":41,"searchable": false,"class":"text-center"},
	 /*   	{"data": "XMLXBH",defaultContent:"","class":"text-center"}, */
	   	{"data": "JJFL",defaultContent:"","class":"text-center"},
	   	{"data": "KMMC",defaultContent:"","class":"text-center"},
	   	
	];
	
   	table = getDataTableByListHj("mydatatables","${ctx}/window/multijjflkmList?treeDm=${param.dm}&treesearch=${treesearch}",[2,'asc'],columns,0,1,setGroup);
