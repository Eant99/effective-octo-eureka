...
//配置iframeUlr///CWYTH/WebContent/webView/kjhs/kmsz/grxxList.jsp
var _pageUrl="${ctx}/webView/kjhs/kmsz/grxxList.jsp?pname=${param.pname}&a=${param.a}&controlId=${param.controlId}&controlId1=${param.controlId1}&windowModel=${param.windowModel}&from=";
//权限标志
var _type="self";//
