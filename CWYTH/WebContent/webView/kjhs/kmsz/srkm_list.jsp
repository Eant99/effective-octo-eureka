...
$(function(){
	...
	var columns = [
		{"data": "XMLXBH",orderable:false, "render": function (data, type, full, meta){
	       	return '<input type="checkbox" class="keyId" bh="'+full.SRKMBH+'" name="XMLXBH" bz="'+full.BZS+'"value="' + "("+full.SRKMBH+")"+full.KMMC + '">';
	    },"width":10,'searchable': false},
		{"data":"_XH",orderable:false,'render': function (data, type, full, meta){
	   		return data;
		},"width":41,"searchable": false,"class":"text-center"},
	  /*  	{"data": "XMLXBH",defaultContent:"","class":"text-center"}, */
		{"data": "SRKMBH",defaultContent:"","class":"text-center"},
	   	{"data": "KMMC",defaultContent:"","class":"text-center"},
	   	
	];
	
   	table = getDataTableByListHj("mydatatables","${ctx}/window/multiSrkmList?treeDm=${param.dm}&treesearch=${treesearch}",[2,'asc'],columns,0,1,setGroup);
//    table = getDataTableByListHj("mydatatables","${ctx}/json/kjhs/kmsz/kjkmsz/kjkmsz_list.json",[2,'asc'],columns,0,1,setGroup);
   ...
   $(document).on("dblclick","#mydatatables tr:not(#header)",function(){
	var winId = getTopFrame().layer.getFrameIndex(window.name);
   	...
   	var bh =$(this).find("[name='XMLXBH']").attr("bh");
