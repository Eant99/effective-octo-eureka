...
$(function () {
    ...
    var columns = [
       {"data": "GUID",orderable:false, 'render': function (data, type, full, meta){
         return '<input type="checkbox" name="guid" mc="'+full.XMMC+'" class="keyId" value="' + data + '" guid = "'+full.GUID+'">';
       },"width":10,'searchable': false},
       {"data":"_XH",orderable:false,'render':function(data,type,full,meta){
         	return data;},"width":41,"searchable":false,"class":"text-center"},
      {"data": "BMBH",defaultContent:"","class":"text-center"},
      {"data": "XMBH",defaultContent:"","class":"text-center"},
      {"data": "XMMC",defaultContent:"","class":"text-center"},
      {"data": "XMDLMC",defaultContent:"","class":"text-center"},
      {"data": "XMLBMC",defaultContent:""},
      {"data": "XMLXMC",defaultContent:"","width":120},
      ];
	
	
    table = $('#mydatatables').DataTable({
        ajax: {
            url: "${ctx}/kmsz/getXmxxPageData?bmbh=${bmbh}"//获取数据的方法
        },
