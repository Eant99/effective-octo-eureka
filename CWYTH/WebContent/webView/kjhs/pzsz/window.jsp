...
//配置iframeUlr
var _pageUrl="${pageContext.request.contextPath}/pzmb/kmxxList?pname=${param.pname}&controlId=${param.controlId}";
...
Ext.onReady(function(){
	var root = new Ext.tree.AsyncTreeNode({
        ...
        loader: new Ext.tree.TreeLoader({
        	 url: "${pageContext.request.contextPath}/kmsz/KmszTree",
             listeners: {
