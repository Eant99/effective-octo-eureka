				...
				<div class="row">
					<div class="col-md-4">
						<div class="input-group">
							...
							<input type="text" id="txt_wlbh" name="wlbh" class="form-control input-radius" style="border-bottom-right-radius: 4px;border-top-right-radius: 4px;"  value="系统自动生成" readonly/>
						</div>
                    </div>
                    <div class="col-md-4">
						<div class="input-group">
				...
				<div class="row">
					<div class="col-md-4">
						<div class="input-group">
	                        ...
	                        <select id="drp_dwlx" class="form-control input-radius select2" name="dwlx"> 
				    ...
				    <tbody id="tbody">
				    	<tr id="tr_1">
				    		...
				    		<td>
				    			...
				    			<input type="text" id="txt_khyh1" a="a" class="bk input-radius null" name="khyh1" value="">
				    			
				    		</td>
				    		<td>
				    			<input type="text" id="txt_khyhzh1" a="a" class="bk input-radius null yhh" name="khyhzh1" value="">
				    		</td>
                            <td>
...
//   		if(khyhzhcd==12||khyhzhcd==14||khyhzhcd==16||khyhzhcd==19||khyhzhcd==""||khyhzhcd==22){
		...
		for (var i=0;i<zdid.length;i++) {
			...
			if (aa!="" && code == "CCB") {
				...
				if(lhhVal==""){
					...
					alert("第"+(i+1)+"行开户银行账号非建行卡号,请输入第"+(i+1)+"行正确的人民银行联行号");
					flag = false;
				}
			}
			if (aa!="" && code != "CCB") {
