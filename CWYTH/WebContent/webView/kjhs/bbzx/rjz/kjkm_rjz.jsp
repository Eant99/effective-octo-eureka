...
// 	       	];
// 	table = getDataTableByListHj("mydatatables","${ctx}/zjrbb/getkmxxPageListForRjz",[2,'asc'],columns,0,1,setGroup);
 
    table = $("#mydatatables").DataTable({
        ajax: {
            url: "${ctx}/zjrbb/getkmxxPageListForRjz?kmbh=${param.kmbh}&year=${param.year}"//获取数据的方法
        },
