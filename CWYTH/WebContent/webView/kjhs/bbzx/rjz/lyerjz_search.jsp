			...
			<div class="container-fluid box-content">
				...
				<div class="col-md-4">
						...
						<span class="input-group-addon">日期<span class="required">*</span></span>
					 	<input type="text" id="txt_kssj" name="kjqj" style="width:150px;" onfocus="WdatePicker({dateFmt:'yyyy-MM'})" class="form-control input-radius" />
	                    <span class='input-group-addon'>
	                        <i class="glyphicon glyphicon-calendar"></i>
	                    </span>
	                    <span style="float:left;">&nbsp至&nbsp</span>
	                    <input type="text" id="txt_kkssj" name="kkjqj" style="width:150px;"  onfocus="WdatePicker({dateFmt:'yyyy-MM'})" class="form-control input-radius" />
	                    <span class='input-group-addon' >
	                        <i class="glyphicon glyphicon-calendar"></i>
	                    </span>
						</div>
...
<!-- 							<select class="form-control input-radius select" name="startKjkm" style="width:38%;"> -->
...
<!-- 						<div class="input-group"> -->
<!-- 							<span class="input-group-addon">会计科目末级单位<span class="required">*</span></span> -->
<!-- 							<select class="form-control input-radius select" name="startKjkm2" style="width:38%;"> -->
<%-- 								<c:forEach items="${list1}" var="mjdw"> --%>
<%-- 									<option value="${mjdw.KMBHMC}">${mjdw.KMBHMC}</option> --%>
<%-- 								</c:forEach> --%>
<!-- 							</select> -->
...
$("#startKjkm").bindChange("${ctx}/suggest/getXx","LYE");
$("#endKjkm").bindChange("${ctx}/suggest/getXx","LYE");
$(function(){
	...
	$("#start_kjkm").click(function(){
		...
		select_commonWin("${ctx}/webView/kjhs/bbzx/kmye/Underkjkm.jsp?controlId=startKjkm&year="+year,"科目设置","920","630");
	});
	...
	$("#start_kjkm2").click(function(){
		...
		year = year.substring(0,4);
		select_commonWin("${ctx}/webView/kjhs/bbzx/kmye/Underkjkm.jsp?controlId=startKjkm2&year="+year,"科目设置","920","630");
	});
	...
	$("#btn_save").click(function(){
		...
		var json = $("#myform").serializeObject("start1","end1");			
  		...
  		$.ajax({
  			url:"${ctx}/lyerjz/paramSession",
  			data:"lyerjzJson="+jsonStr,
  			dataType:"json",
  			type:"post",
  			complete:function(){
