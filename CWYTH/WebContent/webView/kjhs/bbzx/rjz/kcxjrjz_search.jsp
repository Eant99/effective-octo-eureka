...
$("#startKjkm").bindChange("${ctx}/suggest/getXx","KCXJ");
$("#endKjkm").bindChange("${ctx}/suggest/getXx","KCXJ");
$(function(){
	...
	$("#start_kjkm").click(function(){
		...
		select_commonWin("${ctx}/webView/kjhs/bbzx/kmye/Underkjkm.jsp?controlId=startKjkm&bz=kcxj&year="+year,"科目设置","920","630");
	});
	...
	$("#start_kjkm2").click(function(){
		...
		year = year.substring(0,4);
		select_commonWin("${ctx}/webView/kjhs/bbzx/kmye/Underkjkm.jsp?controlId=startKjkm2&bz=kcxj&year="+year,"科目设置","920","630");
	});
	...
	$("#btn_save").click(function(){
		...
		var json = $("#myform").serializeObject("start1","end1");			
  		...
  		$.ajax({
  			url:"${ctx}/kcxjrjz/paramSession",
  			data:"kcxjrjzJson="+jsonStr,
  			dataType:"json",
  			type:"post",
  			complete:function(){
