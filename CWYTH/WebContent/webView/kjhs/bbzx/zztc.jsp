			...
			<table id="mydatatables" class="table table-striped table-bordered" style="border-collapse:collapse;width:82%;margin:0 auto">
				    ...
				    <c:forEach var="list" items="${list}" varStatus="i">
				 		<tr name="tr_tr">
				 			...
				 			<td name="num" id="sj" value='${list.PZBH}' >
				 				${list.PZRQ}
				 			</td>
				 			<td name="num" id='pzbh' value='${list.PZBH}'>
				 				${list.PZBH}
				 			</td>
				 			<td name="num" id='zy' value='${list.PZBH}'>
				 				${list.ZY}
				 			</td>
				 			<td name="num"  value='${list.PZBH}'>
				 				${list.JFJE}
				 			</td>
				 			<td name="num" value='${list.PZBH}'>
				 				${list.DFJE}
				 			</td>
				 			<td name="num" id='fx' value='${list.PZBH}'>
				 				${list.JDFX}
				 			</td>
				 			<td name="num" value='${list.PZBH}'>
				 				${list.QMYE}
