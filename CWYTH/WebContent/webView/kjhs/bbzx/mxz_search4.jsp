...
<!-- 				<input type="hidden" name="start" value="start" /> -->
				...
				<div class="col-md-4">
					<div class="input-group">
							...
							<input type="hidden" name="start" value="start" />
							<input type="hidden" name="zttype" id="zttype" value="2" />
...
$(function(){
	...
	$("[id$=_kjkm]").click(function(){
		...
		select_commonWin("${ctx}/webView/kjhs/bbzx/kmye/kjkmgrTree.jsp?controlId="+id+"&year="+year,"科目设置","920","630");
	});
	//取消按钮
