...
$(function () {
    ...
    table = getDataTableByListHj("mydatatables","${ctx}/kjhs/xmmxz/getXmPageList?treexmbh=${xmbh}&bmbh=${bmbh}",[3,'desc'],columns,0,1,setGroup);
});
...
// $("#dyyl").click(function(){
	...
	var data = $("#myform").serialize();
	 ...
	 $.ajax({
			...
			data:data,
			async : false, 
			url:"${ctx}/mxz/getBmxmPageList?treesearch=${treesearch}&treexmbh=${xmbh}&year=${year}&kjqj1="+kjqj1+"&kjqj2="+kjqj2,
			dataType: "json",
...
// 	var str = "<table>"+$("#header").html()+$("#mytable2").find("tbody").html()+"</table>";
	...
	LODOP.ADD_PRINT_HTM("5%","5%","90%","85%","<h2 style='text-align:center'>项目明细账</h2>");
...
// 	$("#btn_exp").click(function(){
	...
	checkbox.each(function(){
		...
		doExp(json,"${ctx}/kjhs/xmmxz/expExcel?treexmbh=${xmbh}&bmbh=${bmbh}&guid="+guid.join("','"),"项目明细账","${pageContext.request.contextPath}",guid.join(","));
	});
