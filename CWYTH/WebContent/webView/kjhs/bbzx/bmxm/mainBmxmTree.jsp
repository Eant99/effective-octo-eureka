...
//配置iframeUlr
var _pageUrl="${ctx}/${param.pageUrl}?ly=bmxm&gs=${param.gs}&ymtz=yes";
//权限标志
var _type=("${param.type}"==""?"self":"all");
...
//     var str = "<div class='ext-tree-search input-group'><input class='form-control' type='text' id='txt_rybh' placeholder='输入项目编号或项目名称' ><span class='input-group-btn'><button type='button' title='点击搜索信息' class='btn'><i class='faw fa-search' aria-hidden='true'></i></button></span></div>";
...
//     $("#txt_rybh").bindChange("${ctx}/suggest/getXx","R");
     ...
     * 左侧树的联想查询
     */
    	var str = "<div class='ext-tree-search input-group'><input class='form-control' type='text' id='txt_treesearch' placeholder='输入项目编号或项目名称！' ><span class='input-group-btn'><button type='button' title='点击搜索信息' class='btn'><i class='faw fa-search' aria-hidden='true'></i></button></span></div>";
        $("#left_tree .x-panel-body").prepend(str);
        $(".btn").click(function(){
        ...
        $("#txt_treesearch").bindChange("${pageContext.request.contextPath}/suggest/getXx","BMXM");
});
</script>
</body>
</html>