...
// 		$("#btn_bmbh").click(function(){
	...
	//项目弹窗
	$(document).on("click","#btn_xmbh",function(){
...
// 	var sfbhwjzpz = $("#txt_sfbhwjzpz").val();
	//列表数据
    var columns = [
    ...
    table = getDataTableByListHj("mydatatables","${ctx}/wldwmxz/getDwwlPageList?treedwbh=${dm}",[2,'desc'],columns,0,1,setGroup);
...
//     $("#dyyl").click(function(){
    	...
    	var data = $("#myform").serialize();
    	 ...
    	 $.ajax({
 			...
 			async : false, 
 			data:data,  
 			url:"${ctx}/wldwmxz/getWldwPageList?treesearch=${treesearch}&kmbh=${kmbh}&year=${year}&dm=${dm}&kjqj1="+kjqj1+"&kjqj2="+kjqj2+"&pzzt="+pzzt,
 			dataType: "json",
...
//     	var str = "<table>"+$("#header").html()+$("#mytable2").find("tbody").html()+"</table>";
    	...
    	LODOP.ADD_PRINT_HTM("5%","5%","90%","85%","<h2 style='text-align:center'>单位往来明细账</h2>");
...
// 	$("#btn_exp").click(function(){
	...
	checkbox.each(function(){
		...
		doExp(json,"${ctx}/wldwmxz/expWldwExcel?treedwbh=${dm}&guid="+guid.join("','"),"单位往来明细账","${pageContext.request.contextPath}",guid.join(","));
	});
});
