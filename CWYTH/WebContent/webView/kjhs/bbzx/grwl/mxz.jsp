...
<input type="hidden" name="ryid" id="tr_kmbh" value="${kmbh}"/>
 ...
 $(function () {
	 ...
	 helloWord();
	   ...
	   $.ajax({
			type:"post",
			async : false, 
			url:"${ctx}/mxz/getGrwlPageList?treesearch=${treesearch}&ryid=${ryid}&year=${year}",
			dataType: "json",
