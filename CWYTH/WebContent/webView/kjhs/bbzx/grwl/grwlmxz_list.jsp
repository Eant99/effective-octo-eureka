	...
	<div class="container-fluid">
		<div class='responsive-table'>
			<div class='scrollable-area'> 
				...
				<div style="display: none;" id="div_table2">
...
$(function () {
    ...
    table = getDataTableByListHj("mydatatables","${ctx}/kjhs/grwlmxz/getGrwlPageList?treezrr=${ryid}",[2,'desc'],columns,0,1,setGroup);
});
//打印预览
...
// $("#dyyl").click(function(){
	...
	var data = $("#myform").serialize();
	 ...
	 $.ajax({
			...
			data:data,
			async : false, 
			url:"${ctx}/mxz/getGrwlPageList?treesearch=${treesearch}&ryid=${ryid}&year=${year}&kjqj1="+kjqj1+"&kjqj2="+kjqj2,
			dataType: "json",
			success:function(val){
				for (var i=0;i<val.length;i++){
					 var PZRQ=val[i].PZRQ;if(PZRQ==null) PZRQ='';
					 var PZLXM=val[i].PZLXM;if(PZLXM==null) PZLXM='';
					 var PZZ=val[i].PZZ;if(PZZ==null) PZZ='';
					 var ZY=val[i].ZY;if(ZY==null) ZY='';
					 var ZRR=val[i].ZRR;if(ZRR==null) ZRR='';
					 var XM=val[i].XM;if(XM==null) XM='';
...
// 	var str = "<table>"+$("#header").html()+$("#mytable2").find("tbody").html()+"</table>";
	...
	LODOP.ADD_PRINT_HTM("5%","5%","90%","85%","<h2 style='text-align:center'>个人往来明细账</h2>");
...
// 	$("#btn_exp").click(function(){
	...
	checkbox.each(function(){
		...
		doExp(json,"${ctx}/kjhs/grwlmxz/expExcel?treezrr=${ryid}&guid="+guid.join("','"),"个人往来明细账","${pageContext.request.contextPath}",guid.join(","));
	});
