		...
		<div class="responsive-table">
			<div class="scrollable-area" style="overflow-x:auto;"> 
				<table id="mydatatables" class="table table-striped table-bordered" style="border-collapse:collapse;width:100%;margin:0 auto" border="0">
					<div id="print_title">
					<h2 style="text-align:center;"><div style="padding-bottom:5px;margin:0 auto;display:inline-block;"><a style="color:black;text-decoration: none;">${bmmc}&nbsp;项目经费明细账</a></div></h2>
...
$(document).on("dblclick","#mydatatables tr:not(#header)",function(){
	...
	if(vamc ==""){
		alert("该摘要无记账凭证!");return;
   		...
   		pageSkip("${ctx}/kjhs/pzxx/pzlr","pzlrck&gs=bmyebmx&ye=${ye}&guid="+vamc+"&year=${year}&startMonth=${startMonth}&endMonth=${endMonth}&jzpz=${jzpz}&bmh=${param.bmh}");
	}
});
</script>
</body>
