...
<!-- 				<input type="hidden" name="start" value="start" /> -->
				...
				<div class="col-md-4">
					<div class="input-group">
							...
							<input type="hidden" name="start" value="start" />
							<input type="hidden" name="zttype" id="zttype" value="5" />
					...
					<div class="col-md-4">
						<div class="input-group">
							...
							<input type="text" name="startKjkm" id="startKjkm" style="width:55% !important;" class="form-control input-radius" value="${kjkm}"/>
							<input type="hidden" name="Kjkmmc" id="Kjkmmc" style="width:28% ;" class="form-control input-radius" value="${kjkm}"/>
							<div class="div_style">
...
$(function(){
	...
	$("#btn_save").click(function(){
		...
		var json = $("#myform").serializeObject("start","end");  //json对象				
  		...
  		var dm ="${dm}"
  		$.ajax({
  			url:"${ctx}/kjhs/jjkmmxz1/paramSession",
  			data:"params="+jsonStr+"&bbqj="+bbqj,
  			dataType:"json",
  			type:"post",
  			complete:function(){
  				getIframWindow("${param.pname}").kz(bbqj,kmbh,kmbh,startMonth,endMonth,pz,dm);
  				var winId = getTopFrame().layer.getFrameIndex(window.name);
  				close(winId);
  			}
  		});
