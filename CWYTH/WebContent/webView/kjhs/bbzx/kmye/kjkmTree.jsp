...
//配置iframeUlr
var _pageUrl="${pageContext.request.contextPath}/webView/kjhs/bbzx/kmye/kjkm_list.jsp?pname=${param.pname}&controlId=${param.controlId}&year=${param.year}&mkbh=${param.mkbh}";
