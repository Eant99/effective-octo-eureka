	...
	<div class="container box-content">
	    <div class="container-fluid dialog-body">
			...
			<div class="row">
				<div class="col-md-12">
					<div class="input-group">
						<span class="input-group-addon">接收部门</span>
						<input type="text" id="txt_dwbh" class="form-control input-radius" name="dwbh" value="${xtxx.DWBH}">
...
<script type="text/javascript">
	$(function(){
		...
		$("#btn_save").click(function(e){
			...
			var dwbh = $("[name='dwbh']").val();
			var operateType = $("[name='operateType']").val();
			$.ajax({
				type:"post",
				url:"${ctx}/tzxx/doSave",
				data:"content="+content+"&title="+title+"&sfzs="+sfzs+"&operateType="+operateType+"&gid="+gid+"&dwbh="+dwbh,
				dataType:"json",
