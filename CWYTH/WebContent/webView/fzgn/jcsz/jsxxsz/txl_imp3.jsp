...
<body>
<form id="myform"  class="form-horizontal" action="${ctx}/grjfsz/uploadt?pname=${param.pname}" method="post" enctype="multipart/form-data">
...
$(function() {
	...
	$("#btn_exp").click(function(){
		var fname = "经费信息模板template.xls";
		var path = "uploadFiles/经费信息模板template.xls";
