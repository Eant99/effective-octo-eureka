...
<body>
<form id="myform"  class="form-horizontal" action="${ctx}/bmjfsz/uploadt?pname=${param.pname}" method="post" enctype="multipart/form-data">
	<input type="hidden" id="sclx" name="sclx" value="">
    <div class="page-header">
		<div class="pull-left">
			<span class="page-title text-primary"><i class='fa icon-xiangxixinxi'></i>经费信息导入</span>
		 </div>
	</div>
...
$(function() {
	...
	$("#btn_exp").click(function(){
		var fname = "部门经费信息模板template.xls";
		var path = "uploadFiles/部门经费信息模板template.xls";
