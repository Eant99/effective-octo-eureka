	...
	<div class="search" id="searchBox" style="padding-top: 0px">
		...
		<div class="col-md-12 tabs" style="padding-right: 0px">
			<ul id="tabTop" class="nav nav-tabs" role="tablist">
				...
				<li role="presentation"><a id="tab_wysp">外语水平</a></li>
				<li role="presentation"><a id="tab_jxqk">进修情况</a></li>
				<li role="presentation" ><a id="tab_zzqk">著作情况</a></li>
				<li role="presentation"  class="active"><a id="tab_cgjl">成果奖励</a></li>
			</ul>
		</div>
	</div>
...
$(function () {
  //添加按钮
    $(document).on("click","#btn_add",function(){
   		select_commonWin("${ctx}/rycgjlb/goRycgjlbPage?operateType=C&rybh=${rybh}","成果奖励","460","450");
   	});
  //返回按钮
  ...
  //论文情况
    ...
    $("#tab_zzqk").click(function(){
   	...
   	$(document).on("click",".btn_upd",function(){
		...
		select_commonWin("${ctx}/rycgjlb/goRycgjlbPage?operateType=U&rybh=${rybh}&guid="+guid+"","成果奖励","460","450");
   	});
   	//单个删除
  ...
  //列表数据
 	...
 	table = getDataTableByListHj("mydatatables","${ctx}/rycgjlb/getCgjlList?rybh=${rybh}",[2,'asc'],columns,"","",setGroup);
});
$(function() {	
	//列表右侧悬浮按钮
