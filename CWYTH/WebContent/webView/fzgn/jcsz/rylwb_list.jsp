	...
	<div class="search" id="searchBox" style="padding-top: 0px">
		...
		<div class="col-md-12 tabs" style="padding-right: 0px">
			<ul id="tabTop" class="nav nav-tabs" role="tablist">
				...
				<li role="presentation" class="active"><a id="tab_lwqk">论文情况</a></li>
...
$(function () {
    ...
    $(document).on("click","#btn_add",function(){
		select_commonWin("${ctx}/rylwb/goRylwbPage?operateType=C&rybh=${rybh}","论文情况","460","450");
    });
    //返回按钮
    ...
    //修改按钮
   	$(document).on("click",".btn_upd",function(){
		...
		select_commonWin("${ctx}/rylwb/goRylwbPage?operateType=U&rybh=${rybh}&guid="+guid+"","论文情况","460","450");
   	});
  //单个删除
  ...
  //批量删除按钮
   $(document).on("click","#btn_del",function(){
    ...
    //加载列表数据
 	table = getDataTableByListHj("mydatatables","${ctx}/rylwb/getLwqkList?rybh=${rybh}",[2,'asc'],columns,0,1,setGroup);
});
function reloadList(){
	table.ajax.reload();
}
