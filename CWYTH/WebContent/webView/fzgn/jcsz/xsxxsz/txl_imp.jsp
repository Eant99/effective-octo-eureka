...
<body>
<form id="myform"  class="form-horizontal" action="${ctx}/xsxx/upload?pname=${param.pname}" method="post" enctype="multipart/form-data">
	<input type="hidden" id="sclx" name="sclx" value="">
    <div class="page-header">
		<div class="pull-left">
			<span class="page-title text-primary"><i class='fa icon-xiangxixinxi'></i>学生信息导入</span>
		 </div>
	</div>
...
$(function() {
	...
	$("#btn_exp").click(function(){
		var fname = "学生信息模板template.xls";
		var path = "uploadFiles/学生信息模板template.xls";
