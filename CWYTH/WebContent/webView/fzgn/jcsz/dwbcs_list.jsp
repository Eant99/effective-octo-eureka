...
<div class="fullscreen">
	 <!-- ***********************第一栏开始*********************************** -->
    <div class="search" id="searchBox"><!-- 查询 -->
...
//   	     	   		}
   	    	...
   	    	//表数据
   	       	table = getDataTableByListHj("mydatatables","${ctx}/dwb/getPageList?treedwbh=${dwbh}",[2,'asc'],columns,0,1,setGroup);
   	//新增
   	$("#btn_add").click(function(){
   		doOperate("${ctx}/dwb/goEditPage?dwbh=${param.dwbh}","C");
   	});
   	//修改
