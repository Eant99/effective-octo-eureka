	...
	<div class="search" id="searchBox" style="padding-top: 0px">
		...
		<div class="col-md-12 tabs" style="padding-right: 0px">
			<ul id="tabTop" class="nav nav-tabs" role="tablist">
				...
				<li role="presentation"  class="active"><a id="tab_jxqk">进修情况</a></li>
...
$(function () {
  ...
  //成果奖励
   ...
   //返回按钮
    ...
    $(document).on("click","#btn_add",function(){
   		select_commonWin("${ctx}/ryjxb/goRyjxPage?operateType=C&rybh=${rybh}","进修情况","450","460");
   	});
   	//修改按钮
   	$(document).on("click",".btn_upd",function(){
   		var guid = $(this).parents("tr").find("[name='keyId']").val();
		select_commonWin("${ctx}/ryjxb/goRyjxPage?operateType=U&rybh=${rybh}&guid="+guid+"","进修情况","450","460");
   	});
   	//单个删除
  ...
  //列表数据
 	...
 	table = getDataTableByListHj("mydatatables","${ctx}/ryjxb/getRyjxList?rybh=${rybh}",[2,'asc'],columns,"","",setGroup);
});
$(function() {	
	//列表右侧悬浮按钮
