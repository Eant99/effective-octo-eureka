	...
	<div class="search" id="searchBox" style="padding-top: 0px">
		...
		<div class="col-md-12 tabs" style="padding-right: 0px">
			<ul id="tabTop" class="nav nav-tabs" role="tablist">
					...
					<li role="presentation"  class="active"><a id="tab_zzqk">著作情况</a></li>
...
$(function () {
  ...
  //成果奖励
    ...
    $(document).on("click","#btn_add",function(){
   		select_commonWin("${ctx}/ryzzb/goRyzzbPage?operateType=C&rybh=${rybh}","著作情况","450","460");
   	});
  //返回按钮
    $(document).on("click","#btn_back",function(){
   	...
   	$(document).on("click",".btn_upd",function(){
		...
		select_commonWin("${ctx}/ryzzb/goRyzzbPage?operateType=U&rybh=${rybh}&guid="+guid+"","著作情况","450","460");
   	});
   	//单个删除
  ...
  //列表数据
 	...
 	table = getDataTableByListHj("mydatatables","${ctx}/ryzzb/getZzqkList?rybh=${rybh}",[2,'asc'],columns,"","",setGroup);
});
$(function() {	
	//列表右侧悬浮按钮
