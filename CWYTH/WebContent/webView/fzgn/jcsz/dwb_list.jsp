...
//    	});
  ...
  $(document).on("click","#btn_exp",function(){   		
   		...
   		doExp("","${ctx}/dwb/expExcel2?dwbh="+dwbh+"&mc="+mc,"单位信息","${pageContext.request.contextPath}",id);
...
// 				}
   	...
   	var columns = [
		...
		{"data": "SFXY",defaultContent:"","class":"text-left"},
	   	{"data": "DWZT",defaultContent:"","class":"text-left"},
