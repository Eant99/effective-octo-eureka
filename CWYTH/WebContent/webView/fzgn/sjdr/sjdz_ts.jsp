         ...
         <div style="height: 25px;margin-left: 18px;">
            ...
            <div class="div_table" >
                <table border="1" cellpadding="0" cellspacing="0" style="width: 96%; margin:0 auto;" class="form-detail-table">
                    ...
                    <tr>
                        <td class="lable">凭&ensp;证&ensp;号</td>
                        <td align="left">
                            <select name="pzh" id="drp_xmh">
								<option value="null">无</option>
								<c:forEach var="listbt" items="${listbt}"> 
                           			<option value="${listbt.mc}"<c:if test="${'凭证号' == listbt.mc}">selected</c:if>>${listbt.mc}</option>
								</c:forEach>
							</select>
						</td>
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <select name="gbm" id="drp_fw_qsrq">
								<option value="null">无</option>
								<c:forEach var="listbt" items="${listbt}"> 
                    ...
                    <tr>
						...
						<td class="lable">图书册数</td>
                        <td align="left">
                            <select name="sykh" id="drp_fjs">
								<option value="null">无</option>
								<c:forEach var="listbt" items="${listbt}"> 
                           			<option value="${listbt.mc}"<c:if test="${'图书册数' == listbt.mc}">selected</c:if>>${listbt.mc}</option>
								</c:forEach>
							</select>
                        </td>
                        <td class="lable">购置日期</td>
                        <td align="left">
                            <select name="gzrq" id="drp_cgr">
								<option value="null">无</option>
								<c:forEach var="listbt" items="${listbt}"> 
                    ...
                    <tr>
                        <td class="lable">出&ensp;版&ensp;社</td>
                        <td align="left">
                            <select name="sccj" id="drp_htbh">
								<option value="null">无</option>
								<c:forEach var="listbt" items="${listbt}"> 
                           			<option value="${listbt.mc}"<c:if test="${'出版社' == listbt.mc}">selected</c:if>>${listbt.mc}</option>
								</c:forEach>
							</select>
                        </td>
                        <td class="lable">出版日期</td>
                        <td align="left">
                            <select name="ccrq" id="drp_xss">
								<option value="null">无</option>
								<c:forEach var="listbt" items="${listbt}"> 
                           			<option value="${listbt.mc}"<c:if test="${'出版日期' == listbt.mc}">selected</c:if>>${listbt.mc}</option>
								</c:forEach>
							</select>
						</td>
                        <td class="lable">出版编号</td>
                        <td align="left">
                            <select name="cch" id="drp_gzyq">
								<option value="null">无</option>
								<c:forEach var="listbt" items="${listbt}"> 
                           			<option value="${listbt.mc}"<c:if test="${'出版编号' == listbt.mc}">selected</c:if>>${listbt.mc}</option>
								</c:forEach>
							</select>
						</td>
                    </tr>
                    <tr>
                        ...
                        <td class="lable">保存年限</td>
                        <td align="left">
                            <select name="synx" id="drp_gbm">
								<option value="null">无</option>
								<c:forEach var="listbt" items="${listbt}"> 
                           			<option value="${listbt.mc}"<c:if test="${'保存年限' == listbt.mc}">selected</c:if>>${listbt.mc}</option>
								</c:forEach>
							</select>
						</td>
                    </tr>
                    <tr>
                        <td class="lable">实价</td>
                        <td align="left">
                            <select name="jkdj" id="drp_fjzj">
								<option value="null">无</option>
								<c:forEach var="listbt" items="${listbt}"> 
                           			<option value="${listbt.mc}"<c:if test="${'实价' == listbt.mc}">selected</c:if>>${listbt.mc}</option>
								</c:forEach>
							</select>
                        </td>
                        <td class="lable">外币种类</td>
                        <td align="left">
                            <select name="wbzl" id="drp_zj">
								<option value="null">无</option>
								<c:forEach var="listbt" items="${listbt}"> 
                    ...
                    <tr>
                        ...
                        <td class="lable">档&ensp;案&ensp;号</td>
                        <td align="left">
                            <select name="dabh" id="drp_fw_dsmj">
								<option value="null">无</option>
								<c:forEach var="listbt" items="${listbt}"> 
                           			<option value="${listbt.mc}"<c:if test="${'档案号' == listbt.mc}">selected</c:if>>${listbt.mc}</option>
								</c:forEach>
							</select>
						</td>
                        <td class="lable">项目实验室负责人</td>
                        <td align="left">
                            <select name="fzr" id="drp_fw_dxmj">
								<option value="null">无</option>
								<c:forEach var="listbt" items="${listbt}"> 
