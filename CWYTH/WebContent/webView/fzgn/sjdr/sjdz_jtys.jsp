            ...
            <div class="div_table" >
                <table border="1" cellpadding="0" cellspacing="0" style="width: 96%; margin:0 auto;" class="form-detail-table">
                   ...
                   <tr>
                        ...
                        <td align="left">
                            <select name="jt_cpxh" id="drp_htbh">
								<option value="null">无</option>
								<c:forEach var="listbt" items="${listbt}"> 
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <select name="zmjz" id="drp_fw_dsmj">
								<option value="null">无</option>
								<c:forEach var="listbt" items="${listbt}"> 
                    ...
                    <tr>
                        <td class="lable">生产厂家</td>
                        <td align="left">
                            <select name="sccj" id="drp_fw_dsmj">
								<option value="null">无</option>
								<c:forEach var="listbt" items="${listbt}"> 
                        ...
                        <td align="left">
                            <select name="ccrq" id="drp_fw_dxmj">
								<option value="null">无</option>
								<c:forEach var="listbt" items="${listbt}"> 
                    ...
                    <tr>
                    	...
                    	<td class="lable">持证日期</td>
                        <td align="left">
                            <select name="fzrq" id="drp_bz">
								<option value="null">无</option>
								<c:forEach var="listbt" items="${listbt}"> 
                           			<option value="${listbt.mc}"<c:if test="${'持证日期' == listbt.mc}">selected</c:if>>${listbt.mc}</option>
								</c:forEach>
							</select>
                        </td>
                   </tr>
                   <tr>
                    	<td class="lable">排&ensp;气&ensp;量</td>
                        <td align="left">
                            <select name="jt_pql" id="drp_zjjt">
								<option value="null">无</option>
								<c:forEach var="listbt" items="${listbt}"> 
                           			<option value="${listbt.mc}"<c:if test="${'排气量' == listbt.mc}">selected</c:if>>${listbt.mc}</option>
								</c:forEach>
							</select>
						</td>
                        <td class="lable">行车里程</td>
                        <td align="left">
                            <select name="wbje" id="drp_ljzj">
								<option value="null">无</option>
								<c:forEach var="listbt" items="${listbt}"> 
                           			<option value="${listbt.mc}"<c:if test="${'行车里程' == listbt.mc}">selected</c:if>>${listbt.mc}</option>
								</c:forEach>
							</select>
						</td>
                    </tr>
