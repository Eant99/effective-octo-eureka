            ...
            <div class="div_table" >
                <table border="1" cellpadding="0" cellspacing="0" style="width: 96%; margin:0 auto;" class="form-detail-table">
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <select name="qsrq" id="drp_fw_qsrq">
								<option value="null">无</option>
								<c:forEach var="listbt" items="${listbt}"> 
                    ...
                    <tr>
                        <td class="lable"  style=" color:Red">权属年限</td>
                        <td align="left">
                            <select name="synx" id="drp_synx">
								<option value="null">无</option>
								<c:forEach var="listbt" items="${listbt}"> 
                        ...
                        <td class="lable">房屋所有权人</td>
                        <td align="left">
                            <select name="czr" id="drp_czr">
								<option value="null">无</option>
								<c:forEach var="listbt" items="${listbt}"> 
                           			<option value="${listbt.mc}"<c:if test="${'房屋所有权人' == listbt.mc}">selected</c:if>>${listbt.mc}</option>
								</c:forEach>
							</select>
						</td>
                    </tr>
                    <tr>
                        <td class="lable"  style=" color:Red">平面图数</td>
                        <td align="left">
                            <select name="tph" id="drp_tph">
								<option value="null">无</option>
								<c:forEach var="listbt" items="${listbt}"> 
                           			<option value="${listbt.mc}"<c:if test="${'平面图数' == listbt.mc}">selected</c:if>>${listbt.mc}</option>
								</c:forEach>
							</select>
                        </td>
                        <td class="lable"  style=" color:Red">承建单位</td>
                        <td align="left">
                            <select name="sccj" id="drp_cj">
								<option value="null">无</option>
								<c:forEach var="listbt" items="${listbt}"> 
                        ...
                        <td class="lable"  style=" color:Red">完损状况</td>
                        <td align="left">
                            <select name="tddj" id="drp_cgr">
								<option value="null">无</option>
								<c:forEach var="listbt" items="${listbt}"> 
                           			<option value="${listbt.mc}"<c:if test="${'完损状况' == listbt.mc}">selected</c:if>>${listbt.mc}</option>
								</c:forEach>
							</select>
						</td>
                    </tr>
                    <tr>
                        <td class="lable"  style=" color:Red">校区编号</td>
                        <td align="left">
                            <select name="htbh" id="drp_htbh">
								<option value="null">无</option>
								<c:forEach var="listbt" items="${listbt}"> 
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <select name="cqxs" id="drp_fw_cqxs">
								<option value="null">无</option>
								<c:forEach var="listbt" items="${listbt}"> 
                        ...
                        <td class="lable"  style=" color:Red">产权来源</td>
                        <td align="left">
                    ...
                    <tr>
                        <td class="lable"  style=" color:Red">权属证明</td>
                        <td align="left">
                            <select name="fw_qszm" id="drp_fw_qszm">
								<option value="null">无</option>
								<c:forEach var="listbt" items="${listbt}"> 
                        ...
                        <td class="lable">证载面积</td>
                        <td align="left">
                            <select name="zmmj" id="drp_td_zmmj">
								<option value="null">无</option>
								<c:forEach var="listbt" items="${listbt}"> 
                           			<option value="${listbt.mc}"<c:if test="${'证载面积' == listbt.mc}">selected</c:if>>${listbt.mc}</option>
								</c:forEach>
							</select>
						</td>
                    </tr>
                    <tr>
                        ...
                        <td align="left">
                            <select name="fw_fzrq" id="drp_fw_fzrq">
								<option value="null">无</option>
								<c:forEach var="listbt" items="${listbt}"> 
                        ...
                        <td class="lable">房屋用途</td>
                        <td align="left">
                            <select name="fwyt" id="drp_fwyt">
								<option value="null">无</option>
								<c:forEach var="listbt" items="${listbt}"> 
                           			<option value="${listbt.mc}"<c:if test="${'房屋用途' == listbt.mc}">selected</c:if>>${listbt.mc}</option>
								</c:forEach>
							</select>
						</td>
                    </tr>
                    <tr>
                        ...
                        <td align="left">
                            <select name="dsmj" id="drp_fw_dsmj">
								<option value="null">无</option>
								<c:forEach var="listbt" items="${listbt}"> 
                        ...
                        <td align="left">
                            <select name="dxmj" id="drp_fw_dxmj">
								<option value="null">无</option>
								<c:forEach var="listbt" items="${listbt}"> 
                    ...
                    <tr>
                        <td class="lable">自然间数</td>
                        <td align="left">
                            <select name="fw_zrjs" id="drp_blbz">
								<option value="null">无</option>
								<c:forEach var="listbt" items="${listbt}"> 
                           			<option value="${listbt.mc}"<c:if test="${'自然间数' == listbt.mc}">selected</c:if>>${listbt.mc}</option>
								</c:forEach>
							</select>
                        </td>
                        <td class="lable">账面净值</td>
                        <td align="left">
                            <select name="zmjz" id="drp_yt">
								<option value="null">无</option>
								<c:forEach var="listbt" items="${listbt}"> 
                    ...
                    <tr>
                        ...
                        <td class="lable">建筑朝向</td>
                        <td align="left">
                            <select name="gg" id="drp_gg">
								<option value="null">无</option>
								<c:forEach var="listbt" items="${listbt}"> 
                           			<option value="${listbt.mc}"<c:if test="${'建筑朝向' == listbt.mc}">selected</c:if>>${listbt.mc}</option>
								</c:forEach>
							</select>
						</td>
                        <td class="lable">建筑结构</td>
                        <td align="left">
                            <select name="xh" id="drp_xh">
							<option value="null">无</option>
								<c:forEach var="listbt" items="${listbt}"> 
                           			<option value="${listbt.mc}"<c:if test="${'建筑结构' == listbt.mc}">selected</c:if>>${listbt.mc}</option>
								</c:forEach>
						</select>
					</td>
                    </tr>
                    <tr>
                        ...
                        <td align="left">
                            <select name="fw_zymj" id="drp_fw_zymj">
								<option value="null">无</option>
								<c:forEach var="listbt" items="${listbt}"> 
                        ...
                        <td align="left">
                            <select name="zyjz" id="drp_td_zyjz">
								<option value="null">无</option>
								<c:forEach var="listbt" items="${listbt}"> 
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <select name="fw_cjmj" id="drp_fw_cjmj">
								<option value="null">无</option>
								<c:forEach var="listbt" items="${listbt}"> 
                        ...
                        <td align="left">
                            <select name="cjjz" id="drp_td_cjjz">
								<option value="null">无</option>
								<c:forEach var="listbt" items="${listbt}"> 
                        ...
                        <td class="lable">占地面积</td>
                        <td align="left">
                            <select name="wbje" id="drp_wbje">
								<option value="null">无</option>
								<c:forEach var="listbt" items="${listbt}"> 
                           			<option value="${listbt.mc}"<c:if test="${'占地面积' == listbt.mc}">selected</c:if>>${listbt.mc}</option>
								</c:forEach>
							</select>
						</td>
                    </tr>
                    <tr>
                        ...
                        <td align="left">
                            <select name="fw_czmj" id="drp_fw_czmj">
								<option value="null">无</option>
								<c:forEach var="listbt" items="${listbt}"> 
                        ...
                        <td align="left">
                            <select name="czjz" id="drp_td_czjz">
								<option value="null">无</option>
								<c:forEach var="listbt" items="${listbt}"> 
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <select name="jyjz" id="drp_td_jyjz">
								<option value="null">无</option>
								<c:forEach var="listbt" items="${listbt}"> 
                    ...
                    <tr>
                        <td class="lable">担保面积</td>
                        <td align="left">
                            <select name="fw_xzmj" id="drp_fw_xzmj">
								<option value="null">无</option>
								<c:forEach var="listbt" items="${listbt}"> 
                           			<option value="${listbt.mc}"<c:if test="${'担保面积' == listbt.mc}">selected</c:if>>${listbt.mc}</option>
								</c:forEach>
							</select>
						</td>
                        <td class="lable">担保价值</td>
                        <td align="left">
                            <select name="xzjz" id="drp_td_xzjz">
							<option value="null">无</option>
							<c:forEach var="listbt" items="${listbt}"> 
                           			<option value="${listbt.mc}"<c:if test="${'担保价值' == listbt.mc}">selected</c:if>>${listbt.mc}</option>
								</c:forEach>
						</select>
                        </td>
                        <td class="lable">幢&emsp;&emsp;号</td>
                        <td align="left">
                            <select name="cch" id="drp_cch">
								<option value="null">无</option>
								<c:forEach var="listbt" items="${listbt}"> 
                           			<option value="${listbt.mc}"<c:if test="${'幢号' == listbt.mc}">selected</c:if>>${listbt.mc}</option>
								</c:forEach>
							</select>
						</td>
                    </tr>
                    <tr>
                        ...
                        <td align="left">
                            <select name="fw_qtmj" id="drp_fw_qtmj">
								<option value="null">无</option>
								<c:forEach var="listbt" items="${listbt}"> 
                        ...
                        <td align="left">
                            <select name="qtjz" id="drp_td_qtjz">
								<option value="null">无</option>
								<c:forEach var="listbt" items="${listbt}"> 
