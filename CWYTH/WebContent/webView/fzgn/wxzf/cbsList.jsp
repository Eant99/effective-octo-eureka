...
$(function (){
	...
	var columns = [
	           	{"data": "BJBH",orderable:false, "render": function (data, type, full, meta){
	        		return '<input type="checkbox" class="keyId" name="cbs" value="' + full.CBSMC + '">';
	            ...
	            {"data": "CBSWXH",defaultContent:""},
	            {"data": "LXR",defaultContent:""},
	            {"data": "LXDH",defaultContent:""}
	        ];
	table = $('#mydatatables').DataTable({
        ajax: {
            url: "${pageContext.request.contextPath}/wxzf/getCbs"//获取数据的方法
        },
    ...
    $(document).on("dblclick","#mydatatables tr:not(#header)",function(){
    	var val = $(this).find("[name='cbs']").val();
