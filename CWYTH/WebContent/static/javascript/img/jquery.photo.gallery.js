...
$.extend({
	...
	openPhotoGallery : function(obj){
		...
		var $gallerys = $(obj).closest(".file-preview"),
			activeIndex=0,
			imgs = [];
		$gallerys.find(".kv-file-content img").each(function(i, elem){
//			var _this = this.find("img");
		...
		$("#J_pg").remove();
		$("<iframe style='z-index:99999;'></iframe").appendTo("body")
			.attr("id", "J_pg")
			.attr("src", projectName+"/webView/gallery.jsp")
			.css({
				position : "absolute",
