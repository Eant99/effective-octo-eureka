package com.googosoft.util.security;
...
public class EncryptUtils {
    ...
    public static void main(String[] args) {
       ...
       /* 
        ...
        System.out.println("Hello经过SHA:" + EncryptUtils.encryptToSHA(source,"salt"));
        System.out.println("========随机生成Key进行加解密==============");
        // 生成一个DES算法的密匙
        SecretKey key = EncryptUtils.createSecretDESKey();
        //SecretKey key = "googosoftzcgl";
