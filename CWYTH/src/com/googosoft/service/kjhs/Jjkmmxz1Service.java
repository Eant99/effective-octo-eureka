...
import com.googosoft.dao.kjhs.Jjkmmxz1Dao;
...
@Service("jjkmmxz1Service")
public class Jjkmmxz1Service extends BaseService {
	@Resource(name = "jjkmmxz1Dao")
	private Jjkmmxz1Dao jjkmmxz1Dao;
	...
	public List<Map<String, Object>> getPageList(String kmbh,String kjzd,String treesearch,PageData pd){
		return jjkmmxz1Dao.getPageList(kmbh,kjzd,treesearch,pd);
	}
...
//	}
	public List<Map<String, Object>> getJjPageList(String kmbh,String kjkm,String pznd,String startMonth,String endMonth,String pzzt,String bmbh,String xmbh,String jfjel,String jfjeh,String zy) {
		return jjkmmxz1Dao.getJjPageList(kmbh,kjkm,pznd,startMonth,endMonth,pzzt, bmbh, xmbh, jfjel, jfjeh, zy);
	}
	public List<Map<String, Object>> getGrPageList(String ryid,String kjkm,String pznd,String startMonth,String endMonth,String pzzt,String bmbh,String xmbh,String jfjel,String jfjeh,String zy) {
		return jjkmmxz1Dao.getGrPageList(ryid,kjkm,pznd,startMonth,endMonth,pzzt, bmbh, xmbh, jfjel, jfjeh, zy);
	}
	public List<Map<String, Object>> getXmPageList(String treexmbh,String kjkm,String pznd,String startMonth,String endMonth,String pzzt,String bmbh,String xmbh,String jfjel,String jfjeh,String zy) {
		return jjkmmxz1Dao.getXmPageList(treexmbh,kjkm,pznd,startMonth,endMonth,pzzt,bmbh,xmbh,jfjel,jfjeh,zy);
	}
	/**
	 * 查询级别list
	 * 
	...
	public boolean getResult(List list,String sszt,String kjzd,String kmbh,PageData pd,String bz) {
		return jjkmmxz1Dao.getResult(list, sszt,kjzd,kmbh,pd,bz);
	}
	/**
	 ...
	 * @return
	 */
	public boolean getResultNew(String jjbh, String sszt, String kjkm,
			String year, String StartMonth, String endMonth, PageData pd, String bz) {
		return jjkmmxz1Dao.getResultNew(jjbh, sszt,kjkm,year,StartMonth,endMonth,pd,bz);
	}
	...
	public List kmbhList(String kmbh) {
		return jjkmmxz1Dao.kmbhList(kmbh);
	}
	...
	public Object getPowerNode(PageData pd, String loginrybh) {
		...
		List dList=jjkmmxz1Dao.PowerModels(loginrybh);
		Map map=new HashMap();
		...
		if(dList.size()>0){
			...
			for(int i=0;i<dList.size();i++){
                ...
                if(xjcount<=0) {
                	 List LRybs = jjkmmxz1Dao.GetModels(dwbh);
                     xjcount =LRybs.size();
	...
	public Object getDwRyNode(PageData pd, String sjdw,String rootPath) {
		...
		List<ExtTreeNode> children = new ArrayList<ExtTreeNode>();
		List dList =  jjkmmxz1Dao.GetDwModels(sjdw);
		String dwbh, bmh, mc;
		int xjcount = 0;
		Map map = new HashMap();
		if (dList.size() > 0) {
			for (int i = 0; i < dList.size(); i++) {
				...
				List dwcount = jjkmmxz1Dao.GetModels(dwbh);
				xjcount = Integer.parseInt(map.get("XJCOUNT").toString()) + dwcount.size();
				if (xjcount <= 0) {
					dwcount = jjkmmxz1Dao.GetModels(dwbh);
		...
		dList = jjkmmxz1Dao.GetModels(sjdw);
		if (dList.size() > 0) {
			for (int i = 0; i < dList.size(); i++) {
				map = (Map) dList.get(i);
