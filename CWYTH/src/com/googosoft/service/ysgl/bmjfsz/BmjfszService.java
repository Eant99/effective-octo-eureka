package com.googosoft.service.ysgl.bmjfsz;
 ...
 * @author master
 */
@Service("bmjfszService")
public class BmjfszService extends BaseService{
	
	@Resource(name="bmjfszDao")
	public BmjfszDao bmjfszDao;
	...
	public int doUpdate(PageData pd,String dwbh) {
			int result = bmjfszDao.doUpdate(pd,dwbh);
			if(result>0){
...
//		int result = bmjfszDao.goFhPage(pd,dwbh);
//		if(result>0){
//			doAddOplog(OplogFlag.UPD,"");
//		}
//		return result;
//	}
	...
	public int doDelete(String dwbh) {
		int result = bmjfszDao.doDelete(dwbh);
		if(result>0){
