 ...
 * 报销业务查询
 * @author wangzhiduo
 * @date 2017-12-29下午2:48:55
 */
public class BxywcxExportExcel {
	 public static Map<String, Object> exportExcel(String fileurl,String shortfileurl,String[] title,String TITLE, List<Map<String, Object>> listContent) {  
			...
			try {      
			   ...
			   for (Map<String, Object> drow : listContent) {
					...
					sheet.addCell(new Label(3, i, Validate.isNullToDefaultString(drow.get("bxlx"), ""), wcf_left));
					...
					sheet.addCell(new Label(7, i, Validate.isNullToDefaultString(drow.get("BXZJE"), ""), wcf_left));
					i++;
			    }
			   /************将以上缓存中的内容写到EXCEL文件中*********/  
			   workbook.write();  
