...
import com.googosoft.dao.tubiao.GrgzqkDao;
import com.googosoft.pojo.tubiao.Zhcx;
import com.googosoft.service.base.BaseService;
import com.googosoft.util.Validate;

@Service("grgzqkService")
public class GrgzqkService extends BaseService {
	@Resource(name="grgzqkDao")
	public GrgzqkDao grgzqkDao;
	
	//===
	public String getJzggzzc(Zhcx obj){
	    List<Map<String, Object>> list = this.grgzqkDao.getJzggzzc(obj);
	...
	public String getJzgcwxq(Zhcx obj)  {
		...
		Map<String, List> map = grgzqkDao.getJzggzfb(obj);
		List list;
