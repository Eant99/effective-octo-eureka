...
public class YhxxExportExcel {
	 public static Map<String, Object> exportExcel(String fileurl,String shortfileurl,String[] title,String TITLE, List<Map<String, Object>> listContent) {  
			...
			try {      
			   ...
			   /** **********创建工作表************ */  
			   WritableSheet sheet = workbook.createSheet("银行信息",0);
			   ...
			   for (Map<String, Object> drow : listContent) {
					...
					sheet.addCell(new Label(0, i, Validate.isNullToDefaultString(drow.get("XM"), ""), wcf_left));
					sheet.addCell(new Label(1, i, Validate.isNullToDefaultString(drow.get("YHMC"), ""), wcf_left));
					sheet.addCell(new Label(2, i, Validate.isNullToDefaultString(drow.get("YHZH"), ""), wcf_left));
					sheet.addCell(new Label(3, i, Validate.isNullToDefaultString(drow.get("JE"), ""), wcf_left));
					sheet.addCell(new Label(4, i, Validate.isNullToDefaultString(drow.get("STATUS"), ""), wcf_left));
					i++;
			    }
			   /************将以上缓存中的内容写到EXCEL文件中*********/  
			   workbook.write();  
