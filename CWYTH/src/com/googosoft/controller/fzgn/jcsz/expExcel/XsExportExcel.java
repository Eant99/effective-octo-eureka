 ...
 * 学生信息导出
 * @author wangzhiduo
 * @date 2017-12-28下午4:40:55
 */
public class XsExportExcel {
	public static Map<String, Object> exportExcel(String fileurl,String shortfileurl,String[] title,String TITLE, List<Map<String, Object>> listContent) {  
		...
		try {      
		   ...
		   for (Map<String, Object> drow : listContent) {
				...
				sheet.addCell(new Label(3, i, Validate.isNullToDefaultString(drow.get("XB"), ""), wcf_left));
				sheet.addCell(new Label(4, i, Validate.isNullToDefaultString(drow.get("CSRQ"), ""), wcf_left));
				sheet.addCell(new Label(5, i, Validate.isNullToDefaultString(drow.get("XSLB"), ""), wcf_left));
				sheet.addCell(new Label(6, i, Validate.isNullToDefaultString(drow.get("SZYX"), ""), wcf_left));
				sheet.addCell(new Label(7, i, Validate.isNullToDefaultString(drow.get("SZZY"), ""), wcf_left));
				sheet.addCell(new Label(8, i, Validate.isNullToDefaultString(drow.get("SZNJ"), ""), wcf_left));
				sheet.addCell(new Label(9, i, Validate.isNullToDefaultString(drow.get("SZBJ"), ""), wcf_left));
				sheet.addCell(new Label(10, i, Validate.isNullToDefaultString(drow.get("MZ"), ""), wcf_left));
				sheet.addCell(new Label(11, i, Validate.isNullToDefaultString(drow.get("SFZJLX"), ""), wcf_left));
				sheet.addCell(new Label(12, i, Validate.isNullToDefaultString(drow.get("SFZH"), ""), wcf_left));
				sheet.addCell(new Label(13, i, Validate.isNullToDefaultString(drow.get("ZZMM"), ""), wcf_left));
