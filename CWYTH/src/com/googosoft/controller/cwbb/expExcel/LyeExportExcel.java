	 ...
	 public static Map<String, Object> exportExcel(String fileurl,String shortfileurl,String[] title,String TITLE, List<Map<String, Object>> listContent) {  
			...
			try {      
			   ...
			   for (Map<String, Object> drow : listContent) {
					...
					sheet.addCell(new Label(1, i, Validate.isNullToDefaultString(drow.get("PZH"), ""), wcf_left));
					sheet.addCell(new Label(2, i, Validate.isNullToDefaultString(drow.get("ZY"), ""), wcf_left));
//					sheet.addCell(new Label(3, i, Validate.isNullToDefaultString(drow.get("JFJE"), ""), wcf_left));
//					sheet.addCell(new Label(4, i, Validate.isNullToDefaultString(drow.get("DFJE"), ""), wcf_left));
					...
					sheet.addCell(new Label(5, i, Validate.isNullToDefaultString(drow.get("FX"), ""), wcf_left));
					//sheet.addCell(new Label(6, i, Validate.isNullToDefaultString(drow.get("YE"), ""), wcf_left));
					if(Validate.noNull(ye)) {
						double bd =	Double.parseDouble(ye.replace(",", ""));
						sheet.addCell(new jxl.write.Number(6, i, bd, wcf_left));
					}else{
