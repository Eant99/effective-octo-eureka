...
@Controller
@RequestMapping(value = "/ysfxpj")
public class YsfxpjController extends BaseController {
	
	@Resource(name="pageService")
	private PageService pageService;//单例
	
	@RequestMapping(value = "/goYSfxpjPage")
	public ModelAndView goYSfxpjPage() {
		...
		mv.setViewName("ysgl/ystz/ysfxpj_list");
		return mv;
...
//						+ " x.gkbm,((select d.mc from gx_sys_dwb d where d.dwbh=x.gkbm ))gkbmmc,"
		...
		//设置WHERE条件
		pageList.setStrWhere(" and k.sfqy = '1'");
		pageList.setHj1("");//合计
		//页面数据
