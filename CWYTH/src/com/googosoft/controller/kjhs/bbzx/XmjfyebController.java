 ...
 */
@Controller
@RequestMapping(value = "/xmjfyeb")
public class XmjfyebController extends BaseController {
	 ...
	 * @return
	 */
	@RequestMapping(value = "/goXmjfyePage")
	public ModelAndView gokmxxPage(HttpServletRequest request,
		...
		String url = "kjhs/bbzx/xmjf/xmjfyf_list";
...
//		kmyeService.deleteKmyeb();
	...
	public Object getkmxxPageList(HttpSession session) throws Exception {	
		...
		String strWhere = " AND kjzd='"+kjzd+"' and sjfl!='root'";
