...
import com.googosoft.service.kjhs.bbzx.GrwlyebService;
...
@Controller
@RequestMapping(value="/grwlyeb")
public class GrwlyebController extends BaseController {
	...
	@Resource(name="grwlyebService")	
	private GrwlyebService grwlyebService;
	...
	public Map<String, List<Map<String,Object>>> getPageList2(HttpServletRequest request,
		...
		if(params != null){
			result_map = grwlyebService.getResult(params);
		}
		return result_map;
	}
...
//		String pageUrl = "kjhs/bbzx/jjkm/jjkmmx";
		String pageUrl = "kjhs/bbzx/grwl/grwlmxz_list";
		mv.addObject("bbqj", bbqj);
		mv.addObject("bh",bh);
		mv.addObject("flag","grwlyeb");
