 ...
 * @author sxl
 */
@Repository("bmyssbDao1")
public class BmyssbDao1 extends BaseDao {
	
	private Logger logger = Logger.getLogger(BmyssbDao1.class);
...
//			list.add(sql2);
	...
	public int insertTxrysx(Map<String, Object> infoMap,PageData pd,String bzid,Object tbbm) {
		String guid = AutoKey.createDwbh("CW_srysb", "guid", "32");
		String sql = "INSERT into CW_srysb(GUID,XMMC,YJWCSE,WCSJ,BZ,tbbm,nd)values(?,?,?,to_date(?,'yyyy-mm-dd'),?,?,to_char(sysdate,'yyyy'))";
	...
	public int insertZxywfzcysb(Map<String, Object> infoMap,PageData pd,Object tbbm) {
		String guid = AutoKey.createDwbh("cw_zxywfzcysb", "guid", "32");
		String sql = "INSERT into cw_zxywfzcysb(GUID,TBBM,XMMC,JYSM,XMQZSJ,XMJSSJ,XMZTZ,NAPZJS,NYSJYAPS,XMFKSJYQ,JSGC,ZXYWFLHJ,nd)"
	...
	public int insertWxzlfzcysb(Map<String, Object> infoMap,PageData pd,Object tbbm) {
		String guid = AutoKey.createDwbh("cw_wxzlfzcysb", "guid", "32");
		String sql = "INSERT into cw_wxzlfzcysb(GUID,TBBM,XMMC,XMZYYJJJYSM,XMQZSJ,XMJSSJ,XMZTZ,NAPZJS,NYSJYAPS,XMFKSJYQ,WXZLFLHJ,nd)"
				+ "values(?,?,?,?,to_date(?,'yyyy-mm-dd'),to_date(?,'yyyy-mm-dd'),?,?,?,?,?,to_char(sysdate,'yyyy'))";
		Object[] obj=new Object[]{
				guid,
				CommonUtil.getBeginText(tbbm+""),
...
//							infoMap.get("ggyq"),
			...
			public int insertZfcgmxb(PageData pd, String bzid,Object jsonByZb,Object jsonByZb1,Object jsonByZb2,Object jsonByZb3,Object jsonByZb4,Object jsonByZb5) {
			...
			public int insertZfcgmxmxb(Map<String, Object> infoMap,PageData pd, Object tbbm) {
...
//							infoMap.get("ggyq"),
	...
	//-----------------------------------dm=7 财政支出绩效目标申报表 的删除和添加---------------------------
		...
		public int doAddczzcjx(PageData pd,Object jsonStr,Object tbbm,Object zgbm,Object xmssdw,Object xmfzr,
				...
				Object shgz5,Object shgz6,Object shgz7,Object shgz8,Object qtwt
				){
			String guid = AutoKey.createDwbh("CW_CZZCJXMBSQB", "guid", "32");
			String sql="insert into CW_CZZCJXMBSQB"
					...
					+ " shgz1,shgz2,shgz3,shgz4,shgz5,shgz6,shgz7,shgz8,qtwt,nd,tbbm"
					+ " )"
					+ "values(?,?,?,?,?,"
					+ "?,?,?,?,?,?,"
					+ "?,?,?,?,?,"
			...
			Object[] obj=new Object[]{
					...
					shgz1,shgz2,shgz3,shgz4,shgz5,shgz6,shgz7,shgz8,qtwt,CommonUtil.getBeginText(tbbm+"")
					};
			int i=0;
			try{
				i=db.update(sql,obj);
	...
	public int insertRcgyzfysb(Map<String, Object> infoMap,PageData pd,Object tbbm) {
		System.err.println("_____tbbm____"+tbbm);
		String guid = AutoKey.createDwbh("CW_RCGYZCYSB", "guid", "32");
		String sql = "INSERT into CW_RCGYZCYSB(GUID,FYMC,ZYSM,NYSZE,NYSJYAPS,JSGC,tbbm)"
				+ "values(?,?,?,?,?,?,?)";
		Object[] obj=new Object[]{
				guid,
				infoMap.get("fymc"),
...
//----------------------------------------政府支出回显
	public Map getMxObjectById(String guid) {
		String sql=" select T.GUID,T.CGDW,T.XMMC,T.XMQQDYFZR,T.DWYSBM,T.LXFS "+
				"  from cw_zfcgmxb t " + 
	...
	public Map getObjectById2(String guid) {
	...
	public List getObjectById3(String guid) {
		String sql=" select t.guid,t.bz,t.xmmc,to_char(t.wcsj,'yyyy-mm-dd')wcsj,to_char(t.yjwcse,'FM99999999999999.0000') yjwcse,t.tbbm,t.hj "+
				"  from cw_srysb t " + 
				" where t.tbbm = '"+guid+"'" ;
		return db.queryForList(sql);
	}
	public List getZxywfzcysById(String guid){
		String sql = " SELECT t.xmmc,t.jysm,to_char(t.xmqzsj,'yyyy-mm-dd')xmqzsj,t.xmztz,\r\n" + 
				"t.napzjs,t.nysjyaps,t.xmfksjyq,t.jsgc,t.zxywflhj,to_char(t.xmjssj,'yyyy-mm-dd')xmjssj FROM cw_zxywfzcysb t WHERE t.TBBM='"+guid+"'";
		List list = db.queryForList(sql);
		return list;
	}
	public List getWxzlfById(String guid) {
		String sql=" select t.tbbm,t.xmmc,t.xmzyyjjjysm,to_char(t.xmqzsj,'yyyy-mm-dd')xmqzsj,t.xmztz,t.napzjs,t.nysjyaps,t.xmfksjyq,t.wxzlflhj,to_char(t.xmjssj,'yyyy-mm-dd')xmjssj from cw_wxzlfzcysb t WHERE t.TBBM='"+guid+"'";
		return db.queryForList(sql);
	}
	public Map getObjectById6(String guid) {
		String sql=" select t.guid,(select '('||d.dwbh||')'||d.mc from gx_sys_dwb d where d.dwbh=t.bmmc) bmmc,to_char(t.sqsj,'yyyy-mm-dd') sqsj,"
				+ "(select '('||d.dwbh||')'||d.mc from gx_sys_dwb d where d.dwbh=t.ysbm) ysbm,to_char(t.bzrq,'yyyy-mm-dd') bzrq,"
				+ "(select '('||r.rybh||')'||r.xm from gx_sys_ryb r where r.rybh=t.bmfzr) bmfzr,"
				+ "(select '('||r.rybh||')'||r.xm from gx_sys_ryb r where r.rybh=t.jbr)jbr from cw_fmb t where t.guid=? ";
		return db.queryForMap(sql,new Object[]{guid});
	}
	public Map getObjectById7(String guid) {
...
//	}
	...
	//系部负责人 单位领导人员编号
	public List getxbfzr() {
		StringBuffer sql=new StringBuffer();
		sql.append("  select distinct ry.guid as guid from (select dw.dwld as dwld from (  select substr(ssxb,2,6) ssxb from(  ");
