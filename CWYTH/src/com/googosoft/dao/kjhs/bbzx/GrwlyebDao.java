...
@Repository("grwlyebDao")
public class GrwlyebDao extends BaseDao {
	...
	public Map<String, List<Map<String,Object>>> getResult(Params params){
		...
		String procName = "PRO_CWYTH_KMYE_RY";
...
//		String rybh = params.getTreebh();
//		if(Validate.isNull(rybh)){
//			parInMap.put("v_treebh", "");
//		}else{
//			parInMap.put("v_treebh", " and rybh = '"+rybh+"'");
//		}
