...
@Repository("grwlmxz1Dao")
public class GrwlMxz1Dao extends BaseDao {
	/**
	 * 查询月份
	 * 
	 * @return
	...
	public String getWlrymc(String wlbh) {
		String sql = "select xm from GX_SYS_RYB b where b.rybh='"+wlbh+"' ";
...
//		pd.getString(key)
	...
	public boolean getResultNew(String rybh, String sszt, String kmbh,
			String nian, String startMonth, String endMonth, PageData pd) {
		String login = LUser.getGuid();
		String procName = "PRO_CWYTH_MXZ_WLDWNEW";
		List parInList = new ArrayList<String>();
		boolean bool = false;
...
//		System.err.println(startMonth1="startMonth1");
		String endMonth1 = Validate.isNullToDefaultString(endMonth, "");
//		System.err.println(endMonth="endMonth1");
