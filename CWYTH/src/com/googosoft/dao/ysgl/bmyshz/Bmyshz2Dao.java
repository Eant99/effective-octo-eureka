...
@Repository("bmyshz2Dao")
public class Bmyshz2Dao extends BaseDao{
	...
	public List<Map<String, Object>> getPrintList() {
		String sql = "select guid,xmmc,to_char(yjwcse,'fm99999999.0000') yjwcse,to_char(wcsj,'yyyy-mm-dd') wcsj,bz from CW_SRYSB where 1=1   order by XMMC asc";
	 ...
	 * @return
	 */
	public List<Map<String, Object>> getZxywPrintList() {
		String sql = "select  *  from (select b.guid,b.xmmc,to_char(b.xmqzsj,'yyyy-mm-dd') xmqzsj,to_char(b.xmjssj,'yyyy-mm-dd') xmjssj,to_char(b.xmztz,'FM9999999999.0000') xmztz,to_char(b.napzjs,'FM9999999999.0000') napzjs,to_char(b.nysjyaps,'FM999999999999.0000') nysjyaps from cw_zxywfzcysb b) k where 1=1   order by XMMC asc";
		return db.queryForList(sql);
	 ...
	 * 得到维修租赁
	 */
	public List<Map<String, Object>> getWxzlPrintList() {
		String sql = "select  *  from (select b.guid,b.xmmc,to_char(b.xmqzsj,'yyyy-mm-dd') xmqzsj,to_char(b.xmjssj,'yyyy-mm-dd') xmjssj,to_char(b.xmztz,'FM99999999999999.0000') xmztz,to_char(b.napzjs,'FM99999999999999.0000') napzjs,to_char(b.nysjyaps,'FM9999999999999.0000') nysjyaps from cw_wxzlfzcysb b) k where 1=1   order by XMMC asc";
		return db.queryForList(sql);
	 ...
	 * 得到政府采购
	 */
	public List<Map<String, Object>> getZfcgPrintList() {
		String sql = "select  *  from (select b.guid,b.Pmbm,b.Pmmc,b.Sbfl,b.Jhgzs,to_char(b.Dj,'FM99999999999.0000') Dj,to_char(b.Cgysje,'FM99999999.0000') Cgysje from cw_zfcgysb b ) k where 1=1   order by PMBM asc";
		return db.queryForList(sql);
